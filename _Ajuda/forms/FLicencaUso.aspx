<%@ Page Title="FLicencaUso" Language="C#" AutoEventWireup="true" CodeFile="FLicencaUso.aspx.cs"
    Inherits="FLicencaUso" StylesheetTheme="Principal" %>
...
<body style="height: 1200px">
    ...
    <asp:UpdatePanel ID="UpdatePanel" runat="server" style="height: 1200px">
        <ContentTemplate>
            <h1>
                AJUDA - LICENÇA DE USO</h1>
            <h2>
                Licença de Uso do Software</h2>
            <div id="DivNova" style="border-style: none">
                <div style="border: 0px; z-index: 1; left: 35px; top: 100px; position: absolute;
                    ...
                    <dx:ASPxMemo ID="MemoLicenca" runat="server" Height="800px" ReadOnly="True" Width="825px">
                    </dx:ASPxMemo>
                </div>
