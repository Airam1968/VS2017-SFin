<%@ Page Title="Novidades Sistema Gitano" Language="C#" AutoEventWireup="true" CodeFile="FNovidades.aspx.cs"
    Inherits="FNovidades" StylesheetTheme="Principal" %>
...
<head id="Head1" runat="server">
    <title>Gitano - Ajuda - Licença de Uso</title>
...
<body style="height: 1200px">
    ...
    <asp:UpdatePanel ID="UpdatePanel" runat="server" style="height: 1200px">
        <ContentTemplate>
            <h1>
                AJUDA - Melhorias e Novidades</h1>
            <h2>
                Novidades, Funções e Aprimoramentos do Sistema</h2>
