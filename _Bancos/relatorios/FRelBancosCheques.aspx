<%@ Page Title="FRelBancosCheques" Language="C#" AutoEventWireup="true"
    CodeFile="FRelBancosCheques.aspx.cs" Inherits="FRelBancosCheques"
...
<head id="Head1" runat="server">
    <title>Relatório Bancos - Cheques</title>
                ...
                <div id="DivNova" style="border-style: none">
                    <div style="border: 1px solid #808080; z-index: 1; left: 35px; top: 100px; position: absolute; height: 1200px; width: 832px; text-align: center;">
                        ...
                        <asp:Label ID="Label13" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            ...
                            Text="Compensado" Theme="PlasticBlue"></asp:Label>
                        <asp:RadioButtonList ID="rbcompensadossituacao" runat="server"
                            AutoPostBack="True" CellPadding="0"
                            CellSpacing="0" Font-Names="Calibri" Font-Size="12pt" Font-Strikeout="False"
                            ForeColor="#3E5395" Height="12px" Style="z-index: 2; left: 150px; top: 295px; position: absolute; right: 330px; width: 352px;"
                            RepeatDirection="Horizontal">
                            <asp:ListItem Value="0" Selected="True">Todos</asp:ListItem>
                            <asp:ListItem Value="1">Não Compensados</asp:ListItem>
                            <asp:ListItem Value="2">Compensados</asp:ListItem>
                        </asp:RadioButtonList>
