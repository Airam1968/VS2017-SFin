...
public partial class FRelBancosMovimentacao : System.Web.UI.Page
{
    ...
    protected void btImpressao_Click(object sender, EventArgs e)
    {
        ...
        if (lOk)
        {
            ...
            else
            {
                ...
                "toastr.info('Nenhuma Conta Selecionada!', 'Atenção!')", true);
