<%@ Page Title="FRelBancosDepositos" Language="C#" AutoEventWireup="true"
    CodeFile="FRelBancosDepositos.aspx.cs" Inherits="FRelBancosDepositos"
...
<head id="Head1" runat="server">
    <title>Relatório Bancos - Depósitos</title>
                ...
                <div id="DivNova" style="border-style: none">
                    <div style="border: 1px solid #808080; z-index: 1; left: 35px; top: 100px; position: absolute; height: 1200px; width: 832px; text-align: center;">
                        ...
                        <asp:RadioButtonList ID="rbcompensadossituacao" runat="server"
                            ...
                            ForeColor="#3E5395" Height="12px" Style="z-index: 2; left: 150px; top: 295px; position: absolute; right: 314px; width: 368px;"
