<%@ Page Title="FBancosGeracao" Language="C#" AutoEventWireup="true" CodeFile="FBancosGeracao.aspx.cs"
    Inherits="FBancosGeracao" StylesheetTheme="Principal" %>
...
<head id="Head1" runat="server">
    <title>Gitano - Bancos - Gera Lançamentos</title>
...
<body style="height: 1400px">
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="UpdatePanel" runat="server" style="height: 1400px">
            <ContentTemplate>
                <h1>GERAÇÃO - BANCOS</h1>
                <h2>Geração Automática de Lançamentos Bancários</h2>
                <div id="DivNova" style="border-style: none">
                    <div style="border: 1px solid #808080; z-index: 1; left: 35px; top: 100px; position: absolute; height: 1200px; width: 832px; text-align: center;">
                        ...
                        <asp:Label ID="Label9" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            ...
                            Text="Cheques\Depósitos" Theme="PlasticBlue"></asp:Label>
                        <dx:ASPxCheckBox ID="ckchequedeposito" runat="server" Style="z-index: 2; left: 150px; top: 85px; position: absolute; right: 223px;"
                        ...
                        <asp:Label ID="Label2" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            ...
                            Text="Forn.no Histórico" Theme="PlasticBlue"></asp:Label>
                        <dx:ASPxCheckBox ID="ckfornecedor" runat="server" Style="z-index: 2; left: 150px; top: 120px; position: absolute; right: 223px;"
                            AutoPostBack="True" CheckState="Unchecked"
                            Font-Bold="False" Font-Names="Calibri" Font-Size="14px"
                            ForeColor="#3E5395" Height="21px"
                            Text=" " Theme="PlasticBlue" Width="120px">
                        ...
                        <dx:ASPxTextBox ID="edfeedback" runat="server" Style="z-index: 2; left: 150px; top: 155px; position: absolute; right: 223px;"
