<%@ Page Title="FTabelaContas" Language="C#" AutoEventWireup="true" CodeFile="FTabelaContas.aspx.cs"
    Inherits="FTabelaContas" StylesheetTheme="Principal" ClientIDMode="Inherit" %>
...
<head id="Head1" runat="server">
    <title>Gitano - Bancos - Tabela - Contas</title>
...
<body style="height: 1200px">
    ...
    <asp:UpdatePanel ID="UpdatePanel" runat="server" style="height: 1200px">
        <ContentTemplate>
            <h1>
                BANCOS - TABELA - CONTAS</h1>
            <h2>
                Manutenção de Contas Correntes</h2>
                ...
                <div style="border: 1px solid #808080; z-index: 1; left: 35px; top: 100px; position: absolute;
                    ...
                    <dx3:ASPxGridView ID="GridListagem" runat="server" AutoGenerateColumns="False" EnableTheming="True"
                        ...
                        <SettingsText EmptyDataRow="Não há Dados á Exibir" CommandCancel="Cancela" CommandClearFilter="Limpar Filtros"
                            ...
                            CommandUpdate="Grava" ConfirmDelete="Apagar o Registro, Confirma?" PopupEditFormCaption="Manutenção de Clientes"
                            Title="Verificar" />
                        ...
                        <BackgroundImage HorizontalPosition="center" />
                        <Columns>
                            <dx3:GridViewDataTextColumn FieldName="cod_banco" VisibleIndex="1" 
                                Width="80px" Caption="Banco"
                                Name="cod_banco" SortIndex="0" SortOrder="Ascending">
                                <EditFormSettings Caption="Banco &gt;" ColumnSpan="1" />
                            ...
                            <dx3:GridViewDataTextColumn Caption="Agência" FieldName="cod_agencia" 
                                Name="cod_agencia" VisibleIndex="2"
                                Width="100px">
                                <EditFormSettings Caption="Agência &gt;" CaptionLocation="Near" ColumnSpan="4" 
                                    Visible="True" />
                            ...
                            <dx3:GridViewDataTextColumn Caption="Agência Nome" FieldName="nome_agencia" 
                                Name="nome_agencia" VisibleIndex="4" Width="250px">
                                <PropertiesTextEdit MaxLength="20">
                                </PropertiesTextEdit>
                                <EditFormSettings Caption="Agência Nome &gt;" ColumnSpan="2" 
                                    Visible="True" />
                                <EditFormCaptionStyle Font-Bold="True" HorizontalAlign="Right">
                                </EditFormCaptionStyle>
                                <HeaderStyle Font-Bold="True" ForeColor="White" />
                            </dx3:GridViewDataTextColumn>
                            <dx3:GridViewDataTextColumn Caption="Cidade" FieldName="cidade" 
                                Name="cidade" VisibleIndex="6" Width="200px">
                                <PropertiesTextEdit MaxLength="20">
                                </PropertiesTextEdit>
                            ...
                            <dx3:GridViewDataTextColumn Caption="UF" 
                                FieldName="uf" Name="uf" 
                                VisibleIndex="7" Width="50px">
                                <PropertiesTextEdit MaxLength="15">
                                </PropertiesTextEdit>
                                <EditFormSettings Caption="UF &gt;" ColumnSpan="2" 
                                    Visible="True" />
                                <EditFormCaptionStyle Font-Bold="True" HorizontalAlign="Right">
                                </EditFormCaptionStyle>
                                <HeaderStyle Font-Bold="True" ForeColor="White" />
                            ...
                            <dx3:GridViewDataTextColumn Caption="Conta" FieldName="cod_conta" 
                                Name="cod_conta" VisibleIndex="3" Width="150px">
                                <PropertiesTextEdit MaxLength="20">
                                </PropertiesTextEdit>
                                <EditFormSettings Caption="Conta &gt;" ColumnSpan="2" 
                                    Visible="True" />
                                <EditFormCaptionStyle Font-Bold="True" HorizontalAlign="Right">
                                </EditFormCaptionStyle>
                                <HeaderStyle Font-Bold="True" ForeColor="White" />
                            ...
                            <dx3:GridViewDataTextColumn Caption="Complemento" FieldName="complemento" 
                                Name="complemento" VisibleIndex="10" Width="200px">
                            ...
                            <dx3:GridViewDataTextColumn Caption="CEP" 
                                FieldName="cep" Name="cep" 
                            ...
                            <dx3:GridViewDataTextColumn Caption="Conta Contábil" FieldName="conta_contabil" 
                                Name="conta_contabil" VisibleIndex="9" Width="100px">
                                <PropertiesTextEdit MaxLength="20" Width="100px">
                                    <Style Font-Bold="False" HorizontalAlign="Left">
                                    </Style>
                                </PropertiesTextEdit>
                                <EditFormSettings Caption="Conta Contábil &gt;" ColumnSpan="2" Visible="True" />
                                <EditFormCaptionStyle Font-Bold="True" HorizontalAlign="Right">
                                </EditFormCaptionStyle>
                                <HeaderStyle Font-Bold="True" ForeColor="White" />
                                <CellStyle HorizontalAlign="Right">
                            ...
                            <dx3:GridViewDataTextColumn Caption="Limite Cheque" FieldName="limite_cheque" 
                                Name="limite_cheque" VisibleIndex="11" Width="150px">
                                <EditFormSettings Caption="Limite Cheque &gt;" ColumnSpan="2" Visible="True" />
                                <EditFormCaptionStyle Font-Bold="True" HorizontalAlign="Right">
                                </EditFormCaptionStyle>
                                <HeaderStyle Font-Bold="True" ForeColor="White" />
                                <CellStyle HorizontalAlign="Right">
                            ...
                            <dx3:GridViewDataCheckColumn Caption="Exibe Combo" FieldName="combo" 
                                Name="combo" VisibleIndex="12" Width="100px">
                                <EditFormSettings Caption="Exibe Combo &gt;" ColumnSpan="2" Visible="True" />
                                <EditFormCaptionStyle Font-Bold="True" HorizontalAlign="Right">
                                </EditFormCaptionStyle>
                                <HeaderStyle Font-Bold="True" ForeColor="White" />
                                <CellStyle HorizontalAlign="Right">
                        ...
                        <SettingsText EmptyDataRow="Não há Dados á Exibir" CommandCancel="Cancela" CommandClearFilter="Limpar Filtros"
                            ...
                            CommandUpdate="Altera" ConfirmDelete="Apagar o Registro, Confirma?" PopupEditFormCaption="Manutenção de Clientes"
                            Title="Verificar" />
                        <SettingsLoadingPanel ImagePosition="Top" Text="Carregando&amp;hellip;" />
                        <SettingsDetail AllowOnlyOneMasterRowExpanded="True" />
                        <SettingsEditing EditFormColumnCount="1" Mode="PopupEditForm" />
                            ...
                            <ContentCollection>
                                <dx:PopupControlContentControl ID="PopupControlContentControl" runat="server">
                                    <div style="vertical-align: middle">
                                        ...
                                        <br />
                                        Contas Correntes para o cadastro de lançamentos de Contas a Pagar, Receber e Cobrança Bancária.<br />
                                        <br />
                                    </div>
