<%@ Page Title="FAReceberDepositosCompensados" Language="C#" AutoEventWireup="true" CodeFile="FAReceberDepositosCompensados.aspx.cs"
    Inherits="FAReceberDepositosCompensados" StylesheetTheme="Principal" %>
...
<head id="Head1" runat="server">
    <title>Gitano - Bancos - Consultas Depositos</title>
    ...
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="UpdatePanel" runat="server" style="height: 1400px">
            <ContentTemplate>
                ...
                <h2>Consulta Depositos Compensados\Não Compensados</h2>
                <div id="DivNova" style="border-style: none">
                    <div style="border: 1px solid #808080; z-index: 1; left: 35px; top: 100px; position: absolute; height: 1200px; width: 832px; text-align: center;">
                        ...
                        <asp:RadioButtonList ID="rbparcelasituacao" runat="server" AutoPostBack="True" CellPadding="0"
                            ...
                            <asp:ListItem Value="2" Selected="True">Realizados</asp:ListItem>
                        </asp:RadioButtonList>
                        <asp:RadioButtonList ID="rbdeposito" runat="server" AutoPostBack="True" CellPadding="0"
                            CellSpacing="0" Font-Names="Calibri" Font-Size="12pt" Font-Strikeout="False"
                            ForeColor="#3E5395" Height="12px" Style="z-index: 2; left: 500px; top: 270px; position: absolute; right: 382px;"
                            Width="300px"
                            RepeatDirection="Horizontal">
                            <asp:ListItem Value="0" Selected="True">Depositos Compensados</asp:ListItem>
                            <asp:ListItem Value="1">Depositos Não Compensados</asp:ListItem>
                        </asp:RadioButtonList>
                                ...
                                <ContentCollection>
                                    <dx:PopupControlContentControl ID="PopupControlContentControl" runat="server">
                                        <div style="vertical-align: middle">
                                            Consulta de Cheques Compensados/Não Compensados.<br />
                                            <br />
                                            Através dos filtros é possivel visualizar a situação de cheques compensados e não compensados que impactam diretamento na gestão do saldo bancário.<br />
                                            <br />
                                        </div>
