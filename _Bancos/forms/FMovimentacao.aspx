<%@ Page Title="FMovimentacao" Language="C#" AutoEventWireup="true" CodeFile="FMovimentacao.aspx.cs"
    Inherits="FMovimentacao" StylesheetTheme="Principal" %>
...
<head id="Head1" runat="server">
    <title>Gitano - Bancos - Movimentação</title>
                ...
                <div id="DivNova" style="border-style: none">
                    <div style="border: 1px solid #808080; z-index: 1; left: 35px; top: 100px; position: absolute; height: 1200px; width: 920px; text-align: center;">
                        ...
                        <asp:Label ID="Label14" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            ...
                            Text="Saldo" Theme="PlasticBlue"></asp:Label>
                        ...
                        <asp:Label ID="Label15" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            ...
                            Text="Saldo Final + Limite" Theme="PlasticBlue"></asp:Label>
                        <dx:ASPxTextBox ID="edsaldofinallimitet" runat="server" Style="z-index: 2; left: 150px; top: 155px; position: absolute; right: 223px;"
                            Theme="PlasticBlue" Width="200px"
                            AutoPostBack="True" ReadOnly="True" HorizontalAlign="Right">
                            <MaskSettings IncludeLiterals="DecimalSymbol" Mask="&lt;0..9999999999999999999g&gt;.&lt;00000000000..99&gt;" />
                        </dx:ASPxTextBox>
                        ...
                        <dx:ASPxTextBox ID="edaplicdesbloqueadat" runat="server" Style="z-index: 2; left: 150px; top: 190px; position: absolute; right: 223px;"
                            Theme="PlasticBlue" Width="200px"
                            AutoPostBack="True" ReadOnly="True" HorizontalAlign="Right">
                            <MaskSettings IncludeLiterals="DecimalSymbol" Mask="&lt;0..9999999999999999999g&gt;.&lt;00000000000..99&gt;" />
                        </dx:ASPxTextBox>
                        ...
                        <dx:ASPxTextBox ID="edaplicbloqueadat" runat="server" Style="z-index: 2; left: 150px; top: 225px; position: absolute; right: 223px;"
                            Theme="PlasticBlue" Width="200px"
                            AutoPostBack="True" ReadOnly="True" HorizontalAlign="Right">
                            <MaskSettings IncludeLiterals="DecimalSymbol" Mask="&lt;0..9999999999999999999g&gt;.&lt;00000000000..99&gt;" />
                        </dx:ASPxTextBox>
                        ...
                        <dx:ASPxTextBox ID="edsaldofinalt" runat="server" Style="z-index: 2; left: 150px; top: 260px; position: absolute; right: 223px;"
                            Theme="PlasticBlue" Width="200px"
                            AutoPostBack="True" ReadOnly="True" HorizontalAlign="Right">
                            <MaskSettings IncludeLiterals="DecimalSymbol" Mask="&lt;0..9999999999999999999g&gt;.&lt;00000000000..99&gt;" />
                        </dx:ASPxTextBox>
                        <dx3:ASPxGridView ID="GridListagem" runat="server" AutoGenerateColumns="False" EnableTheming="True"
                            Font-Bold="False" KeyFieldName="data" Style="margin-right: 6px; position: absolute; top: 300px; left: 10px;"
                            ...
                            <Columns>
                                ...
                                <dx3:GridViewDataDateColumn Caption="Data" FieldName="data" Name="data"
                                    VisibleIndex="6" Width="100px" SortIndex="0" SortOrder="Ascending">
                                ...
                                <dx3:GridViewDataTextColumn Caption="CMC7" FieldName="cmc7" Name="cmc7"
                                    ReadOnly="True" VisibleIndex="18" Width="200px">
                                    <PropertiesTextEdit EnableFocusedStyle="False">
                                        <Style HorizontalAlign="Left">
                                    </Style>
                                    </PropertiesTextEdit>
                                ...
                                <ContentCollection>
                                    <dx:PopupControlContentControl ID="PopupControlContentControl" runat="server">
                                        <div style="vertical-align: middle">
                                            Movimentação Bancária.<br />
                                            <br />
                                            Através dos filtros é possivel visualizar a movimentação de débitos e créditos oriundos dos lançamentos de contas a receber e contas a pagar.<br />
                                            <br />
                                        </div>
