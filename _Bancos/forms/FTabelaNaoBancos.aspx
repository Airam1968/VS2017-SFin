<%@ Page Title="FTabelaNaoBancos" Language="C#" AutoEventWireup="true" CodeFile="FTabelaNaoBancos.aspx.cs"
    Inherits="FTabelaNaoBancos" StylesheetTheme="Principal" ClientIDMode="Inherit" %>
...
<head id="Head1" runat="server">
    <title>Gitano - Bancos - Tabela - Não Bancos</title>
...
<body style="height: 1200px">
    ...
    <asp:UpdatePanel ID="UpdatePanel" runat="server" style="height: 1200px">
        <ContentTemplate>
            <h1>
                BANCOS - TABELA - NÃO BANCOS</h1>
            <h2>
                Manutenção de Não Bancos</h2>
            <div id="DivNova" style="border-style: none">
                <div style="border: 1px solid #808080; z-index: 1; left: 35px; top: 100px; position: absolute;
                    ...
                    <dx3:ASPxGridView ID="GridListagem" runat="server" AutoGenerateColumns="False" EnableTheming="True"
                        Font-Bold="False" KeyFieldName="cod_banco" Style="margin-right: 6px;" Theme="PlasticBlue"
                        ...
                        <SettingsText EmptyDataRow="Não há Dados á Exibir" CommandCancel="Cancela" CommandClearFilter="Limpar Filtros"
                            ...
                            CommandUpdate="Altera" ConfirmDelete="Apagar o Registro, Confirma?" PopupEditFormCaption="Manutenção de Não Bancos"
                            Title="Verificar" />
                        ...
                        <Columns>
                            ...
                            <dx3:GridViewDataTextColumn FieldName="cod_banco" VisibleIndex="1" 
                                Width="100px" Caption="Código"
                                Name="cod_banco" SortIndex="0" SortOrder="Ascending" ReadOnly="True">
                            ...
                            <dx3:GridViewDataTextColumn Caption="Nome" FieldName="nome" 
                                Name="nome" VisibleIndex="2"
                                Width="400px">
                                <EditFormSettings Caption="Nome &gt;" CaptionLocation="Near" 
                            ...
                            <ContentCollection>
                                <dx:PopupControlContentControl ID="PopupControlContentControl" runat="server">
                                    <div style="vertical-align: middle">
                                        Codificação de Não Bancos.<br />
                                        <br />
                                        Tabela de Não Bancos para utilização.<br />
                                        <br />
                                        Não Bancos para o cadastro de lançamentos de Contas a Pagar, Receber e Contas Correntes.<br />
                                        <br />
                                    </div>
