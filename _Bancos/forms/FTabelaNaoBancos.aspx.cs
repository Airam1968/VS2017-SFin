...
public partial class FTabelaNaoBancos : System.Web.UI.Page
{
    DataSet dsbancos;
    ...
    {
        //dsusuario.Clear();
        dsbancos = uBanco_2.PegaDadosBancos(0);
    ...
    protected void GridListagem_RowDeleting(object sender, DevExpress.Web.Data.ASPxDataDeletingEventArgs e)
    {
        ...
        uBanco_2.ExcluiBanco(e.Values["ID"].ToString());
        //
