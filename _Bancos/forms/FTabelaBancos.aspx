<%@ Page Title="FTabelaBancos" Language="C#" AutoEventWireup="true" CodeFile="FTabelaBancos.aspx.cs"
    Inherits="FTabelaBancos" StylesheetTheme="Principal" ClientIDMode="Inherit" %>
...
<head id="Head1" runat="server">
    <title>Gitano - Bancos - Tabela - Bancos</title>
...
<body style="height: 1200px">
    ...
    <asp:UpdatePanel ID="UpdatePanel" runat="server" style="height: 1200px">
        <ContentTemplate>
            <h1>
                BANCOS - TABELA - BANCOS</h1>
            <h2>
                Manutenção de Bancos</h2>
                ...
                <div style="border: 1px solid #808080; z-index: 1; left: 35px; top: 100px; position: absolute;
                    ...
                    <dx3:ASPxGridView ID="GridListagem" runat="server" AutoGenerateColumns="False" EnableTheming="True"
                        ...
                        <SettingsText EmptyDataRow="Não há Dados á Exibir" CommandCancel="Cancela" CommandClearFilter="Limpar Filtros"
                            ...
                            CommandUpdate="Altera" ConfirmDelete="Apagar o Registro, Confirma?" PopupEditFormCaption="Manutenção de Bancos"
                            Title="Verificar" />
                            ...
                            <ContentCollection>
                                <dx:PopupControlContentControl ID="PopupControlContentControl" runat="server">
                                    <div style="vertical-align: middle">
                                        Codificação de Bancos - FEBRABAN.<br />
                                        <br />
                                        Tabela de Bancos para utilização.<br />
                                        <br />
                                        Bancos para o cadastro de lançamentos de Contas a Pagar, Receber e Contas Correntes.<br />
                                        <br />
                                    </div>
