<%@ Page Title="FAPagarChequesCompensados" Language="C#" AutoEventWireup="true" CodeFile="FAPagarChequesCompensados.aspx.cs"
    Inherits="FAPagarChequesCompensados" StylesheetTheme="Principal" %>
...
<head id="Head1" runat="server">
    <title>Gitano - Bancos - Consultas Cheques</title>
...
<body style="height: 1400px">
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="UpdatePanel" runat="server" style="height: 1400px">
            <ContentTemplate>
                <h1>CONSULTA LANÇAMENTOS - BANCOS</h1>
                <h2>Consulta Cheques Compensados\Não Compensados</h2>
                <div id="DivNova" style="border-style: none">
                    <div style="border: 1px solid #808080; z-index: 1; left: 35px; top: 100px; position: absolute; height: 1200px; width: 832px; text-align: center;">
                        ...
                        <asp:RadioButtonList ID="rbcheque" runat="server" AutoPostBack="True" CellPadding="0"
                            CellSpacing="0" Font-Names="Calibri" Font-Size="12pt" Font-Strikeout="False"
                            ForeColor="#3E5395" Height="12px" Style="z-index: 2; left: 500px; top: 270px; position: absolute; right: 382px;"
                            Width="300px"
                            RepeatDirection="Horizontal">
                            <asp:ListItem Value="0" Selected="True">Cheques Compensados</asp:ListItem>
                            <asp:ListItem Value="1">Cheques Não Compensados</asp:ListItem>
                        </asp:RadioButtonList>
                        ...
                        <dx3:ASPxGridView ID="GridListagem" runat="server" AutoGenerateColumns="False" EnableTheming="True"
                            Font-Bold="False" KeyFieldName="ID" Style="margin-right: 6px; position: absolute; top: 435px; left: 10px; height: 400px;"
                            ...
                            <Columns>
                                ...
                                <dx3:GridViewDataTextColumn Caption="Documento" FieldName="documento"
                                    Name="documento" VisibleIndex="13">
                                    <PropertiesTextEdit Width="60px">
                                        <Style Font-Bold="True">
                                    </Style>
                                    </PropertiesTextEdit>
                                ...
                                <dx3:GridViewDataDateColumn Caption="Data Real." FieldName="data_realizado"
                                    Name="data_realizado" VisibleIndex="10">
                                    <PropertiesDateEdit DisplayFormatString="dd/MM/yyyy" Width="100px">
                                    </PropertiesDateEdit>
                                ...
                                <dx3:GridViewDataDateColumn Caption="Data Documento" FieldName="data_documento"
                                    Name="data_documento" VisibleIndex="14">
                                    <PropertiesDateEdit DisplayFormatString="dd/MM/yyyy" Width="100px">
                                    </PropertiesDateEdit>
                                ...
                                <dx3:GridViewDataDateColumn Caption="Data Compensação" FieldName="dtcompensacao"
                                    Name="dtcompensacao" VisibleIndex="17">
                                ...
                                <dx3:GridViewDataTextColumn Caption="Fornecedor" FieldName="fornecedor"
                                    Name="fornecedor" VisibleIndex="5" Width="60px">
                                    <EditFormSettings Caption="Fornecedor &gt;" CaptionLocation="Near"
                                ...
                                <ContentCollection>
                                    <dx:PopupControlContentControl ID="PopupControlContentControl" runat="server">
                                        <div style="vertical-align: middle">
                                            Consulta de Depósitos Compensados/Não Compensados.<br />
                                            <br />
                                            Através dos filtros é possivel visualizar a situação de depositos\créditos compensados e não compensados que impactam diretamento na gestão do saldo bancário.<br />
                                            <br />
                                        </div>
