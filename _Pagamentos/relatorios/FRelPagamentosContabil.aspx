<%@ Page Title="FRelPagamentosContabil" Language="C#" AutoEventWireup="true"
    CodeFile="FRelPagamentosContabil.aspx.cs" Inherits="FRelPagamentosContabil"
...
<head id="Head1" runat="server">
    <title>Relatório Pagamentos - Contabilização de Recebimentos</title>
    ...
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="UpdatePanel" runat="server">
            <ContentTemplate>
                ...
                <h2>Contabilização de Recebimentos</h2>
                                ...
                                <ContentCollection>
                                    <dx:PopupControlContentControl ID="PopupControlContentControl" runat="server">
                                        <div style="vertical-align: middle">
                                            Relatório Pagamentos Contábil.<br />
                                            <br />
                                            O Relatório em questão apresenta os recebimentos de parcela em um período.<br />
                                            <br />
                                            Totalizando por Data de Pagamento.<br />
                                            <br />
