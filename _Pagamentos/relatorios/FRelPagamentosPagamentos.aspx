<%@ Page Title="FRelPagamentosPagamentos" Language="C#" AutoEventWireup="true"
    CodeFile="FRelPagamentosPagamentos.aspx.cs" Inherits="FRelPagamentosPagamentos"
...
<head id="Head1" runat="server">
    <title>Relatório Pagamentos - Pagamentos</title>
            ...
            <div id="DivNova" style="border-style: none">
                <div style="border: 1px solid #808080; z-index: 1; left: 35px; top: 100px; position: absolute;
                    ...
                    <asp:Label ID="Label1" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                        ...
                        position: absolute" Text="Origem Pagamento" Theme="PlasticBlue" 
                        Visible="False"></asp:Label>
                    ...
                    <asp:Label ID="Label6" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                        ...
                        position: absolute" Text="Pagamentos" Theme="PlasticBlue" Visible="False"></asp:Label>
                    <asp:RadioButtonList ID="rbpagamentos" runat="server" AutoPostBack="True" CellPadding="0"
                        CellSpacing="0" Font-Names="Calibri" Font-Size="12pt" Font-Strikeout="False"
                        ForeColor="#3E5395" Height="12px" Style="z-index: 2; left: 150px; top: 270px;
                        position: absolute; right: 214px; width: 468px;" 
                        RepeatDirection="Horizontal" Visible="False">
                        <asp:ListItem Value="0" Selected="True">Todos</asp:ListItem>
                    ...
                    <asp:RadioButtonList ID="rbordem" runat="server" AutoPostBack="True" CellPadding="0"
                        CellSpacing="0" Font-Names="Calibri" Font-Size="12pt" Font-Strikeout="False"
                        ForeColor="#3E5395" Style="z-index: 2; left: 150px; top: 300px;
                    ...
                    <asp:CheckBox ID="ckdesistentes" runat="server" AutoPostBack="True" 
                        ...
                        top: 330px; left: 150px; width: 50px;" Text=" " Checked="True" 
                        Visible="False" />                                                                                                                                               
