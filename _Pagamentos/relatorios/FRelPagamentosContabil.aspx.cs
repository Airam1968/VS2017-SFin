...
public partial class FRelPagamentosContabil : System.Web.UI.Page
{
    ...
    protected void btImpressao_Click(object sender, EventArgs e)
    {
        ...
        if (lOk)
        {
            ...
            fwObs_Log = "RELATÓRIO RECEBIMENTOS CONTABIL: " + cbproduto.Text.Substring(0, 5) + "/";
