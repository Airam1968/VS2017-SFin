<%@ Page Title="FRelPagamentosExtCorrecao" Language="C#" AutoEventWireup="true"
    CodeFile="FRelPagamentosExtCorrecao.aspx.cs" Inherits="FRelPagamentosExtCorrecao"
...
<head id="Head1" runat="server">
    <title>Relatório Pagamentos - Extrato Correção Monetária</title>
    ...
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="UpdatePanel" runat="server">
            <ContentTemplate>
                ...
                <h2>Extrato Correção Monetária</h2>
                                ...
                                <ContentCollection>
                                    <dx:PopupControlContentControl ID="PopupControlContentControl" runat="server">
                                        <div style="vertical-align: middle">
                                            Relatório Extrato de Correção.<br />
                                            <br />
                                            O Relatório em questão apresenta os dados da evolução da correção monetária.<br />
                                            <br />
                                        </div>
