...
public partial class FRelPagamentosFluxoParcelas : System.Web.UI.Page
{
    ...
    protected void btImpressao_Click(object sender, EventArgs e)
    {
        ...
        if (lOk)
        {
            ...
            fwObs_Log = "RELATÓRIO FLUXO DE PARCELAS: " + cbproduto.Text.Substring(0, 5) + "/";
