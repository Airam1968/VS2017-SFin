<%@ Page Title="FRelPagamentosDevedores" Language="C#" AutoEventWireup="true"
    CodeFile="FRelPagamentosDevedores.aspx.cs" Inherits="FRelPagamentosDevedores"
...
<head id="Head1" runat="server">
    <title>Relatório Pagamentos - Devedores</title>
...
<body style="height: 910px">
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="UpdatePanel" runat="server">
            <ContentTemplate>
                <h1>PAGAMENTOS - RELATÓRIOS</h1>
                <h2>Devedores de Parcela</h2>
                <div id="DivNova" style="border-style: none">
                    <div style="border: 1px solid #808080; z-index: 1; left: 35px; top: 100px; position: absolute; height: 1200px; width: 832px; text-align: center;">
                        ...
                        <asp:Label ID="Label4" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            ...
                            Text="Período Vencimento" Theme="PlasticBlue"
                        ...
                        <asp:Label ID="Label1" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            ...
                            Text="Protesto" Theme="PlasticBlue"
                            Visible="False"></asp:Label>
                        ...
                        <asp:Label ID="Label6" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            ...
                            Text="Carteira\Bancária" Theme="PlasticBlue"
                            Visible="False"></asp:Label>
                        <asp:RadioButtonList ID="rbcarteira" runat="server" AutoPostBack="True" CellPadding="0"
                            CellSpacing="0" Font-Names="Calibri" Font-Size="12pt" Font-Strikeout="False"
                            ForeColor="#3E5395" Style="z-index: 2; left: 150px; top: 270px; position: absolute; right: 118px; width: 300px; height: 16px;"
                            RepeatDirection="Horizontal" Visible="False">
                            <asp:ListItem Value="0" Selected="True">Todas</asp:ListItem>
                            <asp:ListItem Value="1">Bancária</asp:ListItem>
                            <asp:ListItem Value="2">Carteira</asp:ListItem>
                        </asp:RadioButtonList>
                        ...
                        <asp:Label ID="Label10" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            Font-Size="15px" ForeColor="#3E5395" Style="z-index: 2; left: 9px; top: 335px; position: absolute; right: 713px;"
                        ...
                        <asp:CheckBox ID="ckdesistentes" runat="server" AutoPostBack="True"
                            ...
                            Font-Size="15px" ForeColor="#3E5395" Style="z-index: 5; position: absolute; font-size: 15px; top: 335px; left: 150px; width: 50px;"
                            Text=" " Checked="True"
                            Visible="False" />
                                ...
                                <ContentCollection>
                                    <dx:PopupControlContentControl ID="PopupControlContentControl" runat="server">
                                        <div style="vertical-align: middle">
                                            Relatório Pagamentos Devedores.<br />
                                            <br />
