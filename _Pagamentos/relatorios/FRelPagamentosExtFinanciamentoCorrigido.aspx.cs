...
public partial class FRelPagamentosExtFinanciamentoCorrigido : System.Web.UI.Page
{
    ...
    protected void btImpressao_Click(object sender, EventArgs e)
    {
        ...
        if (lOk)
        {
            ...
            Session.Remove("dtcorrecao");
            if (dtprevisao1.Text != string.Empty)
            {
                Session.Add("dtprevisao1", dtprevisao1.Text.Trim().Substring(0, 10));
            }
            else
            {
            ...
            {
                Session.Add("dtprevisao2", dtprevisao2.Text.Trim().Substring(0, 10));
            }
            else
            {
            ...
            //
            Session.Add("dtcorrecao", dtcorrecao.Text.Trim().Substring(0, 10));
            //
            //cbcontacorrente
            ...
            Session.Add("rbpagamentos", rbpagamentos.SelectedIndex.ToString());
            //
            //cbcliente
            ...
            //
            IDCliente = uUnidade.PegaIDCliente(cbproduto.Value.ToString(), cbgrupo.Value.ToString(), cbgrupounidades.Value.ToString(), parte, proprietario);
            ...
            fwObs_Log = "RELATÓRIO EXTRATO FINANCIAMENTO: " + cbproduto.Text.Substring(0, 5) + "/";
            ...
            if (proprietario.Trim() != string.Empty)
            {
                fwObs_Log = fwObs_Log +
                            "/" + proprietario;
            }
