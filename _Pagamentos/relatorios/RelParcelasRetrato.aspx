<%@ Page Title="RECIBO PAGAMENTO DE PARCELAS NUMERADO" Language="C#" AutoEventWireup="true"
    CodeFile="RelParcelasRetrato.aspx.cs" Inherits="RelParcelasRetrato" StylesheetTheme="Principal" %>
...
<body>
    ...
    <div id="Relatorio">
        ...
        <dx:ReportToolbar ID="ReportToolbar1" runat="server" ReportViewerID="ReportViewer1"
            ShowDefaultButtons="False" Width="750px" Theme="PlasticBlue" Height="35px">
            <Items>
    ...
    <dx:ReportViewer ID="ReportViewer1" runat="server" Width="750px" AutoSize="False"
        Height="1100px" PrintUsingAdobePlugIn="False" Theme="PlasticBlue" Style="margin-right: 0px"
