<%@ Page Title="FRelPagamentosFluxoParcelas" Language="C#" AutoEventWireup="true"
    CodeFile="FRelPagamentosFluxoParcelas.aspx.cs" Inherits="FRelPagamentosFluxoParcelas"
...
<head id="Head1" runat="server">
    <title>Relatório Pagamentos - Fluxo de Parcelas</title>
...
<body style="height: 910px">
    ...
    <asp:UpdatePanel ID="UpdatePanel" runat="server">
        <ContentTemplate>
            ...
            <h2>
                Fluxo de Parcelas do Financiamento</h2>
                            ...
                            <ContentCollection>
                                <dx:PopupControlContentControl ID="PopupControlContentControl" runat="server">
                                    <div style="vertical-align: middle">
                                        Relatório Fluxo de Parcelas.<br />
                                        <br />
                                        O Relatório em questão apresenta as de parcela do financiamento.<br />
                                        <br />
                                    </div>
