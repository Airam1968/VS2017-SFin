...
public partial class RelPagamentosSaldoCredor : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        RepPagamentosSaldoCredor report = new RepPagamentosSaldoCredor();
        ...
        // RODAPÉ
        report.lcaminho.Text = "Gitano ->SGFin ->Pagamentos ->Relatório Saldo Credor";
        //
        DataSet ds;
        ds = uParcelas.PegaDadosSaldoCredor(produto, grupo, dtprevisao1.ToString().Substring(0, 10), dtprevisao2.ToString().Substring(0, 10));
        //
