<%@ Page Title="FRelPagamentosExtFinanciamentoCorrigido" Language="C#" AutoEventWireup="true"
    CodeFile="FRelPagamentosExtFinanciamentoCorrigido.aspx.cs" Inherits="FRelPagamentosExtFinanciamentoCorrigido"
...
<head id="Head1" runat="server">
    <title>Relatório Pagamentos - Extrato Financiamento Corrigido</title>
    ...
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="UpdatePanel" runat="server">
            <ContentTemplate>
                ...
                <h2>Extrato Financiamento Corrigido</h2>
                <div id="DivNova" style="border-style: none">
                    <div style="border: 1px solid #808080; z-index: 1; left: 35px; top: 100px; position: absolute; height: 1200px; width: 832px; text-align: center;">
                        ...
                        <asp:Label ID="Label6" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            Font-Size="15px" ForeColor="#3E5395" Style="z-index: 2; left: 9px; top: 215px; position: absolute; height: 18px;"
                            Text="Pagamentos" Theme="PlasticBlue"
                            Visible="False"></asp:Label>
                        <asp:RadioButtonList ID="rbpagamentos" runat="server" AutoPostBack="True" CellPadding="0"
                            CellSpacing="0" Font-Names="Calibri" Font-Size="12pt" Font-Strikeout="False"
                            ForeColor="#3E5395" Height="12px" Style="z-index: 2; left: 150px; top: 215px; position: absolute; right: 214px; width: 468px;"
                            ...
                            <asp:ListItem Value="3">Atrasadas</asp:ListItem>
                            <asp:ListItem Value="4">Á Vencer</asp:ListItem>
                        </asp:RadioButtonList>
                        <asp:Label ID="Label1" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            Font-Size="15px" ForeColor="#3E5395" Style="z-index: 2; left: 9px; top: 250px; position: absolute"
                            Text="Corrigir Até" Theme="PlasticBlue"
                            Visible="False"></asp:Label>
                        <dx:ASPxDateEdit ID="dtcorrecao" runat="server" BackColor="#E1E6F2" DisplayFormatString="dd/MM/yyyy"
                            EditFormat="Custom" EditFormatString="dd/MM/yyyy" EnableTheming="True" Font-Bold="False"
                            Font-Names="Calibri" Font-Size="15px" ForeColor="#3E5395" Height="16px" Style="z-index: 4; position: absolute; margin-right: 5px; left: 150px; top: 250px;"
                            Theme="PlasticBlue"
