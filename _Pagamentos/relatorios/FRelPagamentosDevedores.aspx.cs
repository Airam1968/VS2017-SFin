...
public partial class FRelPagamentosDevedores : System.Web.UI.Page
{
    ...
    protected void btImpressao_Click(object sender, EventArgs e)
    {
        ...
        if (lOk)
        {
            ...
            //
            //Carteira\Bancária
            Session.Remove("rbcarteira");
            Session.Add("rbcarteira", rbcarteira.SelectedItem.Value.ToString());
            //
            //Ordem
            ...
            fwObs_Log = "RELATÓRIO DEVEDORES: " + cbproduto.Text.Substring(0, 5) + "/";
