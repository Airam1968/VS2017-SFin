<%@ Page Title="FParcelasProprietario" Language="C#" AutoEventWireup="true" CodeFile="FParcelasProprietario.aspx.cs"
    Inherits="FParcelasProprietario" StylesheetTheme="Principal" %>
...
<head id="Head1" runat="server">
    <title>Gitano - Pagamentos - Parcelas Proprietário</title>
...
<body style="height: 1400px">
    <form id="form1" runat="server">
        ...
        <h2>Pagamento de Parcelas Proprietário</h2>
                ...
                <div id="DivNova" style="border-style: none">
                    <div style="border: 1px solid #808080; z-index: 1; left: 35px; top: 100px; position: absolute; height: 1500px; width: 832px; text-align: center;">
                        ...
                        <dx:ASPxComboBox ID="cbcliente_filtro" runat="server" IncrementalFilteringMode="StartsWith"
                            EnableIncrementalFiltering="True" ValueField="nome" TextFormatString="{0} ({1}) ({2})"
                            ...
                            DataSourceID="dsfiltro_combo_clientes"
                    ...
                    <asp:ObjectDataSource ID="dsfiltro_combo_clientes" runat="server" OldValuesParameterFormatString="original_{0}{1}{2}"
                        SelectMethod="filtro_combo_contato_nome" TypeName="uContato">
                        <SelectParameters>
                            ...
                            <asp:SessionParameter Name="cnpj" SessionField="cnpj" Type="String" />
                        </SelectParameters>
