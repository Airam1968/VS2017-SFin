<%@ Page Title="FParcelasCancelamento" Language="C#" AutoEventWireup="true" CodeFile="FParcelasCancelamento.aspx.cs"
    Inherits="FParcelasCancelamento" StylesheetTheme="Principal" %>
...
<head id="Head1" runat="server">
    <title>Gitano - Cancelamento - Parcelas</title>
...
<body style="height: 1400px">
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="UpdatePanel" runat="server" style="height: 1400px">
            <ContentTemplate>
                <h1>CANCELAMENTO - PARCELAS</h1>
                <h2>Cancelamento do Pagamento de Parcelas</h2>
                                ...
                                <ContentCollection>
                                    <dx:PopupControlContentControl ID="PopupControlContentControl" runat="server">
                                        <div style="vertical-align: middle">
                                            Cancelamento de Pagamento de Parcela.<br />
                                            <br />
                                            O Processo de cancelamento do pagamento da parcela, envolve a exclusão dos dados de pagamento, deixando a parcela em aberto.<br />
                                            <br />
                                        </div>
