<%@ Page Title="FParcelasDesmembramentoRajada" Language="C#" AutoEventWireup="true"
    CodeFile="FParcelasDesmembramentoRajada.aspx.cs" Inherits="FParcelasDesmembramentoRajada"
...
<head id="Head1" runat="server">
    <title>Gitano - Pagamentos - Desmembramento Rajada/Multiplo</title>
...
<body style="height: 1400px">
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="UpdatePanel" runat="server" style="height: 1400px">
            <ContentTemplate>
                <h1>DESMEMBRAMENTO RAJADA - PARCELAS</h1>
                <h2>Desmembramento de Parcelas em Rajada</h2>
                <div id="DivNova" style="border-style: none">
                    <div style="border: 1px solid #808080; z-index: 1; left: 35px; top: 100px; position: absolute; height: 1200px; width: 832px; text-align: center;">
                        ...
                        <dx:ASPxTextBox ID="edvlr_original" runat="server" Style="z-index: 2; left: 380px; top: 750px; position: absolute; right: 223px;"
                            Theme="PlasticBlue" Width="200px"
                            Visible="False" ReadOnly="True">
                            <MaskSettings IncludeLiterals="DecimalSymbol" Mask="&lt;0..9999999999999999999g&gt;.&lt;00000000000..99&gt;" />
                        </dx:ASPxTextBox>
                        ...
                        <asp:Label ID="Label9" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            ...
                            Text="Base Correção" Theme="PlasticBlue" Visible="False"></asp:Label>
                        <dx:ASPxTextBox ID="eddtbase" runat="server" Style="z-index: 2; left: 150px; top: 810px; position: absolute; right: 223px;"
                            Theme="PlasticBlue" Width="200px" Visible="False"
                            ReadOnly="True">
                        </dx:ASPxTextBox>
                        ...
                        <dx:ASPxTextBox ID="edindexador" runat="server" Style="z-index: 2; left: 150px; top: 840px; position: absolute; right: 223px;"
                            Theme="PlasticBlue" Width="200px" Visible="False"
                            ReadOnly="True">
                        </dx:ASPxTextBox>
                        ...
                        <dx:ASPxTextBox ID="edperiodicidade" runat="server" Style="z-index: 2; left: 150px; top: 870px; position: absolute; right: 223px;"
                            Theme="PlasticBlue" Width="200px"
                            Visible="False" ReadOnly="True">
                        </dx:ASPxTextBox>
                        <asp:Label ID="Label24" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            ...
                            Text="Tipo Valores" Theme="PlasticBlue" Visible="False"></asp:Label>
                        <asp:RadioButtonList ID="rbvalorparcela" runat="server" AutoPostBack="True" CellPadding="0"
                            CellSpacing="0" Font-Names="Calibri" Font-Size="12pt" Font-Strikeout="False"
                            ForeColor="#3E5395" Height="12px" Style="z-index: 2; left: 150px; top: 900px; position: absolute; right: 423px;"
                            Width="300px" RepeatDirection="Horizontal"
                            Visible="False" OnSelectedIndexChanged="rbvalorparcela_SelectedIndexChanged">
                            <asp:ListItem Value="0" Selected="True">Valores Iguais</asp:ListItem>
                            <asp:ListItem Value="1">Valores Diferentes</asp:ListItem>
                        </asp:RadioButtonList>
                        <asp:Label ID="Label12" runat="server" BackColor="White" Font-Bold="True" Font-Names="Calibri"
                            ...
                            Text="Valor Parcela" Theme="PlasticBlue" Visible="False"></asp:Label>
                        <dx:ASPxTextBox ID="edvlr_parcela1" runat="server" Style="z-index: 2; left: 150px; top: 930px; position: absolute; right: 223px;"
                            Theme="PlasticBlue" Width="200px"
                            Visible="False" OnTextChanged="edvlr_parcela1_TextChanged">
                            <MaskSettings IncludeLiterals="DecimalSymbol" Mask="&lt;0..9999999999999999999g&gt;.&lt;00000000000..99&gt;" />
                        </dx:ASPxTextBox>
                        <dx:ASPxTextBox ID="edvlr_original1" runat="server" Style="z-index: 2; left: 380px; top: 930px; position: absolute; right: 223px;"
                            Theme="PlasticBlue" Width="200px"
                            Visible="False" ReadOnly="True">
                            <MaskSettings IncludeLiterals="DecimalSymbol" Mask="&lt;0..9999999999999999999g&gt;.&lt;00000000000..99&gt;" />
                        </dx:ASPxTextBox>
                        <asp:Label ID="Label14" runat="server" BackColor="White" Font-Bold="True" Font-Names="Calibri"
                            Font-Size="15px" ForeColor="#3E5395" Style="z-index: 2; left: 9px; top: 960px; position: absolute"
                            Text="Quantidade" Theme="PlasticBlue" Visible="False"></asp:Label>
                        <dx:ASPxTextBox ID="edqtd_parcelas" runat="server" Style="z-index: 2; left: 150px; top: 960px; position: absolute; right: 223px;"
                            Theme="PlasticBlue" Width="200px"
                            Visible="False" AutoPostBack="True" OnTextChanged="edqtd_parcelas_TextChanged"
                            MaxLength="2">
                            <MaskSettings Mask="&lt;0..9999999999999999999g&gt;" />
                        </dx:ASPxTextBox>
                        <dx:ASPxTextBox ID="edvlr_original2" runat="server" Style="z-index: 2; left: 380px; top: 960px; position: absolute; right: 223px;"
                            Theme="PlasticBlue" Width="200px"
                            Visible="False" ReadOnly="True">
                            <MaskSettings IncludeLiterals="DecimalSymbol" Mask="&lt;0..9999999999999999999g&gt;.&lt;00000000000..99&gt;" />
                        </dx:ASPxTextBox>
                        <asp:Label ID="Label15" runat="server" BackColor="White" Font-Bold="True" Font-Names="Calibri"
                            Font-Size="15px" ForeColor="#3E5395" Style="z-index: 2; left: 9px; top: 990px; position: absolute"
                            Text="Vencimento 2o. " Theme="PlasticBlue" Visible="False"></asp:Label>
                        <dx:ASPxDateEdit ID="eddtvencimento2" runat="server" BackColor="#E1E6F2" DisplayFormatString="dd/MM/yyyy"
                            EditFormat="Custom" EditFormatString="dd/MM/yyyy" EnableTheming="True" Font-Bold="False"
                            Font-Names="Calibri" Font-Size="15px" ForeColor="#3E5395" Height="16px" Style="z-index: 4; position: absolute; margin-right: 5px; left: 150px; top: 990px;"
                            Theme="PlasticBlue"
                            UseMaskBehavior="True" Width="120px" Visible="False" Enabled="False" AutoPostBack="True">
                            <CalendarProperties ClearButtonText="Limpar" TodayButtonText="Hoje">
                            </CalendarProperties>
                            <ClientSideEvents KeyDown="function(s, e) 
                                                   {if (!(
                        ...
                        <asp:Label ID="Label19" runat="server" BackColor="White" Font-Bold="True" Font-Names="Calibri"
                            Font-Size="15px" ForeColor="#3E5395" Style="z-index: 2; left: 350px; top: 990px; position: absolute"
                            Text="Data Fixa" Theme="PlasticBlue" Visible="False"></asp:Label>
                        <dx:ASPxCheckBox ID="ckdatafixa" runat="server" Style="z-index: 2; left: 450px; top: 990px; position: absolute; right: 223px;"
                            ...
                            OnCheckedChanged="ckdatafixa_CheckedChanged">
                        </dx:ASPxCheckBox>
                        <asp:Label ID="Label17" runat="server" BackColor="White" Font-Bold="True" Font-Names="Calibri"
                            ...
                            Text="Valores Parcelas" Theme="PlasticBlue" Visible="False"></asp:Label>
                        <dx:ASPxTextBox ID="edvlr_parcela_01" runat="server" Style="z-index: 2; left: 150px; top: 1020px; position: absolute; right: 223px;"
                            Theme="PlasticBlue" Width="150px"
                            Visible="False" AutoPostBack="True" OnTextChanged="edvlr_parcela_01_TextChanged">
                            <MaskSettings IncludeLiterals="DecimalSymbol" Mask="&lt;0..9999999999999999999g&gt;.&lt;00000000000..99&gt;" />
                        </dx:ASPxTextBox>
                        <dx:ASPxTextBox ID="edvlr_parcela_02" runat="server" Style="z-index: 2; left: 350px; top: 1020px; position: absolute; right: 223px;"
                            Theme="PlasticBlue" Width="150px"
                            Visible="False" AutoPostBack="True" OnTextChanged="edvlr_parcela_02_TextChanged">
                            <MaskSettings IncludeLiterals="DecimalSymbol" Mask="&lt;0..9999999999999999999g&gt;.&lt;00000000000..99&gt;" />
                        </dx:ASPxTextBox>
                        <dx:ASPxTextBox ID="edvlr_parcela_03" runat="server" Style="z-index: 2; left: 550px; top: 1020px; position: absolute; right: 223px;"
                            Theme="PlasticBlue" Width="150px"
                            Visible="False" AutoPostBack="True" OnTextChanged="edvlr_parcela_03_TextChanged">
                            <MaskSettings IncludeLiterals="DecimalSymbol" Mask="&lt;0..9999999999999999999g&gt;.&lt;00000000000..99&gt;" />
                        </dx:ASPxTextBox>
                        <dx:ASPxTextBox ID="edvlr_parcela_04" runat="server" Style="z-index: 2; left: 150px; top: 1050px; position: absolute; right: 223px;"
                            Theme="PlasticBlue" Width="150px"
                            Visible="False" AutoPostBack="True" OnTextChanged="edvlr_parcela_04_TextChanged">
                            <MaskSettings IncludeLiterals="DecimalSymbol" Mask="&lt;0..9999999999999999999g&gt;.&lt;00000000000..99&gt;" />
                        </dx:ASPxTextBox>
                        <dx:ASPxTextBox ID="edvlr_parcela_05" runat="server" Style="z-index: 2; left: 350px; top: 1050px; position: absolute; right: 223px;"
                            Theme="PlasticBlue" Width="150px"
                            Visible="False" AutoPostBack="True" OnTextChanged="edvlr_parcela_05_TextChanged">
                            <MaskSettings IncludeLiterals="DecimalSymbol" Mask="&lt;0..9999999999999999999g&gt;.&lt;00000000000..99&gt;" />
                        </dx:ASPxTextBox>
                        <dx:ASPxTextBox ID="edvlr_parcela_06" runat="server" Style="z-index: 2; left: 550px; top: 1050px; position: absolute; right: 223px;"
                            Theme="PlasticBlue" Width="150px"
                            Visible="False" AutoPostBack="True" OnTextChanged="edvlr_parcela_06_TextChanged">
                            <MaskSettings IncludeLiterals="DecimalSymbol" Mask="&lt;0..9999999999999999999g&gt;.&lt;00000000000..99&gt;" />
                        </dx:ASPxTextBox>
                        <dx:ASPxTextBox ID="edvlr_parcela_07" runat="server" Style="z-index: 2; left: 150px; top: 1080px; position: absolute; right: 223px;"
                            Theme="PlasticBlue" Width="150px"
                            Visible="False" AutoPostBack="True" OnTextChanged="edvlr_parcela_07_TextChanged">
                            <MaskSettings IncludeLiterals="DecimalSymbol" Mask="&lt;0..9999999999999999999g&gt;.&lt;00000000000..99&gt;" />
                        </dx:ASPxTextBox>
                        <dx:ASPxTextBox ID="edvlr_parcela_08" runat="server" Style="z-index: 2; left: 350px; top: 1080px; position: absolute; right: 223px;"
                            Theme="PlasticBlue" Width="150px"
                            Visible="False" AutoPostBack="True" OnTextChanged="edvlr_parcela_08_TextChanged">
                            <MaskSettings IncludeLiterals="DecimalSymbol" Mask="&lt;0..9999999999999999999g&gt;.&lt;00000000000..99&gt;" />
                        </dx:ASPxTextBox>
                        <dx:ASPxTextBox ID="edvlr_parcela_09" runat="server" Style="z-index: 2; left: 550px; top: 1080px; position: absolute; right: 223px;"
                            Theme="PlasticBlue" Width="150px"
                            Visible="False" AutoPostBack="True" OnTextChanged="edvlr_parcela_09_TextChanged">
                            <MaskSettings IncludeLiterals="DecimalSymbol" Mask="&lt;0..9999999999999999999g&gt;.&lt;00000000000..99&gt;" />
                        </dx:ASPxTextBox>
                        <dx:ASPxTextBox ID="edvlr_parcela_10" runat="server" Style="z-index: 2; left: 150px; top: 1110px; position: absolute; right: 223px;"
                            Theme="PlasticBlue" Width="150px"
                            Visible="False" AutoPostBack="True" OnTextChanged="edvlr_parcela_10_TextChanged">
                            <MaskSettings IncludeLiterals="DecimalSymbol" Mask="&lt;0..9999999999999999999g&gt;.&lt;00000000000..99&gt;" />
                        </dx:ASPxTextBox>
                        <dx:ASPxTextBox ID="edvlr_parcela_11" runat="server" Style="z-index: 2; left: 350px; top: 1110px; position: absolute; right: 223px;"
                            Theme="PlasticBlue" Width="150px"
                            Visible="False" AutoPostBack="True" OnTextChanged="edvlr_parcela_11_TextChanged">
                            <MaskSettings IncludeLiterals="DecimalSymbol" Mask="&lt;0..9999999999999999999g&gt;.&lt;00000000000..99&gt;" />
                        </dx:ASPxTextBox>
                        <dx:ASPxTextBox ID="edvlr_parcela_12" runat="server" Style="z-index: 2; left: 550px; top: 1110px; position: absolute; right: 223px;"
                            Theme="PlasticBlue" Width="150px"
                            Visible="False" AutoPostBack="True" OnTextChanged="edvlr_parcela_12_TextChanged">
                            <MaskSettings IncludeLiterals="DecimalSymbol" Mask="&lt;0..9999999999999999999g&gt;.&lt;00000000000..99&gt;" />
                        </dx:ASPxTextBox>
                        <asp:Label ID="Label16" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            Font-Size="15px" ForeColor="#3E5395" Style="z-index: 2; left: 9px; top: 1140px; position: absolute"
                            Text="Feedback" Theme="PlasticBlue" Visible="False"></asp:Label>
                        <dx:ASPxTextBox ID="edfeedback" runat="server" Style="z-index: 2; left: 150px; top: 1140px; position: absolute; right: 82px;"
                            Theme="PlasticBlue" Width="600px" Visible="False"
                            ReadOnly="True" Enabled="False">
                        </dx:ASPxTextBox>
                        <div id="Div2" runat="server" style="border: 1px solid #808080; z-index: 2; position: absolute; top: 720px; left: 650px; height: 50px; width: 150px;">
                            ...
                            <dx:ASPxButton ID="btprocessa" runat="server" Height="40px" ImagePosition="Left"
                                ...
                                <Image Height="30px" ToolTip="Gravar Desmembramento Parcela" Url="~/images/BotoesTelas/BTNalterarA.bmp"
                        ...
                        <div runat="server" style="z-index: 2; position: absolute; top: 1200px; left: 10px; height: 200px; width: 378px;"
                            id="Div4">
                            <div>
                            </div>
                                ...
                                <ContentCollection>
                                    <dx:PopupControlContentControl ID="PopupControlContentControl" runat="server">
                                        <div style="vertical-align: middle">
                                            Desmembramento de Parcela em Rajada.<br />
                                            <br />
                                            O Processo de desmembramento da parcela, envolve dividir a parcela em no máximo
                                        doze.
                                        <br />
                                            Durante o processo é feito desmembramento pelo valor atual, e os calculos necessários
                                        para ajuste do VALOR BASE da parcela conforme seu indexador e DATA BASE..<br />
                                            <br />
                                        </div>
