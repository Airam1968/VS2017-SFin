<%@ Page Title="FParcelasProprietarioCNPJ" Language="C#" AutoEventWireup="true" CodeFile="FParcelasProprietarioCNPJ.aspx.cs"
    Inherits="FParcelasProprietarioCNPJ" StylesheetTheme="Principal" %>
...
<head id="Head1" runat="server">
    <title>Gitano - Pagamentos - Parcelas Proprietário CPF/CNPJ</title>
...
<body style="height: 1400px">
    <form id="form1" runat="server">
        ...
        <h2>Pagamento de Parcelas Proprietário CPF/CNPJ</h2>
        <asp:UpdatePanel ID="UpdatePanel" runat="server" style="height: 1400px">
            <ContentTemplate>
                <h1>PAGAMENTOS - PARCELAS</h1>
                <div id="DivNova" style="border-style: none">
                    <div style="border: 1px solid #808080; z-index: 1; left: 35px; top: 100px; position: absolute; height: 1500px; width: 832px; text-align: center;">
                        ...
                        <dx:ASPxComboBox ID="cbcliente_filtro" runat="server" IncrementalFilteringMode="StartsWith"
                            EnableIncrementalFiltering="True" ValueField="cnpj" TextFormatString="{0} ({1}) ({2})"
                            ...
                            DataSourceID="dsfiltro_combo_clientes_cnpj"
                            OnSelectedIndexChanged="cbcliente_filtro_SelectedIndexChanged"
                            LoadingPanelText="Carregando&amp;hellip;">
                            <Columns>
                                <dx:ListBoxColumn FieldName="cnpj" Width="100px" Caption="CPF/CNPJ" />
                        ...
                        <asp:Label ID="Label27" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            ...
                            Text="Vendas" Theme="PlasticBlue" Visible="False"></asp:Label>
                        <dx:ASPxComboBox ID="cbvendas" runat="server" ValueType="System.String" Font-Bold="True"
                            ...
                            OnSelectedIndexChanged="cbvendas_SelectedIndexChanged">
                        </dx:ASPxComboBox>
                        <asp:Label ID="Label3" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            Font-Size="15px" ForeColor="#3E5395" Style="z-index: 2; left: 9px; top: 115px; position: absolute"
                            Text="Produto" Theme="PlasticBlue" Visible="False"></asp:Label>
                        <dx:ASPxComboBox ID="cbproduto" runat="server" ValueType="System.String" Font-Bold="True"
                            Font-Names="Calibri" Font-Size="15px" ForeColor="#3E5395" Style="z-index: 5; position: absolute; font-size: 10pt; top: 115px; left: 150px;"
                            Width="380px" Theme="PlasticBlue"
                        ...
                        <dx:ASPxComboBox ID="cbgrupo" runat="server" ValueType="System.String" Font-Bold="True"
                            Font-Names="Calibri" Font-Size="15px" ForeColor="#3E5395" Style="z-index: 5; position: absolute; font-size: 10pt; top: 150px; left: 150px;"
                            Width="380px" Theme="PlasticBlue"
                        ...
                        <dx:ASPxComboBox ID="cbgrupounidades" runat="server" ValueType="System.String" Font-Bold="True"
                            Font-Names="Calibri" Font-Size="15px" ForeColor="#3E5395" Style="z-index: 5; position: absolute; font-size: 10pt; top: 185px; left: 150px;"
                        ...
                        <asp:RadioButtonList ID="rbmeiolote" runat="server" AutoPostBack="True" CellPadding="0"
                            ...
                            ForeColor="#3E5395" Height="12px" Style="z-index: 2; left: 320px; top: 185px; position: absolute; right: 312px;"
                        ...
                        <dx:ASPxTextBox ID="edcliente" runat="server" Style="z-index: 2; left: 150px; top: 220px; position: absolute; right: 223px;"
                        ...
                        <dx:ASPxDateEdit ID="dtvenda" runat="server" BackColor="#E1E6F2" DisplayFormatString="dd/MM/yyyy"
                            ...
                            Font-Names="Calibri" Font-Size="15px" ForeColor="#3E5395" Height="16px" Style="z-index: 4; position: absolute; margin-right: 5px; left: 150px; top: 255px;"
                            Theme="PlasticBlue"
                        ...
                        <asp:Label ID="Label28" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            Font-Size="15px" ForeColor="#3E5395" Style="z-index: 2; left: 350px; top: 255px; position: absolute"
                            Text="Correção" Theme="PlasticBlue" Visible="False"></asp:Label>
                        <dx:ASPxTextBox ID="edcorrecao" runat="server" Style="z-index: 2; left: 450px; top: 255px; position: absolute; right: 223px;"
                            Theme="PlasticBlue" Width="300px" Visible="False"
                            AutoPostBack="True" ReadOnly="True">
                        </dx:ASPxTextBox>
                        ...
                        <asp:RadioButtonList ID="rbparcelasituacao" runat="server" AutoPostBack="True" CellPadding="0"
                            CellSpacing="0" Font-Names="Calibri" Font-Size="12pt" Font-Strikeout="False"
                            ForeColor="#3E5395" Height="12px" Style="z-index: 2; left: 150px; top: 290px; position: absolute; right: 423px;"
                            Width="300px" RepeatDirection="Horizontal"
                            Visible="False"
                            OnSelectedIndexChanged="rbparcelasituacao_SelectedIndexChanged">
                        ...
                        <dx3:ASPxGridView ID="GridListagem" runat="server" AutoGenerateColumns="False" EnableTheming="True"
                            Font-Bold="False" KeyFieldName="ID" Style="margin-right: 6px; position: absolute; top: 330px; left: 10px;"
                            ...
                            <SettingsBehavior AllowSelectByRowClick="True" ColumnResizeMode="Control"
                                ConfirmDelete="True" AllowSelectSingleRowOnly="True" />
                            ...
                            <Columns>
                                ...
                                <dx3:GridViewDataTextColumn Caption="Vlr Pgto" FieldName="vlr_pagamento"
                                    Name="vlr_pagamento" VisibleIndex="11">
                                ...
                                <dx3:GridViewDataTextColumn Caption="Tipo" FieldName="tipo"
                                    Name="tipo" VisibleIndex="7" Width="50px">
                                ...
                                <dx3:GridViewDataDateColumn Caption="Vencimento" FieldName="data_vencimento"
                                    Name="data_vencimento" SortIndex="0" SortOrder="Ascending" VisibleIndex="8">
                                ...
                                <dx3:GridViewDataTextColumn Caption="Nosso Número" FieldName="nossonumero"
                                    Name="nossonumero" VisibleIndex="16">
                                ...
                                <dx3:GridViewDataTextColumn Caption="Origem Pagamento"
                                    FieldName="origem_pagamento" Name="origem_pagamento" VisibleIndex="17">
                                ...
                                <dx3:GridViewDataCheckColumn Caption="Protesto" FieldName="protesto"
                                    Name="protesto" VisibleIndex="23">
                                    <PropertiesCheckEdit>
                                ...
                                <dx3:GridViewDataTextColumn Caption="% Comissão" FieldName="tx_comissao"
                                    Name="tx_comissao" Visible="False" VisibleIndex="26">
                                ...
                                <dx3:GridViewDataCheckColumn Caption="Ativa" FieldName="ativa" Name="ativa"
                                    ReadOnly="True" VisibleIndex="18" Width="50px">
                                    <PropertiesCheckEdit>
                                        <Style HorizontalAlign="Left">
                                ...
                                <dx3:GridViewDataDateColumn Caption="Pagamento" FieldName="data_pagamento"
                                    Name="data_pagamento" VisibleIndex="10">
                                    <PropertiesDateEdit DisplayFormatString="dd/MM/yyyy" Width="100px">
                                    </PropertiesDateEdit>
                                ...
                                <dx3:GridViewDataCheckColumn Caption="Carteira" FieldName="carteira"
                                    Name="carteira" VisibleIndex="22">
                                    <PropertiesCheckEdit>
                                        <Style HorizontalAlign="Left">
                                ...
                                <dx3:GridViewDataDateColumn Caption="Data Original" FieldName="data_original"
                                    Name="data_original" Visible="False" VisibleIndex="12">
                                    <PropertiesDateEdit DisplayFormatString="dd/MM/yyyy" Width="100px">
                                    </PropertiesDateEdit>
                                ...
                                <dx3:GridViewDataDateColumn Caption="Data Base" FieldName="data_base"
                                    Name="data_base" Visible="False" VisibleIndex="14" Width="100px">
                                    <PropertiesDateEdit DisplayFormatString="dd/MM/yyyy" Width="100px">
                                    </PropertiesDateEdit>
                                ...
                                <dx3:GridViewDataDateColumn Caption="Data Conta" FieldName="data_conta"
                                    Name="data_conta" ReadOnly="True" Visible="False" VisibleIndex="32">
                                ...
                                <dx3:GridViewDataTextColumn Caption="Resíduo Mês" FieldName="residuo_mes"
                                    Name="residuo_mes" Visible="False" VisibleIndex="36">
                                ...
                                <dx3:GridViewDataTextColumn Caption="Valor Correção" FieldName="vlr_correcao"
                                    Name="vlr_correcao" Visible="False" VisibleIndex="28">
                                ...
                                <dx3:GridViewDataTextColumn Caption="Observações" FieldName="observacao"
                                    Name="observacao" Visible="False" VisibleIndex="38">
                                    <EditFormSettings Caption="Observações &gt;" ColumnSpan="2" Visible="True" />
                                </dx3:GridViewDataTextColumn>
                                <dx3:GridViewCommandColumn Caption=" " ShowSelectCheckbox="True"
                        ...
                        <asp:Label ID="Label23" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            Font-Size="15px" ForeColor="#3E5395" Style="z-index: 2; left: 9px; top: 835px; position: absolute"
                            Text="Parcela" Theme="PlasticBlue" Visible="False"></asp:Label>
                        <dx:ASPxTextBox ID="edparcela" runat="server" Style="z-index: 2; left: 150px; top: 835px; position: absolute; right: 223px;"
                        ...
                        <asp:Label ID="Label5" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            Font-Size="15px" ForeColor="#3E5395" Style="z-index: 2; left: 9px; top: 870px; position: absolute"
                            Text="Valor Parcela" Theme="PlasticBlue" Visible="False"></asp:Label>
                        <dx:ASPxTextBox ID="edvlr_parcela" runat="server" Style="z-index: 2; left: 150px; top: 870px; position: absolute; right: 223px;"
                            Theme="PlasticBlue" Width="200px" Visible="False"
                            AutoPostBack="True" ReadOnly="True">
                        ...
                        <asp:Label ID="Label6" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            Font-Size="15px" ForeColor="#3E5395" Style="z-index: 2; left: 9px; top: 905px; position: absolute"
                            Text="Vencimento" Theme="PlasticBlue" Visible="False"></asp:Label>
                        <dx:ASPxTextBox ID="eddtvencimento" runat="server" Style="z-index: 2; left: 150px; top: 905px; position: absolute; right: 223px;"
                            Theme="PlasticBlue" Width="200px" Visible="False"
                            AutoPostBack="True" ReadOnly="True">
                        </dx:ASPxTextBox>
                        <asp:Label ID="Label9" runat="server" BackColor="White" Font-Bold="True" Font-Names="Calibri"
                            Font-Size="15px" ForeColor="#3E5395" Style="z-index: 2; left: 9px; top: 940px; position: absolute"
                        ...
                        <dx:ASPxDateEdit ID="eddtpagamento" runat="server" BackColor="#E1E6F2" DisplayFormatString="dd/MM/yyyy"
                            EditFormat="Custom" EditFormatString="dd/MM/yyyy" EnableTheming="True" Font-Bold="False"
                            Font-Names="Calibri" Font-Size="15px" ForeColor="#3E5395" Height="16px" Style="z-index: 4; position: absolute; margin-right: 5px; left: 150px; top: 940px;"
                            Theme="PlasticBlue"
                            UseMaskBehavior="True" Width="120px" Visible="False" Enabled="False" MinDate="1900-01-01"
                            AutoPostBack="True" OnValueChanged="eddtpagamento_ValueChanged">
                            <CalendarProperties ClearButtonText="Limpar" TodayButtonText="Hoje">
                            </CalendarProperties>
                            <ClientSideEvents KeyDown="function(s, e) 
                                                   {if (!(
                        ...
                        <asp:Label ID="Label25" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            Font-Size="15px" ForeColor="#3E5395" Style="z-index: 2; left: 400px; top: 940px; position: absolute"
                            Text="Formato Recibo" Theme="PlasticBlue" Visible="False"></asp:Label>
                        <asp:RadioButtonList ID="rbrecibo" runat="server" AutoPostBack="True" CellPadding="0"
                            CellSpacing="0" Font-Names="Calibri" Font-Size="12pt" Font-Strikeout="False"
                            ForeColor="#3E5395" Height="12px" Style="z-index: 2; left: 550px; top: 940px; position: absolute; right: 423px;"
                            Width="200px" RepeatDirection="Horizontal"
                            Visible="False">
                            <asp:ListItem Value="0" Selected="True">Retrato</asp:ListItem>
                            <asp:ListItem Value="1">Paisagem</asp:ListItem>
                        </asp:RadioButtonList>
                        <asp:Label ID="Label10" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            Font-Size="15px" ForeColor="#3E5395" Style="z-index: 2; left: 9px; top: 975px; position: absolute"
                            Text="Valor Corr.Monetária" Theme="PlasticBlue"
                            Visible="False"></asp:Label>
                        <dx:ASPxTextBox ID="edvlr_correcao" runat="server" Style="z-index: 2; left: 150px; top: 975px; position: absolute; right: 223px;"
                            Theme="PlasticBlue" Width="200px" Visible="False"
                            AutoPostBack="True" ReadOnly="True">
                            <MaskSettings IncludeLiterals="DecimalSymbol" Mask="&lt;0..9999999999999999999g&gt;.&lt;00000000000..99&gt;" />
                        </dx:ASPxTextBox>
                        <asp:Label ID="Label11" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            Font-Size="15px" ForeColor="#3E5395" Style="z-index: 2; left: 400px; top: 975px; position: absolute"
                            Text="Indexador\Tx.Acum." Theme="PlasticBlue" Visible="False"></asp:Label>
                        <dx:ASPxTextBox ID="edindexador_acum" runat="server" Style="z-index: 2; left: 550px; top: 975px; position: absolute; right: 223px;"
                            Theme="PlasticBlue" Width="200px" Visible="False"
                            AutoPostBack="True" ReadOnly="True">
                        </dx:ASPxTextBox>
                        <dx:ASPxTextBox ID="edindexador_acum2" runat="server" Style="z-index: 2; left: 760px; top: 975px; position: absolute; right: 223px;"
                        ...
                        <asp:Label ID="Label12" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            Font-Size="15px" ForeColor="#3E5395" Style="z-index: 2; left: 9px; top: 1010px; position: absolute"
                            Text="Valor Juros" Theme="PlasticBlue" Visible="False"></asp:Label>
                        <dx:ASPxTextBox ID="edvlr_juros" runat="server" Style="z-index: 2; left: 150px; top: 1010px; position: absolute; right: 223px;"
                            Theme="PlasticBlue" Width="200px" Visible="False"
                            AutoPostBack="True" ReadOnly="True">
                            <MaskSettings IncludeLiterals="DecimalSymbol" Mask="&lt;0..9999999999999999999g&gt;.&lt;00000000000..99&gt;" />
                        </dx:ASPxTextBox>
                        <asp:Label ID="Label14" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            Font-Size="15px" ForeColor="#3E5395" Style="z-index: 2; left: 400px; top: 1010px; position: absolute"
                            Text="Taxa Juros\Tx. Acum." Theme="PlasticBlue"
                            Visible="False"></asp:Label>
                        <dx:ASPxTextBox ID="edjuros_acum" runat="server" Style="z-index: 2; left: 550px; top: 1010px; position: absolute; right: 223px;"
                            Theme="PlasticBlue" Width="200px" Visible="False"
                            AutoPostBack="True" ReadOnly="True">
                        </dx:ASPxTextBox>
                        <dx:ASPxTextBox ID="edjuros_acum2" runat="server" Style="z-index: 2; left: 760px; top: 1010px; position: absolute; right: 223px;"
                            Theme="PlasticBlue" Width="50px" Visible="False"
                            AutoPostBack="True" ReadOnly="True">
                        </dx:ASPxTextBox>
                        <asp:Label ID="Label15" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            Font-Size="15px" ForeColor="#3E5395" Style="z-index: 2; left: 9px; top: 1045px; position: absolute"
                            Text="Valor Multa" Theme="PlasticBlue" Visible="False"></asp:Label>
                        <dx:ASPxTextBox ID="edvlr_multa" runat="server" Style="z-index: 2; left: 150px; top: 1045px; position: absolute; right: 223px;"
                            Theme="PlasticBlue" Width="200px" Visible="False"
                            AutoPostBack="True" ReadOnly="True">
                            <MaskSettings IncludeLiterals="DecimalSymbol" Mask="&lt;0..9999999999999999999g&gt;.&lt;00000000000..99&gt;" />
                        </dx:ASPxTextBox>
                        <asp:Label ID="Label16" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            Font-Size="15px" ForeColor="#3E5395" Style="z-index: 2; left: 400px; top: 1045px; position: absolute"
                            Text="Taxa Multa" Theme="PlasticBlue" Visible="False"></asp:Label>
                        <dx:ASPxTextBox ID="edtaxa_multa" runat="server" Style="z-index: 2; left: 550px; top: 1045px; position: absolute; right: 223px;"
                            Theme="PlasticBlue" Width="200px" Visible="False"
                            AutoPostBack="True" ReadOnly="True">
                        </dx:ASPxTextBox>
                        <asp:Label ID="Label17" runat="server" BackColor="White" Font-Bold="True" Font-Names="Calibri"
                            Font-Size="15px" ForeColor="#3E5395" Style="z-index: 2; left: 9px; top: 1080px; position: absolute"
                            Text="Valor Pago" Theme="PlasticBlue" Visible="False"></asp:Label>
                        <dx:ASPxTextBox ID="edvlr_pagamento" runat="server" Style="z-index: 2; left: 150px; top: 1080px; position: absolute; right: 223px;"
                            Theme="PlasticBlue" Width="200px" Visible="False"
                            AutoPostBack="True" OnTextChanged="edvlr_pagamento_TextChanged">
                            <MaskSettings IncludeLiterals="DecimalSymbol" Mask="&lt;0..9999999999999999999g&gt;.&lt;00000000000..99&gt;" />
                        </dx:ASPxTextBox>
                        <asp:Label ID="Label18" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            Font-Size="15px" ForeColor="#3E5395" Style="z-index: 2; left: 400px; top: 1080px; position: absolute"
                            Text="Diferença Mes\Dias" Theme="PlasticBlue" Visible="False"></asp:Label>
                        <dx:ASPxTextBox ID="eddiferenca" runat="server" Style="z-index: 2; left: 550px; top: 1080px; position: absolute; right: 223px;"
                            Theme="PlasticBlue" Width="200px" Visible="False"
                            AutoPostBack="True" ReadOnly="True">
                        </dx:ASPxTextBox>
                        <asp:Label ID="Label19" runat="server" BackColor="White" Font-Bold="True" Font-Names="Calibri"
                            Font-Size="15px" ForeColor="#3E5395" Style="z-index: 2; left: 9px; top: 1115px; position: absolute"
                            Text="Valor Desconto" Theme="PlasticBlue"
                            Visible="False"></asp:Label>
                        <dx:ASPxTextBox ID="edvlr_desconto" runat="server" Style="z-index: 2; left: 150px; top: 1115px; position: absolute; right: 223px;"
                            Theme="PlasticBlue" Width="200px" Visible="False"
                            AutoPostBack="True" OnTextChanged="edvlr_desconto_TextChanged">
                            <MaskSettings IncludeLiterals="DecimalSymbol" Mask="&lt;0..9999999999999999999g&gt;.&lt;00000000000..99&gt;" />
                        </dx:ASPxTextBox>
                        <asp:Label ID="Label20" runat="server" BackColor="White" Font-Bold="True" Font-Names="Calibri"
                            Font-Size="15px" ForeColor="#3E5395" Style="z-index: 2; left: 9px; top: 1150px; position: absolute"
                            Text="Valor Final Pago" Theme="PlasticBlue"
                            Visible="False"></asp:Label>
                        <dx:ASPxTextBox ID="edvlr_pagofinal" runat="server" Style="z-index: 2; left: 150px; top: 1150px; position: absolute; right: 223px;"
                            Theme="PlasticBlue" Width="200px" Visible="False"
                            AutoPostBack="True">
                            <MaskSettings IncludeLiterals="DecimalSymbol" Mask="&lt;0..9999999999999999999g&gt;.&lt;00000000000..99&gt;" />
                        </dx:ASPxTextBox>
                        <asp:Label ID="Label21" runat="server" BackColor="White" Font-Bold="True" Font-Names="Calibri"
                            Font-Size="15px" ForeColor="#3E5395" Style="z-index: 2; left: 9px; top: 1185px; position: absolute"
                            Text="Forma Pagamento" Theme="PlasticBlue"
                            Visible="False"></asp:Label>
                        <dx:ASPxComboBox ID="cbformapagamento" runat="server" ValueType="System.String" Font-Bold="True"
                            Font-Names="Calibri" Font-Size="15px" ForeColor="#3E5395" Style="z-index: 5; position: absolute; font-size: 10pt; top: 1185px; left: 150px;"
                            Width="380px" Theme="PlasticBlue"
                            Visible="False" AutoPostBack="True">
                        </dx:ASPxComboBox>
                        <asp:Label ID="Label22" runat="server" BackColor="White" Font-Bold="True" Font-Names="Calibri"
                            Font-Size="15px" ForeColor="#3E5395" Style="z-index: 2; left: 9px; top: 1220px; position: absolute"
                            Text="Conta Corrente" Theme="PlasticBlue"
                            Visible="False"></asp:Label>
                        <dx:ASPxComboBox ID="cbcontascorrentes" runat="server"
                            ValueType="System.String" Font-Bold="True"
                            Font-Names="Calibri" Font-Size="15px" ForeColor="#3E5395" Style="z-index: 5; position: absolute; font-size: 10pt; top: 1220px; left: 150px;"
                            Width="380px" Theme="PlasticBlue"
                            Visible="False" AutoPostBack="True">
                        </dx:ASPxComboBox>
                        <asp:Label ID="Label24" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            Font-Size="15px" ForeColor="#3E5395" Style="z-index: 2; left: 9px; top: 1255px; position: absolute"
                            Text="Feedback" Theme="PlasticBlue" Visible="False"></asp:Label>
                        <dx:ASPxTextBox ID="edfeedback" runat="server" Style="z-index: 2; left: 150px; top: 1255px; position: absolute; right: 223px;"
                            Theme="PlasticBlue" Width="600px" Visible="False"
                            AutoPostBack="True" ReadOnly="True">
                        </dx:ASPxTextBox>
                        <div id="Div2" runat="server" style="border: 1px solid #808080; z-index: 2; position: absolute; top: 835px; left: 550px; height: 50px; width: 250px;">
                            ...
                            <dx:ASPxButton ID="btcalcula" runat="server" Height="40px" ImagePosition="Left"
                                OnClick="btcalcula_Click" Width="45px">
                                <Image Height="30px" ToolTip="Calcular Pagamento" Url="~/images/BotoesTelas/BTNincluirA.bmp" UrlDisabled="~/images/BotoesTelas/BTNincluirI.bmp"
                                    UrlPressed="~/images/BotoesTelas/BTNincluirS.bmp" Width="30px">
                                </Image>
                            </dx:ASPxButton>
                            <dx:ASPxButton ID="btprocessa" runat="server" Height="40px" ImagePosition="Left"
                                OnClick="btprocessa_Click" Width="45px">
                                <Image Height="30px" ToolTip="Gravar Pagamento Parcela" Url="~/images/BotoesTelas/BTNalterarA.bmp" UrlDisabled="~/images/BotoesTelas/BTNalterarI.bmp"
                                    UrlPressed="~/images/BotoesTelas/BTNalterarS.bmp" Width="30px">
                                </Image>
                            </dx:ASPxButton>
                            <dx:ASPxButton ID="btimprime" runat="server" Height="40px" ImagePosition="Left"
                                Width="45px" OnClick="btimprime_Click">
                                <Image Height="30px" ToolTip="Imprimir Recibo" Url="~/images/BotoesTelas/BTNimprimirA.bmp" UrlDisabled="~/images/BotoesTelas/BTNimprimirI.bmp"
                        ...
                        <div runat="server" style="z-index: 2; position: absolute; top: 1350px; left: 10px; height: 200px; width: 378px;"
                            id="Div4">
                            <div>
                            </div>
                                ...
                                <ContentCollection>
                                    <dx:PopupControlContentControl ID="PopupControlContentControl" runat="server">
                                        <div style="vertical-align: middle">
                                            Pagamento de Parcela Proprietário.<br />
                                            <br />
                                            O Processo de pagamento da parcela, envolve a data do pagamento a partir dai o sistema efetua os calculos conforme foram estabelecidos no momento da venda para pagamento de parcelas e inadimplência.<br />
                                            <br />
                                        </div>
                    ...
                    <asp:ObjectDataSource ID="dsfiltro_combo_clientes_cnpj" runat="server" OldValuesParameterFormatString="original_{0}{1}{2}"
                        SelectMethod="filtro_combo_contato_cnpj" TypeName="uContato">
                        <SelectParameters>
                            <asp:SessionParameter Name="valor_inicio" SessionField="cnpj" Type="String" />
