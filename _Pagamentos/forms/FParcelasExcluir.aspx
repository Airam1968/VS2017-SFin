<%@ Page Title="FParcelasExcluir" Language="C#" AutoEventWireup="true" CodeFile="FParcelasExcluir.aspx.cs"
    Inherits="FParcelasExcluir" StylesheetTheme="Principal" %>
...
<head id="Head1" runat="server">
    <title>Gitano - Pagamentos - Excluir</title>
...
<body style="height: 1400px">
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="UpdatePanel" runat="server" style="height: 1400px">
            <ContentTemplate>
                <h1>EXCLUIR - PARCELAS</h1>
                <h2>Exclusão de Parcelas</h2>
                        ...
                        <dx3:ASPxGridView ID="GridListagem" runat="server" AutoGenerateColumns="False" EnableTheming="True"
                            ...
                            <Columns>
                                ...
                                <dx3:GridViewDataDateColumn Caption="Vencimento" FieldName="data_vencimento"
                                    Name="data_vencimento" VisibleIndex="8">
                                ...
                                <dx3:GridViewDataTextColumn Caption="Conta" FieldName="conta" Name="conta"
                                    Visible="False" VisibleIndex="19" Width="50px">
                                ...
                                <ContentCollection>
                                    <dx:PopupControlContentControl ID="PopupControlContentControl" runat="server">
                                        <div style="vertical-align: middle">
                                            Excluir Parcela.<br />
                                            <br />
                                            O Processo de Excluir uma parcela nova em um financiamento é uma situação extraordinária e não deve ser utilizada sem critério. O Contrato assinado pelas partes rege o gerenciamento do contrato, caso exista erro no momento da venda, o correto é refazer a venda.<br />
                                            <br />
                                            Sendo necessário Excluir a parcela devemos observar que a parcela só poderá ser excluida se estiver em aberto ou seja, sem pagamento.<br />
                                            <br />
