<%@ Page Title="FParcelasContabil" Language="C#" AutoEventWireup="true" CodeFile="FParcelasPeriodicidade.aspx.cs"
    Inherits="FParcelasContabil" StylesheetTheme="Principal" %>
...
<head id="Head1" runat="server">
    <title>Gitano - Pagamentos - Periodicidade juros</title>
...
<body style="height: 1400px">
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="UpdatePanel" runat="server" style="height: 1400px">
            <ContentTemplate>
                <h1>CONTÁBIL - PARCELAS</h1>
                <h2>Periodicidade juros de Parcelas</h2>
                <div id="DivNova" style="border-style: none">
                    <div style="border: 1px solid #808080; z-index: 1; left: 35px; top: 100px; position: absolute; height: 1200px; width: 832px; text-align: center;">
                        ...
                        <asp:Label ID="Label9" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            ...
                            Text="Ação" Theme="PlasticBlue" Visible="False"></asp:Label>
                        ...
                        <dx3:ASPxGridView ID="GridListagem" runat="server" AutoGenerateColumns="False" EnableTheming="True"
                            ...
                            <Columns>
                                ...
                                <dx3:GridViewDataTextColumn Caption="Origem Pagamento" FieldName="origem_pagamento"
                                    Name="origem_pagamento" Visible="False" VisibleIndex="18">
                                ...
                                <dx3:GridViewDataCheckColumn Caption="Protesto" FieldName="protesto"
                                    Name="protesto" VisibleIndex="16" Visible="False">
                                    <PropertiesCheckEdit>
                                ...
                                <dx3:GridViewDataTextColumn Caption="% Correção" FieldName="percentual_correcao"
                                    Name="percentual_correcao" Visible="False" VisibleIndex="23">
                                ...
                                <dx3:GridViewDataTextColumn Caption="Periodicidade" FieldName="periodicidade_comissao"
                                    Name="periodicidade_comissao" VisibleIndex="17">
                                ...
                                <ContentCollection>
                                    <dx:PopupControlContentControl ID="PopupControlContentControl" runat="server">
                                        <div style="vertical-align: middle">
                                            Protesto de Parcelas.<br />
                                            <br />
                                            Caso a Cobrança seja Bancária, o usuário poderá habilitar o protesto automático
                                        do título, caso não haja pagamento.<br />
                                            <br />
                                            Com isso quando o título der entrada no banco, ele será acompanhado pela ordem de
                                        protesto caso não haja pagamento.<br />
                                            <br />
                                            A Instrução de Protesto é valida para cada uma das parcelas, portanto é individual.<br />
                                            <br />
                                        </div>
