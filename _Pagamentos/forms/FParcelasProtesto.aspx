<%@ Page Title="FParcelasProtesto" Language="C#" AutoEventWireup="true" CodeFile="FParcelasProtesto.aspx.cs"
    Inherits="FParcelasProtesto" StylesheetTheme="Principal" %>
...
<head id="Head1" runat="server">
    <title>Gitano - Pagamentos - Protesto</title>
...
<body style="height: 1400px">
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="UpdatePanel" runat="server" style="height: 1400px">
            <ContentTemplate>
                <h1>PROTESTO - PARCELAS</h1>
                <h2>Protesto de Parcelas</h2>
                <div id="DivNova" style="border-style: none">
                    <div style="border: 1px solid #808080; z-index: 1; left: 35px; top: 100px; position: absolute; height: 1200px; width: 832px; text-align: center;">
                        ...
                        <asp:RadioButtonList ID="rbprotesto" runat="server" AutoPostBack="True" CellPadding="0"
                            ...
                            Width="300px" RepeatDirection="Horizontal"
                            Visible="False">
                            <asp:ListItem Value="0">Protestar</asp:ListItem>
                            <asp:ListItem Value="1">Não Protestar</asp:ListItem>
                        </asp:RadioButtonList>
