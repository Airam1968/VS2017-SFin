<%@ Page Title="FCobrancaConfiguracao" Language="C#" AutoEventWireup="true" CodeFile="FCobrancaConfiguracao.aspx.cs"
    Inherits="FCobrancaConfiguracao" StylesheetTheme="Principal" %>
...
<head id="Head1" runat="server">
    <title>Gitano - Cobrança Bancária - Configuração</title>
                ...
                <div id="DivNova" style="border-style: none">
                    <div style="border: 1px solid #808080; z-index: 1; left: 35px; top: 100px; position: absolute; height: 1200px; width: 832px; text-align: center;">
                        ...
                        <asp:Label ID="Label3" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            ...
                            Text="Banco" Theme="PlasticBlue"></asp:Label>
                        ...
                        <asp:Label ID="Label23" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            ...
                            Text="Ultima Atualização" Theme="PlasticBlue" Visible="False"></asp:Label>
                        ...
                        <asp:Label ID="Label5" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            ...
                            Text="Drive Dados" Theme="PlasticBlue" Visible="False"></asp:Label>
                        <dx:ASPxTextBox ID="eddrivedados" runat="server" Style="z-index: 2; left: 150px; top: 85px; position: absolute; right: 223px;"
                        ...
                        <asp:Label ID="Label6" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            ...
                            Text="Pasta Remessa" Theme="PlasticBlue" Visible="False"></asp:Label>
                        <dx:ASPxTextBox ID="edpastaremessa" runat="server" Style="z-index: 2; left: 150px; top: 120px; position: absolute; right: 223px;"
                            Theme="PlasticBlue" Width="400px" Visible="False"
                            AutoPostBack="True">
                        </dx:ASPxTextBox>
                        <dx:ASPxTextBox ID="edextensaoremessa" runat="server" Style="z-index: 2; left: 560px; top: 120px; position: absolute; right: 223px;"
                        ...
                        <asp:Label ID="Label2" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            ...
                            Text="Pasta Retorno" Theme="PlasticBlue" Visible="False"></asp:Label>
                        <dx:ASPxTextBox ID="edpastaretorno" runat="server" Style="z-index: 2; left: 150px; top: 155px; position: absolute; right: 223px;"
                            Theme="PlasticBlue" Width="400px" Visible="False"
                            AutoPostBack="True">
                        </dx:ASPxTextBox>
                        <dx:ASPxTextBox ID="edextensaoretorno" runat="server" Style="z-index: 2; left: 560px; top: 155px; position: absolute; right: 223px;"
                            Theme="PlasticBlue" Width="100px" Visible="False"
                            AutoPostBack="True">
                        </dx:ASPxTextBox>
                        <asp:Label ID="Label4" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            ...
                            Text="Pasta Envelope" Theme="PlasticBlue" Visible="False"></asp:Label>
                        <dx:ASPxTextBox ID="edpastaenvelope" runat="server" Style="z-index: 2; left: 150px; top: 190px; position: absolute; right: 282px;"
                            Theme="PlasticBlue" Width="400px" Visible="False"
                            AutoPostBack="True">
                        </dx:ASPxTextBox>
                        <asp:Label ID="Label16" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            ...
                            Text="Assunto" Theme="PlasticBlue" Visible="False"></asp:Label>
                        <dx:ASPxTextBox ID="edassunto" runat="server" Style="z-index: 2; left: 150px; top: 225px; position: absolute; right: 282px;"
                            Theme="PlasticBlue" Width="400px" Visible="False"
                            AutoPostBack="True">
                        </dx:ASPxTextBox>
                        <asp:Label ID="Label7" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            ...
                            Text="Devolução Título (Dias)" Theme="PlasticBlue" Visible="False"></asp:Label>
                        <dx:ASPxTextBox ID="eddevolucaotitulos" runat="server" Style="z-index: 2; left: 150px; top: 260px; position: absolute; right: 282px;"
                            Theme="PlasticBlue" Width="100px" Visible="False"
                            AutoPostBack="True">
                        </dx:ASPxTextBox>
                        <asp:Label ID="Label8" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            ...
                            Text="Protesto (Dias)" Theme="PlasticBlue" Visible="False"></asp:Label>
                        <dx:ASPxTextBox ID="edprotesto" runat="server" Style="z-index: 2; left: 150px; top: 295px; position: absolute; right: 282px;"
                            Theme="PlasticBlue" Width="100px" Visible="False"
                            AutoPostBack="True">
                        </dx:ASPxTextBox>
                        <asp:Label ID="Label9" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            ...
                            Text="Cobrança Multa (Dias)" Theme="PlasticBlue" Visible="False"></asp:Label>
                        <dx:ASPxTextBox ID="edcobrancamulta" runat="server" Style="z-index: 2; left: 150px; top: 330px; position: absolute; right: 582px;"
                            Theme="PlasticBlue" Width="100px" Visible="False"
                            AutoPostBack="True">
                        </dx:ASPxTextBox>
                        ...
                        <dx:ASPxTextBox ID="edmulta" runat="server" Style="z-index: 2; left: 150px; top: 365px; position: absolute; right: 282px;"
                            Theme="PlasticBlue" Width="100px" Visible="False"
                            AutoPostBack="True">
                        </dx:ASPxTextBox>
                        <asp:Label ID="Label11" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            ...
                            Text="Juros (%)" Theme="PlasticBlue" Visible="False"></asp:Label>
                        <dx:ASPxTextBox ID="edjuros" runat="server" Style="z-index: 2; left: 150px; top: 400px; position: absolute; right: 282px;"
                            Theme="PlasticBlue" Width="100px" Visible="False"
                            AutoPostBack="True">
                        </dx:ASPxTextBox>
                        <asp:Label ID="Label12" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            ...
                            Text="Com.Permanência (%)" Theme="PlasticBlue" Visible="False"></asp:Label>
                        <dx:ASPxTextBox ID="edcomissao" runat="server" Style="z-index: 2; left: 150px; top: 435px; position: absolute; right: 282px;"
                            Theme="PlasticBlue" Width="100px" Visible="False"
                            AutoPostBack="True">
                        </dx:ASPxTextBox>
                        <asp:Label ID="Label13" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            Font-Size="15px" ForeColor="#3E5395" Style="z-index: 2; left: 9px; top: 470px; position: absolute"
                            Text="Caixa Postal" Theme="PlasticBlue" Visible="False"></asp:Label>
                        <dx:ASPxTextBox ID="edcaixapostal" runat="server" Style="z-index: 2; left: 150px; top: 470px; position: absolute; right: 282px;"
                            Theme="PlasticBlue" Width="100px" Visible="False"
                            AutoPostBack="True">
                        </dx:ASPxTextBox>
                        <asp:Label ID="Label14" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            Font-Size="15px" ForeColor="#3E5395" Style="z-index: 2; left: 9px; top: 505px; position: absolute"
                            Text="Remessa No." Theme="PlasticBlue" Visible="False"></asp:Label>
                        <dx:ASPxTextBox ID="edremessa" runat="server" Style="z-index: 2; left: 150px; top: 505px; position: absolute; right: 282px;"
                            Theme="PlasticBlue" Width="100px" Visible="False"
                            AutoPostBack="True">
                        </dx:ASPxTextBox>
                        <asp:Label ID="Label15" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            Font-Size="15px" ForeColor="#3E5395" Style="z-index: 2; left: 9px; top: 540px; position: absolute"
                            Text="Carteira No." Theme="PlasticBlue" Visible="False"></asp:Label>
                        <dx:ASPxTextBox ID="edcarteira" runat="server" Style="z-index: 2; left: 150px; top: 540px; position: absolute; right: 282px;"
                            Theme="PlasticBlue" Width="100px" Visible="False"
                            AutoPostBack="True">
                        </dx:ASPxTextBox>
                        <asp:Label ID="Label17" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            Font-Size="15px" ForeColor="#3E5395" Style="z-index: 2; left: 9px; top: 575px; position: absolute"
                            Text="No. Inicial-Final" Theme="PlasticBlue" Visible="False"></asp:Label>
                        <dx:ASPxTextBox ID="ednuminicial" runat="server" Style="z-index: 2; left: 150px; top: 575px; position: absolute; right: 282px;"
                            Theme="PlasticBlue" Width="100px" Visible="False"
                            AutoPostBack="True">
                        </dx:ASPxTextBox>
                        <dx:ASPxTextBox ID="ednumfinal" runat="server" Style="z-index: 2; left: 300px; top: 575px; position: absolute; right: 282px;"
                            Theme="PlasticBlue" Width="100px" Visible="False"
                            AutoPostBack="True">
                        </dx:ASPxTextBox>
                        <asp:Label ID="Label18" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            Font-Size="15px" ForeColor="#3E5395" Style="z-index: 2; left: 9px; top: 610px; position: absolute"
                            Text="No. Atual" Theme="PlasticBlue" Visible="False"></asp:Label>
                        <dx:ASPxTextBox ID="ednumatual" runat="server" Style="z-index: 2; left: 150px; top: 610px; position: absolute; right: 282px;"
                            Theme="PlasticBlue" Width="100px" Visible="False"
                            AutoPostBack="True">
                        </dx:ASPxTextBox>
                        <asp:Label ID="Label19" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            Font-Size="15px" ForeColor="#3E5395" Style="z-index: 2; left: 9px; top: 645px; position: absolute"
                            Text="Complemento" Theme="PlasticBlue" Visible="False"></asp:Label>
                        <dx:ASPxTextBox ID="edcomplemento" runat="server" Style="z-index: 2; left: 150px; top: 645px; position: absolute; right: 582px;"
                            Theme="PlasticBlue" Width="100px" Visible="False"
                            AutoPostBack="True">
                        </dx:ASPxTextBox>
                        <asp:Label ID="Label20" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            Font-Size="15px" ForeColor="#3E5395" Style="z-index: 2; left: 9px; top: 680px; position: absolute"
                            Text="Ultimo Arquivo" Theme="PlasticBlue"
                            Visible="False"></asp:Label>
                        <dx:ASPxTextBox ID="ednomearquivo" runat="server" Style="z-index: 2; left: 150px; top: 680px; position: absolute; right: 582px;"
                        ...
                        <asp:Label ID="Label21" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            ...
                            Text="Numero Arquivo" Theme="PlasticBlue" Visible="False"></asp:Label>
                        <dx:ASPxTextBox ID="ednumeroarquivo" runat="server" Style="z-index: 2; left: 150px; top: 715px; position: absolute; right: 582px;"
                            Theme="PlasticBlue" Width="100px" Visible="False"
                            AutoPostBack="True">
                        </dx:ASPxTextBox>
                        ...
                        <dx:ASPxTextBox ID="edfeedback" runat="server" Style="z-index: 2; left: 150px; top: 750px; position: absolute; right: 82px;"
                            Theme="PlasticBlue" Width="600px" Visible="False"
                            AutoPostBack="True" ReadOnly="True">
                        </dx:ASPxTextBox>
                        <div id="Div2" runat="server" style="border: 1px solid #808080; z-index: 2; position: absolute; top: 15px; left: 700px; height: 50px; width: 100px; bottom: 1133px;">
