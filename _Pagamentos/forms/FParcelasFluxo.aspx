<%@ Page Title="FParcelasFluxo" Language="C#" AutoEventWireup="true" CodeFile="FParcelasFluxo.aspx.cs"
    Inherits="FParcelasFluxo" StylesheetTheme="Principal" %>
...
<head id="Head1" runat="server">
    <title>Gitano - Pagamentos - Fluxo</title>
                    ...
                    <div style="border: 1px solid #808080; z-index: 1; left: 35px; top: 100px; position: absolute; height: 1200px; width: 832px; text-align: center;">
                        ...
                        <div id="Div2" runat="server" style="border: 1px solid #808080; z-index: 2; position: absolute; top: 720px; left: 650px; height: 50px; width: 150px;">
                            ...
                            <dx:ASPxButton ID="btprocessa" runat="server" Height="40px" ImagePosition="Left"
                                ...
                                <Image Height="30px" ToolTip="Processa Alteração" Url="~/images/BotoesTelas/BTNalterarA.bmp"
                                ...
                                <ContentCollection>
                                    <dx:PopupControlContentControl ID="PopupControlContentControl" runat="server">
                                        <div style="vertical-align: middle">
                                            Alterar Parcelas Fluxo Financeiro.<br />
                                            <br />
                                            O Processo de alterar uma parcela em um financiamento e uma situação extraordinária
