<%@ Page Title="FParcelas" Language="C#" AutoEventWireup="true" CodeFile="FParcelas.aspx.cs"
    Inherits="FParcelas" StylesheetTheme="Principal" %>
...
<head id="Head1" runat="server">
    <title>Gitano - Pagamentos - Parcelas</title>
                ...
                <div id="DivNova" style="border-style: none">
                    <div style="border: 1px solid #808080; z-index: 1; left: 35px; top: 100px; position: absolute; height: 1500px; width: 832px; text-align: center;">
                        ...
                        <asp:Label ID="Label26" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            Font-Size="15px" ForeColor="#3E5395" Style="z-index: 2; left: 350px; top: 155px; position: absolute"
                            Text="Correção" Theme="PlasticBlue" Visible="False"></asp:Label>
                        <dx:ASPxTextBox ID="edcorrecao" runat="server" Style="z-index: 2; left: 450px; top: 155px; position: absolute; right: 223px;"
                        ...
                        <asp:Label ID="Label23" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            Font-Size="15px" ForeColor="#3E5395" Style="z-index: 2; left: 9px; top: 720px; position: absolute"
                            Text="Parcela" Theme="PlasticBlue" Visible="False"></asp:Label>
                        <dx:ASPxTextBox ID="edparcela" runat="server" Style="z-index: 2; left: 150px; top: 720px; position: absolute; right: 223px;"
                        ...
                        <dx:ASPxTextBox ID="eddtvencimento" runat="server" Style="z-index: 2; left: 150px; top: 780px; position: absolute; right: 223px;"
                            Theme="PlasticBlue" Width="200px" Visible="False"
                            AutoPostBack="True" ReadOnly="True">
                        </dx:ASPxTextBox>
                        <asp:Label ID="Label9" runat="server" BackColor="White" Font-Bold="True" Font-Names="Calibri"
                            Font-Size="15px" ForeColor="#3E5395" Style="z-index: 2; left: 9px; top: 810px; position: absolute"
                        ...
                        <dx:ASPxDateEdit ID="eddtpagamento" runat="server" BackColor="#E1E6F2" DisplayFormatString="dd/MM/yyyy"
                            EditFormat="Custom" EditFormatString="dd/MM/yyyy" EnableTheming="True" Font-Bold="False"
                            Font-Names="Calibri" Font-Size="15px" ForeColor="#3E5395" Height="16px" Style="z-index: 4; position: absolute; margin-right: 5px; left: 150px; top: 810px;"
                            Theme="PlasticBlue"
                            UseMaskBehavior="True" Width="120px" Visible="False" Enabled="False" MinDate="1900-01-01"
                        ...
                        <asp:Label ID="Label25" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            Font-Size="15px" ForeColor="#3E5395" Style="z-index: 2; left: 400px; top: 810px; position: absolute"
                        ...
                        <asp:RadioButtonList ID="rbrecibo" runat="server" AutoPostBack="True" CellPadding="0"
                            CellSpacing="0" Font-Names="Calibri" Font-Size="12pt" Font-Strikeout="False"
                            ForeColor="#3E5395" Height="12px" Style="z-index: 2; left: 550px; top: 810px; position: absolute; right: 423px;"
                            Width="200px" RepeatDirection="Horizontal"
                            Visible="False">
                        ...
                        <asp:Label ID="Label10" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            Font-Size="15px" ForeColor="#3E5395" Style="z-index: 2; left: 9px; top: 840px; position: absolute"
                            Text="Valor Corr.Monetária" Theme="PlasticBlue"
                            Visible="False"></asp:Label>
                        <dx:ASPxTextBox ID="edvlr_correcao" runat="server" Style="z-index: 2; left: 150px; top: 840px; position: absolute; right: 223px;"
                            Theme="PlasticBlue" Width="200px" Visible="False"
                            AutoPostBack="True" ReadOnly="True">
                            <MaskSettings IncludeLiterals="DecimalSymbol" Mask="&lt;0..9999999999999999999g&gt;.&lt;00000000000..99&gt;" />
                        </dx:ASPxTextBox>
                        <asp:Label ID="Label11" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            Font-Size="15px" ForeColor="#3E5395" Style="z-index: 2; left: 400px; top: 840px; position: absolute"
                            Text="Indexador\Tx.Acum." Theme="PlasticBlue" Visible="False"></asp:Label>
                        <dx:ASPxTextBox ID="edindexador_acum" runat="server" Style="z-index: 2; left: 550px; top: 840px; position: absolute; right: 223px;"
                            Theme="PlasticBlue" Width="200px" Visible="False"
                            AutoPostBack="True" ReadOnly="True">
                        </dx:ASPxTextBox>
                        <dx:ASPxTextBox ID="edindexador_acum2" runat="server" Style="z-index: 2; left: 760px; top: 840px; position: absolute; right: 223px;"
                        ...
                        <dx:ASPxTextBox ID="edvlr_juros" runat="server" Style="z-index: 2; left: 150px; top: 870px; position: absolute; right: 223px;"
                            Theme="PlasticBlue" Width="200px" Visible="False"
                            AutoPostBack="True" ReadOnly="True">
                            <MaskSettings IncludeLiterals="DecimalSymbol" Mask="&lt;0..9999999999999999999g&gt;.&lt;00000000000..99&gt;" />
                        </dx:ASPxTextBox>
                        <asp:Label ID="Label14" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            Font-Size="15px" ForeColor="#3E5395" Style="z-index: 2; left: 400px; top: 870px; position: absolute"
                            Text="Taxa Juros\Tx. Acum." Theme="PlasticBlue"
                            Visible="False"></asp:Label>
                        <dx:ASPxTextBox ID="edjuros_acum" runat="server" Style="z-index: 2; left: 550px; top: 870px; position: absolute; right: 223px;"
                            Theme="PlasticBlue" Width="200px" Visible="False"
                            AutoPostBack="True" ReadOnly="True">
                        </dx:ASPxTextBox>
                        <dx:ASPxTextBox ID="edjuros_acum2" runat="server" Style="z-index: 2; left: 760px; top: 870px; position: absolute; right: 223px;"
                            Theme="PlasticBlue" Width="50px" Visible="False"
                            AutoPostBack="True" ReadOnly="True">
                        </dx:ASPxTextBox>
                        <asp:Label ID="Label15" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            Font-Size="15px" ForeColor="#3E5395" Style="z-index: 2; left: 9px; top: 900px; position: absolute"
                            Text="Valor Multa" Theme="PlasticBlue" Visible="False"></asp:Label>
                        <dx:ASPxTextBox ID="edvlr_multa" runat="server" Style="z-index: 2; left: 150px; top: 900px; position: absolute; right: 223px;"
                            Theme="PlasticBlue" Width="200px" Visible="False"
                            AutoPostBack="True" ReadOnly="True">
                            <MaskSettings IncludeLiterals="DecimalSymbol" Mask="&lt;0..9999999999999999999g&gt;.&lt;00000000000..99&gt;" />
                        </dx:ASPxTextBox>
                        <asp:Label ID="Label16" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            Font-Size="15px" ForeColor="#3E5395" Style="z-index: 2; left: 400px; top: 900px; position: absolute"
                            Text="Taxa Multa" Theme="PlasticBlue" Visible="False"></asp:Label>
                        <dx:ASPxTextBox ID="edtaxa_multa" runat="server" Style="z-index: 2; left: 550px; top: 900px; position: absolute; right: 223px;"
                            Theme="PlasticBlue" Width="200px" Visible="False"
                            AutoPostBack="True" ReadOnly="True">
                        </dx:ASPxTextBox>
                        <asp:Label ID="Label17" runat="server" BackColor="White" Font-Bold="True" Font-Names="Calibri"
                            Font-Size="15px" ForeColor="#3E5395" Style="z-index: 2; left: 9px; top: 930px; position: absolute"
                            Text="Valor Pago" Theme="PlasticBlue" Visible="False"></asp:Label>
                        <dx:ASPxTextBox ID="edvlr_pagamento" runat="server" Style="z-index: 2; left: 150px; top: 930px; position: absolute; right: 223px;"
                            Theme="PlasticBlue" Width="200px" Visible="False"
                        ...
                        <asp:Label ID="Label18" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            Font-Size="15px" ForeColor="#3E5395" Style="z-index: 2; left: 400px; top: 930px; position: absolute"
                            Text="Diferença Mes\Dias" Theme="PlasticBlue" Visible="False"></asp:Label>
                        <dx:ASPxTextBox ID="eddiferenca" runat="server" Style="z-index: 2; left: 550px; top: 930px; position: absolute; right: 223px;"
                            Theme="PlasticBlue" Width="200px" Visible="False"
                            AutoPostBack="True" ReadOnly="True">
                        </dx:ASPxTextBox>
                        <asp:Label ID="Label19" runat="server" BackColor="White" Font-Bold="True" Font-Names="Calibri"
                            Font-Size="15px" ForeColor="#3E5395" Style="z-index: 2; left: 9px; top: 960px; position: absolute"
                            Text="Valor Desconto" Theme="PlasticBlue"
                            Visible="False"></asp:Label>
                        <dx:ASPxTextBox ID="edvlr_desconto" runat="server" Style="z-index: 2; left: 150px; top: 960px; position: absolute; right: 223px;"
                            Theme="PlasticBlue" Width="200px" Visible="False"
                        ...
                        <asp:Label ID="Label20" runat="server" BackColor="White" Font-Bold="True" Font-Names="Calibri"
                            Font-Size="15px" ForeColor="#3E5395" Style="z-index: 2; left: 9px; top: 990px; position: absolute"
                            Text="Valor Final Pago" Theme="PlasticBlue"
                            Visible="False"></asp:Label>
                        <dx:ASPxTextBox ID="edvlr_pagofinal" runat="server" Style="z-index: 2; left: 150px; top: 990px; position: absolute; right: 223px;"
                            Theme="PlasticBlue" Width="200px" Visible="False"
                            AutoPostBack="True">
                            <MaskSettings IncludeLiterals="DecimalSymbol" Mask="&lt;0..9999999999999999999g&gt;.&lt;00000000000..99&gt;" />
                        </dx:ASPxTextBox>
                        <asp:Label ID="Label21" runat="server" BackColor="White" Font-Bold="True" Font-Names="Calibri"
                            Font-Size="15px" ForeColor="#3E5395" Style="z-index: 2; left: 9px; top: 1020px; position: absolute"
                        ...
                        <dx:ASPxComboBox ID="cbformapagamento" runat="server" ValueType="System.String" Font-Bold="True"
                            Font-Names="Calibri" Font-Size="15px" ForeColor="#3E5395" Style="z-index: 5; position: absolute; font-size: 10pt; top: 1020px; left: 150px;"
                            Width="380px" Theme="PlasticBlue"
                            Visible="False" AutoPostBack="True">
                        </dx:ASPxComboBox>
                        <asp:Label ID="Label22" runat="server" BackColor="White" Font-Bold="True" Font-Names="Calibri"
                            Font-Size="15px" ForeColor="#3E5395" Style="z-index: 2; left: 9px; top: 1050px; position: absolute"
                        ...
                        <dx:ASPxComboBox ID="cbcontascorrentes" runat="server"
                            ...
                            Font-Names="Calibri" Font-Size="15px" ForeColor="#3E5395" Style="z-index: 5; position: absolute; font-size: 10pt; top: 1050px; left: 150px;"
                            Width="380px" Theme="PlasticBlue"
                            Visible="False" AutoPostBack="True">
                        </dx:ASPxComboBox>
                        ...
                        <dx:ASPxTextBox ID="edfeedback" runat="server" Style="z-index: 2; left: 150px; top: 1080px; position: absolute; right: 223px;"
                            Theme="PlasticBlue" Width="600px" Visible="False"
                            AutoPostBack="True" ReadOnly="True">
                        </dx:ASPxTextBox>
                        <div id="Div2" runat="server" style="border: 1px solid #808080; z-index: 2; position: absolute; top: 720px; left: 550px; height: 50px; width: 250px;">
