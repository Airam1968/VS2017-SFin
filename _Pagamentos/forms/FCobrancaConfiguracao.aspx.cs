...
public partial class FCobrancaConfiguracao : System.Web.UI.Page
{
    DataSet dsbancos;
    ...
    protected void btprocessa_Click(object sender, EventArgs e)
    {
        ...
        {
            //Processa 
            uBanco.AlteraBanco(uBanco.PegaIDCodigo(cbbanco.Value.ToString()),
    ...
    protected void cbbanco_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        //Carregar Dados
        //
        dsbancos = uBanco.PegaDadosBancos(Convert.ToInt16(cbbanco.Value));
