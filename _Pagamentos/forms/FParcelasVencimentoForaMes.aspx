<%@ Page Title="FParcelasVencimentoForaMes" Language="C#" AutoEventWireup="true" CodeFile="FParcelasVencimentoForaMes.aspx.cs"
    Inherits="FParcelasVencimentoForaMes" StylesheetTheme="Principal" %>
...
<head id="Head1" runat="server">
    <title>Gitano - Pagamentos - Vencimento Fora do Mês</title>
...
<body style="height: 1400px">
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="UpdatePanel" runat="server" style="height: 1400px">
            <ContentTemplate>
                <h1>VENCIMENTO FORA DO MÊS- PARCELAS</h1>
                <h2>Vencimento de Parcelas fora do Mês Corrente</h2>
                <div id="DivNova" style="border-style: none">
                    <div style="border: 1px solid #808080; z-index: 1; left: 35px; top: 100px; position: absolute; height: 1200px; width: 832px; text-align: center;">
                        ...
                        <asp:Label ID="Label9" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            ...
                            Text="Nova Data Inicial" Theme="PlasticBlue"
                            Visible="False"></asp:Label>
                        <dx:ASPxDateEdit ID="eddiavencimento" runat="server" BackColor="#E1E6F2" DisplayFormatString="dd/MM/yyyy"
                            EditFormat="Custom" EditFormatString="dd/MM/yyyy" EnableTheming="True" Font-Bold="False"
                                ...
                                <ContentCollection>
                                    <dx:PopupControlContentControl ID="PopupControlContentControl" runat="server">
                                        <div style="vertical-align: middle">
                                            Alteração Data de Vencimento Fora do Mês Corrente.<br />
                                            <br />
                                            A Alteração da data do vencimento fora do mês de vencimento e possivel informando
                                        o período á ser alterado e o nova primeira data, com isso todas as parcelas do período serão
                                        alteradas baseando-se na nova primeira data.<br />
                                            <br />
