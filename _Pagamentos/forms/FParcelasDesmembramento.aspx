<%@ Page Title="FParcelasDesmembramento" Language="C#" AutoEventWireup="true" CodeFile="FParcelasDesmembramento.aspx.cs"
    Inherits="FParcelasDesmembramento" StylesheetTheme="Principal" %>
...
<head id="Head1" runat="server">
    <title>Gitano - Pagamentos - Desmembramento</title>
...
<body style="height: 1400px">
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="UpdatePanel" runat="server" style="height: 1400px">
            <ContentTemplate>
                <h1>DESMEMBRAMENTO - PARCELAS</h1>
                <h2>Desmembramento de Parcelas</h2>
                <div id="DivNova" style="border-style: none">
                    <div style="border: 1px solid #808080; z-index: 1; left: 35px; top: 100px; position: absolute; height: 1200px; width: 832px; text-align: center;">
                        ...
                        <asp:Label ID="Label12" runat="server" BackColor="White" Font-Bold="True" Font-Names="Calibri"
                            ...
                            Text="1o. Valor" Theme="PlasticBlue" Visible="False"></asp:Label>
                        <dx:ASPxTextBox ID="edvlr_parcela1" runat="server" Style="z-index: 2; left: 150px; top: 900px; position: absolute; right: 223px;"
                            Theme="PlasticBlue" Width="200px"
                            Visible="False" AutoPostBack="True">
                            <MaskSettings IncludeLiterals="DecimalSymbol" Mask="&lt;0..9999999999999999999g&gt;.&lt;00000000000..99&gt;" />
                        </dx:ASPxTextBox>
                        <dx:ASPxTextBox ID="edvlr_original1" runat="server" Style="z-index: 2; left: 380px; top: 900px; position: absolute; right: 223px;"
                            Theme="PlasticBlue" Width="200px"
                            Visible="False" AutoPostBack="True" ReadOnly="True">
                            <MaskSettings IncludeLiterals="DecimalSymbol" Mask="&lt;0..9999999999999999999g&gt;.&lt;00000000000..99&gt;" />
                        </dx:ASPxTextBox>
                        <asp:Label ID="Label14" runat="server" BackColor="White" Font-Bold="True" Font-Names="Calibri"
                            ...
                            Text="2o. Valor" Theme="PlasticBlue" Visible="False"></asp:Label>
                        <dx:ASPxTextBox ID="edvlr_parcela2" runat="server" Style="z-index: 2; left: 150px; top: 930px; position: absolute; right: 223px;"
                            Theme="PlasticBlue" Width="200px"
                            Visible="False" AutoPostBack="True">
                            <MaskSettings IncludeLiterals="DecimalSymbol" Mask="&lt;0..9999999999999999999g&gt;.&lt;00000000000..99&gt;" />
                        </dx:ASPxTextBox>
                        <dx:ASPxTextBox ID="edvlr_original2" runat="server" Style="z-index: 2; left: 380px; top: 930px; position: absolute; right: 223px;"
                            Theme="PlasticBlue" Width="200px"
                            Visible="False" AutoPostBack="True" ReadOnly="True">
                            <MaskSettings IncludeLiterals="DecimalSymbol" Mask="&lt;0..9999999999999999999g&gt;.&lt;00000000000..99&gt;" />
                        </dx:ASPxTextBox>
                        ...
                        <dx:ASPxDateEdit ID="eddtvencimento2" runat="server" BackColor="#E1E6F2" DisplayFormatString="dd/MM/yyyy"
                            EditFormat="Custom" EditFormatString="dd/MM/yyyy" EnableTheming="True" Font-Bold="False"
                            Font-Names="Calibri" Font-Size="15px" ForeColor="#3E5395" Height="16px" Style="z-index: 4; position: absolute; margin-right: 5px; left: 150px; top: 960px;"
                            Theme="PlasticBlue"
                            UseMaskBehavior="True" Width="120px" Visible="False" Enabled="False" MinDate="1900-01-01">
                            <CalendarProperties ClearButtonText="Limpar" TodayButtonText="Hoje">
                            </CalendarProperties>
                        ...
                        <dx:ASPxTextBox ID="edfeedback" runat="server" Style="z-index: 2; left: 150px; top: 990px; position: absolute; right: 223px;"
                            Theme="PlasticBlue" Width="600px" Visible="False"
                            AutoPostBack="True" ReadOnly="True">
                        </dx:ASPxTextBox>
                        <div id="Div2" runat="server" style="border: 1px solid #808080; z-index: 2; position: absolute; top: 720px; left: 600px; height: 50px; width: 200px;">
                            ...
                            <dx:ASPxButton ID="btcalcula" runat="server" Height="40px" ImagePosition="Left" OnClick="btcalcula_Click"
                                Width="45px">
                                <Image Height="30px" ToolTip="Calcular Desmembramento" Url="~/images/BotoesTelas/BTNincluirA.bmp"
                                ...
                                <ContentCollection>
                                    <dx:PopupControlContentControl ID="PopupControlContentControl" runat="server">
                                        <div style="vertical-align: middle">
                                            Desmembramento de Parcela.<br />
                                            <br />
                                            O Processo de desmembramento da parcela, envolve dividir a parcela em duas. O processo
                                        pode ser repetido para dividir a parte restante em quantas vezes sejam necessárias.<br />
                                            <br />
