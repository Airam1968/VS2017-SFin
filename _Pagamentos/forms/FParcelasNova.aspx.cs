...
public partial class FParcelasNova : System.Web.UI.Page
{
    DataSet dsparcelas;
    DataSet parcela;
        ...
        if (lOk)
        {
            ...
            if (parte == "0")
            {
                uParcelas.Grava(cbproduto.Value.ToString(),
                                ...
                                edparcela.Text,
                                edparcelatipo.Text,
                                eddtvencimento.Text.Substring(0, 10),
            ...
            if (parte == "0")
            {
                fwObs_Log = "NOVA PARCELA: " + cbproduto.Value.ToString() + "/" + cbgrupo.Value.ToString() + "/" + cbgrupounidades.Value.ToString() + "/" + parte +
                            " PARCELA No./TIPO: " + edparcela.Text + "/" + edparcelatipo.Text;
            }
            else
            {
            ...
            //
            btprocessa.Enabled = false;
            //ScriptManager.RegisterStartupScript(UpdatePanel, GetType(), "msgbox", "alert('Parcela Nova Registrada!');", true);
            ScriptManager.RegisterStartupScript(this.Page, typeof(Page), Guid.NewGuid().ToString(),
            "toastr.success('Parcela Nova Registrada!', 'Atenção!')", true);
        }
