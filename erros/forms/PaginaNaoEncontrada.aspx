<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PaginaNaoEncontrada.aspx.cs" Inherits="PaginaNaoEncontrada"
    StylesheetTheme="Principal" Title="Erro 404 - Página não encontrada" %>
...
<body>
    ...
    <h2 style="font-family: Calibri; text-align: left; margin-top: 0px;">
        Erro 404 - Página não encontrada</h2>
    <div>
