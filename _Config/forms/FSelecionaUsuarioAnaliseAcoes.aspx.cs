...
public partial class FSelecionaUsuarioAnaliseAcoes : System.Web.UI.Page
{
    ...
    protected void btprocessa_Click(object sender, EventArgs e)
    {
        ...
        //
        //
        dslog2 = uLog.LookUpLogAcoes(usuarioselecionado.Trim(),
        ...
        if (tst != String.Empty)
        {
            fwObs_Log = "CONSULTA SEGURANÇA AÇÕES: " + tst + " - Período (" + dtinicio.Text + " até " + dtfim.Text + ")";
        }
        //
        SqlParameter[] param_log = { new SqlParameter("@login"    , (String)Session["CodUsuario"]         ), 
                                     new SqlParameter("@tabela"   , fWtabela                              ),
                                     new SqlParameter("@operacao" , "CONSULTA"                            ),
                                     new SqlParameter("@obs"      , "CONSULTA SEGURANÇA AÇÕES"            ),
    ...
    protected void btimprimir_Click(object sender, EventArgs e)
    {
        ...
        Session.Add("RelatorioTipo", 2);
        //
        //Usando Classe uLog.MakeLog - Gravando Log
        fwObs_Log = "RELATÓRIO SEGURANÇA AÇÕES: Todos";
        if (tst != String.Empty)
        {
        ...
        SqlParameter[] param_log = { new SqlParameter("@login"    , (String)Session["CodUsuario"]         ), 
                                     ...
                                     new SqlParameter("@obs"      , "RELATÓRIO SEGURANÇA AÇÕES"           ),
                                     new SqlParameter("@acao"     , fwObs_Log                             ) };
        uLog.MakeLog(param_log);
