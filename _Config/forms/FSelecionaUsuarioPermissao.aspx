<%@ Page Title="FSelecionaUsuarioPermissao" Language="C#" AutoEventWireup="true"
    CodeFile="FSelecionaUsuarioPermissao.aspx.cs" Inherits="FSelecionaUsuarioPermissao"
...
<head id="Head1" runat="server">
    <title>Gitano - Config - Permissões de Usuário</title>
...
<body style="height: 1200px">
    ...
    <asp:UpdatePanel ID="UpdatePanel" runat="server" style="height: 1200px">
        <ContentTemplate>
            <h1>
                CONFIG - PERMISSÕES DE USUÁRIOS</h1>
            <h2>
                Permissões de Usuários</h2>
            <div id="DivNova" style="border-style: none">
                <div style="border: 1px solid #808080; z-index: 5; left: 45px; top: 65px; position: absolute;
                    height: 100px; width: 350px">
                    <asp:Label ID="Label1" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                        Font-Size="15px" ForeColor="#3E5395" Style="z-index: 5; left: 9px; top: -11px;
                        position: absolute" Text="Usuário"></asp:Label>
                    <dx:ASPxComboBox ID="cbusuario" runat="server" ValueType="System.String" BackColor="#E1E6F2"
                        ...
                        Width="300px" Style="z-index: 4; position: absolute; margin-right: 5px; top: 15px;
                        ...
                        <ContentCollection>
                            <dx:PopupControlContentControl ID="PopupControlContentControl" runat="server">
                                <div style="vertical-align: middle">
                                    ...
                                    <br />
                                    As Permissões de Usuário podem ser atribuidas ou retiradas dos Usuários individualmente ou Todas.<br />
                                    <br />
                                    Alterando um usuário, automaticamente ele recebe ou é retirado o direito da permissão.<br />
                                    <br />
                ...
                <div style="border: 1px solid #808080; z-index: 3; left: 45px; top: 190px; position: absolute;
                    height: 80px; width: 430px">
                    <asp:Label ID="Label4" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                        Font-Size="15px" ForeColor="#3E5395" Style="z-index: 3; left: 9px; top: -11px;
                        position: absolute" Text="Selecionar Módulos"></asp:Label>
                    <dx:ASPxComboBox ID="lookupmodulos" runat="server" ValueType="System.String" BackColor="#E1E6F2"
                        DisplayFormatString="dd/MM/yyyy" EditFormat="Custom" EditFormatString="dd/MM/yyyy"
                        EnableTheming="True" Font-Bold="False" Font-Names="Calibri" Font-Size="15px"
                        ForeColor="#3E5395" Height="16px" Theme="PlasticBlue" UseMaskBehavior="True"
                        Width="380px" Style="z-index: 2; position: absolute; margin-right: 5px; top: 15px;
                        left: 13px;" ToolTip="Filtrar Módulos do Sistema" DropDownRows="15" AutoPostBack="True" OnSelectedIndexChanged="lookupmodulos_SelectedIndexChanged">
                    </dx:ASPxComboBox>                    
                </div>
                <div style="border: 1px solid #808080; z-index: 1; left: 45px; top: 300px; position: absolute;
                ...
                <div style="border: 1px solid #808080; z-index: 1; left: 540px; top: 300px; position: absolute;
                    ...
                    <asp:Label ID="Label2" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                        ...
                        position: absolute" Text="Permissões do Usuário Selecionado (Nenhum)"></asp:Label>
