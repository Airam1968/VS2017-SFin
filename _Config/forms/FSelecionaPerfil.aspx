<%@ Page Title="FSelecionaPerfil" Language="C#" AutoEventWireup="true" CodeFile="FSelecionaPerfil.aspx.cs"
    Inherits="FSelecionaPerfil" StylesheetTheme="Principal" %>
...
<head id="Head1" runat="server">
    <title>Gitano - Config - Seleção de Perfil de Usuários</title>
...
<body style="height: 1200px">
    ...
    <asp:UpdatePanel ID="UpdatePanel" runat="server" style="height: 1200px">
        <ContentTemplate>
            <h1>
                CONFIG - PERFIS DE USUÁRIOS</h1>
            <h2>
                Manutenção de Perfis de Usuários</h2>
                ...
                <div style="border: 1px solid #808080; z-index: 1; left: 35px; top: 100px; position: absolute;
                    ...
                    <dx3:ASPxGridView ID="GridListagem" runat="server" AutoGenerateColumns="False" EnableTheming="True"
                        ...
                        <SettingsText EmptyDataRow="Não há Dados á Exibir" CommandCancel="Cancela" CommandClearFilter="Limpar Filtros"
                            ...
                            CommandUpdate="Altera" ConfirmDelete="Apagar o Registro, Confirma?" PopupEditFormCaption="Manutenção Perfil de Usuários"
                            Title="Verificar" />
                        ...
                        <Columns>
                            ...
                            <dx3:GridViewDataTextColumn FieldName="Login" VisibleIndex="0" Width="80px" Caption="Perfil"
                                Name="Perfil" SortIndex="0" SortOrder="Ascending">
                                <EditFormSettings Caption="Perfil &gt;" ColumnSpan="1" />
                            ...
                            <dx3:GridViewDataTextColumn Caption="Função\Cargo" FieldName="Funcao" Name="Funcao"
                                VisibleIndex="4" Width="150px">
                                <EditFormSettings Caption="Função\Cargo &gt;" CaptionLocation="Near" ColumnSpan="2"
                                    Visible="True" />
                            ...
                            <dx3:GridViewDataTextColumn Caption="Setor\Departamento" FieldName="Setor" Name="Setor"
                                VisibleIndex="3" Width="150px">
                                <PropertiesTextEdit EnableFocusedStyle="False">
                                    <Style HorizontalAlign="Left"></Style>
                                </PropertiesTextEdit>
                                <EditFormSettings Caption="Setor\Departamento &gt;" ColumnSpan="2" Visible="True" />
                                <EditFormCaptionStyle Font-Bold="True" HorizontalAlign="Right">
                                </EditFormCaptionStyle>
                                <HeaderStyle Font-Bold="True" ForeColor="White" />
                            </dx3:GridViewDataTextColumn>
                            <dx3:GridViewDataTextColumn Caption="Senha" FieldName="Senha" Name="Senha" Visible="False"
                                VisibleIndex="1" ReadOnly="True">
                                <EditFormSettings Caption="Senha &gt;" Visible="False" />
                                <EditFormCaptionStyle Font-Bold="True" HorizontalAlign="Right">
                                </EditFormCaptionStyle>
                            </dx3:GridViewDataTextColumn>
                            <dx3:GridViewDataTextColumn Caption="Telefone" FieldName="Fone" Name="Telefone" Visible="False"
                                VisibleIndex="5">
                                <EditFormSettings Caption="Telefone &gt;" Visible="True" />
                                <EditFormCaptionStyle Font-Bold="True" HorizontalAlign="Right">
                                </EditFormCaptionStyle>
                            </dx3:GridViewDataTextColumn>
                            <dx3:GridViewDataTextColumn Caption="EMail" FieldName="email" Name="EMail" Visible="False"
                                VisibleIndex="6">
                                <EditFormSettings Caption="E-Mail &gt;" Visible="True" />
                                <EditFormCaptionStyle Font-Bold="True" HorizontalAlign="Right">
                                </EditFormCaptionStyle>
                            </dx3:GridViewDataTextColumn>
                            <dx3:GridViewDataTextColumn Caption="Alçada" FieldName="alcada" Name="Alçada" Visible="False"
                                VisibleIndex="8">
                                <EditFormSettings Caption="Alçada &gt;" Visible="True" />
                                <EditFormCaptionStyle Font-Bold="True" HorizontalAlign="Right">
                                </EditFormCaptionStyle>
                            </dx3:GridViewDataTextColumn>
                            <dx3:GridViewDataCheckColumn Caption="Ativo" FieldName="ativo" Name="Ativo" VisibleIndex="9"
                                Width="50px">
                            ...
                            <dx3:GridViewDataCheckColumn Caption="Perfil" FieldName="perfil" Name="Perfil" 
                                Visible="False" VisibleIndex="7">
                                <EditFormSettings Caption="Perfil &gt;" Visible="True" />
                                <EditFormCaptionStyle Font-Bold="True" HorizontalAlign="Right">
                                </EditFormCaptionStyle>
                            </dx3:GridViewDataCheckColumn>
                        </Columns>
                        ...
                        <SettingsText EmptyDataRow="Não há Dados á Exibir" CommandCancel="Cancela" CommandClearFilter="Limpar Filtros"
                            CommandDelete="Exclui" CommandEdit="Altera" CommandNew="Insere" CommandSelect="Seleciona"
                            CommandUpdate="Altera" ConfirmDelete="Apagar o Registro, Confirma?" PopupEditFormCaption="Manutenção de Usuários"
                            Title="Verificar" />
                        <SettingsLoadingPanel ImagePosition="Top" Text="Carregando&amp;hellip;" />
                        <SettingsDetail AllowOnlyOneMasterRowExpanded="True" />
                        <SettingsEditing EditFormColumnCount="1" Mode="PopupEditForm" />
