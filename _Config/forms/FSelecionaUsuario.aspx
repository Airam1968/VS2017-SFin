<%@ Page Title="FSelecionaUsuario" Language="C#" AutoEventWireup="true" CodeFile="FSelecionaUsuario.aspx.cs"
    Inherits="FSelecionaUsuario" StylesheetTheme="Principal" %>
...
<head id="Head1" runat="server">
    <title>Gitano - Config - Seleção de Usuários</title>
                ...
                <div style="border: 1px solid #808080; z-index: 1; left: 35px; top: 100px; position: absolute;
                    ...
                    <dx3:ASPxGridView ID="GridListagem" runat="server" AutoGenerateColumns="False" EnableTheming="True"
                        ...
                        <Columns>
                            ...
                            <dx3:GridViewDataTextColumn FieldName="Login" VisibleIndex="0" Width="80px" Caption="Login"
                                Name="Login" SortIndex="0" SortOrder="Ascending">
                                <EditFormSettings Caption="Login &gt;" ColumnSpan="1" />
                                <PropertiesTextEdit>
                                    <ValidationSettings>
