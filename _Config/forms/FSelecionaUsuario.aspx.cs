...
public partial class FSelecionaUsuario : System.Web.UI.Page
{
    DataSet dsusuario;
    ...
    {
        //dsusuario.Clear();
        dsusuario = uUsuario.PegaDadosUsuario("");
    ...
    protected void GridListagem_RowDeleting(object sender, DevExpress.Web.Data.ASPxDataDeletingEventArgs e)
    {
        ...
        uPermissoes.ExcluiPermissoesUsuario(e.Values["Login"].ToString(), "", "");
