<%@ Page Title="FRelProdutoCadastroTotal" Language="C#" AutoEventWireup="true" CodeFile="FRelProdutoCadastroTotal.aspx.cs"
    Inherits="FRelProdutoCadastroTotal" StylesheetTheme="Principal" %>
...
<head id="Head1" runat="server">
    <title>Relatório Produto Cadastro Total</title>
...
<body style="height: 910px">
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="UpdatePanel" runat="server">
            <ContentTemplate>
                <h1>PRODUTO - RELATÓRIOS</h1>
                <h2 >Produto Cadastro Total</h2>
                            ...
                            <ContentCollection>
                                <dx:PopupControlContentControl ID="PopupControlContentControl" runat="server">
                                    <div style="vertical-align: middle">
                                        Relatório Produto Cadastro Total.<br />
                                        <br />
                                        O Relatório em questão apresenta uma visão sobre as informações do Produto.<br />
                                        <br />
