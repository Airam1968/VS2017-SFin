...
public partial class RelProdutoCadastroResumido : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        RepProdutoCadastroResumido report = new RepProdutoCadastroResumido();
        ...
        // RODAPÉ
        report.lcaminho.Text = "Gitano ->SGFin ->Produto ->Relatório Produto Cadastro Resumido";
        ...
        report.lmail.DataBindings.AddRange(new DevExpress.XtraReports.UI.XRBinding[] {
