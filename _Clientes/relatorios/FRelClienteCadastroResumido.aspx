<%@ Page Title="FRelClienteCadastroResumido" Language="C#" AutoEventWireup="true"
    CodeFile="FRelClienteCadastroResumido.aspx.cs" Inherits="FRelClienteCadastroResumido"
...
<head id="Head1" runat="server">
    <title>Relatório Cliente Cadastro Resumido</title>
            ...
            <div id="DivNova" style="border-style: none">
                <div style="border: 1px solid #808080; z-index: 1; left: 35px; top: 100px; position: absolute;
                    ...
                    <dx3:ASPxGridView ID="lookupempresa" ClientInstanceName="lookupempresa" runat="server"
                        ...
                        height: 300px;" Theme="PlasticBlue" Width="390px" EnableRowsCache="False" EnableCallBacks="False">
                        <Columns>
                            ...
                            <dx3:GridViewDataTextColumn Caption="Apelido" FieldName="apelido" 
                                Name="apelido" VisibleIndex="5" Width="80%">
                                <PropertiesTextEdit>
                        ...
                        <asp:Label ID="Label7" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            ...
                            Text="Filtro DDA" Theme="PlasticBlue"></asp:Label>
                        <asp:RadioButtonList ID="rbdda" runat="server" AutoPostBack="True" CellPadding="0"
                            CellSpacing="0" Font-Names="Calibri" Font-Size="12pt" Font-Strikeout="False"
                            ForeColor="#3E5395" Height="12px" Style="z-index: 2; left: 150px; top: 400px; position: absolute; right: 423px;"
                            Width="200px" RepeatDirection="Horizontal">
                            <asp:ListItem Value="0" Selected="True">Todos</asp:ListItem>
                            <asp:ListItem Value="1">DDA</asp:ListItem>
                        </asp:RadioButtonList>
