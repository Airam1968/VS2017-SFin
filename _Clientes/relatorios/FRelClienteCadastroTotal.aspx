<%@ Page Title="FRelClienteCadastroTotal" Language="C#" AutoEventWireup="true" CodeFile="FRelClienteCadastroTotal.aspx.cs"
    Inherits="FRelClienteCadastroTotal" StylesheetTheme="Principal" %>
...
<head id="Head1" runat="server">
    <title>Relatório Cliente Cadastro Total</title>
                            ...
                            <ContentCollection>
                                <dx:PopupControlContentControl ID="PopupControlContentControl" runat="server">
                                    <div style="vertical-align: middle">
                                        Relatório Cadastro de Clientes Total.<br />
                                        <br />
                                        Emissão de Relatório com totas as informações do Cliente.<br />
                                        <br />
                                        <br />
                                    </div>
