<%@ Page Title="FRelClienteCartaPadrao" Language="C#" AutoEventWireup="true" CodeFile="FRelClienteCartaPadrao.aspx.cs"
    Inherits="FRelClienteCartaPadrao" StylesheetTheme="Principal" %>
...
<head id="Head1" runat="server">
    <title>Relatório Cliente Carta Padrão</title>
...
<body style="height: 910px">
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="UpdatePanel" runat="server">
            <ContentTemplate>
                <h1>CLIENTES - RELATÓRIOS</h1>
                <h2>Clientes Mala Direta Carta Padrão</h2>
                <div id="DivNova" style="border-style: none">
                    <div style="border: 1px solid #808080; z-index: 1; left: 35px; top: 100px; position: absolute; height: 1200px; width: 832px; text-align: center;">
                        ...
                        <dx3:ASPxGridView ID="lookupcliente" ClientInstanceName="lookupcliente" runat="server"
                            ...
                            Theme="PlasticBlue" Width="300px" EnableRowsCache="False" EnableCallBacks="False">
                            <Columns>
                            ...
                            <SettingsPager Visible="False" Mode="ShowAllRecords" PageSize="1000000">
                            </SettingsPager>
                        ...
                        <dx3:ASPxGridView ID="lookupcartas" ClientInstanceName="lookupcartas" runat="server"
                            AutoGenerateColumns="False" EnableTheming="True" Font-Bold="False" KeyFieldName="nome"
                            Style="z-index: 1; position: absolute; margin-right: 5px; top: 15px; left: 350px; height: 170px;"
                            Theme="PlasticBlue" Width="300px" EnableRowsCache="False" EnableCallBacks="False">
                            <Columns>
                                <dx3:GridViewCommandColumn ShowInCustomizationForm="True" ShowSelectCheckbox="True"
                                    VisibleIndex="0" Width="20%">
                                    <HeaderTemplate>
                                        <dx:ASPxCheckBox ID="ASPxCheckBox1" runat="server" ToolTip="Marca/Desmarca Todos os itens visíveis"
                                            ClientSideEvents-CheckedChanged="function(s, e) { lookupcartas.SelectAllRowsOnPage(s.GetChecked()); }">
                                        </dx:ASPxCheckBox>
                                    </HeaderTemplate>
                                </dx3:GridViewCommandColumn>
                                <dx3:GridViewDataTextColumn Caption="Carta" FieldName="nome" Name="nome" ShowInCustomizationForm="True"
                        ...
                        <asp:Label ID="Label13" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            ...
                            Text="Filtro Clientes" Theme="PlasticBlue"></asp:Label>
                        <asp:RadioButtonList ID="rbfiltro" runat="server" AutoPostBack="True" CellPadding="0"
                            ...
                            ForeColor="#3E5395" Height="12px" Style="z-index: 2; left: 150px; top: 225px; position: absolute; right: 286px; width: 396px;"
                        ...
                        <asp:Label ID="Label14" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            ...
                            Text="Mês Aniversário" Theme="PlasticBlue"
                        ...
                        <dx:ASPxComboBox ID="cbproduto" runat="server" ValueType="System.String" Font-Bold="True"
                            Font-Names="Calibri" Font-Size="15px" ForeColor="#3E5395" Style="z-index: 5; position: absolute; font-size: 10pt; top: 295px; left: 150px;"
                        ...
                        <dx:ASPxComboBox ID="cbgrupo" runat="server" ValueType="System.String" Font-Bold="True"
                            Font-Names="Calibri" Font-Size="15px" ForeColor="#3E5395" Style="z-index: 5; position: absolute; font-size: 10pt; top: 330px; left: 150px;"
                        ...
                        <asp:Label ID="Label4" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            ...
                            Text="Devedores Até" Theme="PlasticBlue"
                            Visible="False"></asp:Label>
                                ...
                                <ContentCollection>
                                    <dx:PopupControlContentControl ID="PopupControlContentControl" runat="server">
                                        <div style="vertical-align: middle">
                                            Carta Padrão Clientes.<br />
                                            <br />
                                            Emissão de cartas padronizadas.<br />
                                            <br />
                                            Seleção automática do endereço padrão para endereço residencial ou comercial.<br />
                                            <br />
                                            Selecionando os Clientes e a Carta, será emitida uma carta para cada cliente<br />
                                            <br />
                                        </div>
