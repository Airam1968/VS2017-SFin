...
public partial class FRelProcesso : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        RepProcesso report = new RepProcesso();
        ...
        // RODAPÉ
        report.lcaminho.Text = "Gitano ->SGFin ->Vendas ->Relatório Vendas em Processo Judicial";

        DataSet ds;
        try
        {
            ds = uProduto.PegaDadosProdutoUnidades(produto, grupo, "0", "0", "1");
        }
        catch (Exception)
        {
            ds = uProduto.PegaDadosProdutoUnidades("", "", "0", "0", "1");
        }
