<%@ Page Title="FRelVendasHistorico" Language="C#" AutoEventWireup="true"
    CodeFile="FRelVendasHistorico.aspx.cs" Inherits="FRelVendasHistorico"
...
<head id="Head1" runat="server">
    <title>Relatório Vendas Históricos</title>
...
<body style="height: 910px">
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="UpdatePanel" runat="server">
            <ContentTemplate>
                <h1>HISTÓRICOS VENDAS - RELATÓRIOS</h1>
                <h2>Históricos Vendas</h2>
                                ...
                                <ContentCollection>
                                    <dx:PopupControlContentControl ID="PopupControlContentControl" runat="server">
                                        <div style="vertical-align: middle">
                                            Relatório Vendas Histórico.<br />
                                            <br />
                                            O Relatório em questão apresenta uma lista ocorrência de LOG relacionadas ao Financiamento.<br />
                                            <br />
