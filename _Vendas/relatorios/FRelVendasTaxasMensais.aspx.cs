...
public partial class FRelVendasTaxasMensais : System.Web.UI.Page
{
    ...
    protected void Page_Init(object sender, EventArgs e)  // CARGA DOS LOOKUPS TEM QUE SER FEITA NESTE EVENTO  ====================================================================================
    {
        ...
        // CARGA DE UM LOOKUP  ===============================================================================================================================================
        // lookupempresa
        dstaxadiaria = uIndexadores.LookUpIndexadores("M");    // Método que retorna o dataset com os campos pro lookup
