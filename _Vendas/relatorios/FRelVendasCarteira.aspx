<%@ Page Title="FRelVendasCarteira" Language="C#" AutoEventWireup="true"
    CodeFile="FRelVendasCarteira.aspx.cs" Inherits="FRelVendasCarteira"
...
<head id="Head1" runat="server">
    <title>Relatório Vendas Carteira</title>
...
<body style="height: 910px">
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="UpdatePanel" runat="server">
            <ContentTemplate>
                <h1>CARTEIRA - RELATÓRIOS</h1>
                <h2>Posição da Carteira</h2>
                                ...
                                <ContentCollection>
                                    <dx:PopupControlContentControl ID="PopupControlContentControl" runat="server">
                                        <div style="vertical-align: middle">
                                            Relatório Vendas Carteira.<br />
                                            <br />
                                            O Relatório em questão apresenta uma visão resumida dos numeros da carteira de financiamento.<br />
                                            <br />
