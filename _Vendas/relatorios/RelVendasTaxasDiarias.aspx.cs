...
public partial class RelVendasTaxasDiarias : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        RepVendasTaxasDiarias report = new RepVendasTaxasDiarias();
        ...
        // RODAPÉ
        report.lcaminho.Text = "Gitano ->SGFin ->Vendas ->Relatório Taxas Diárias";

        DataSet ds;

        ds = uTaxasDiarias.PegaDadosTaxasDiariasNome(indexador, dtprevisao1, dtprevisao2);
