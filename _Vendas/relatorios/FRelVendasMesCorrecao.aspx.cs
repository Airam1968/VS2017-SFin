...
public partial class FRelVendasMesCorrecao : System.Web.UI.Page
{
    ...
    protected void btImpressao_Click(object sender, EventArgs e)
    {
        ...
        if (lOk)
        {
            ...
            {
                Session.Add("cbmes", cbmes.Value.ToString().Trim());
            }
            else
            {
                Session.Add("cbmes", "");
