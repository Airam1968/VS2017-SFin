<%@ Page Title="FRelVendasComissoes" Language="C#" AutoEventWireup="true"
    CodeFile="FRelVendasComissoes.aspx.cs" Inherits="FRelVendasComissoes"
...
<head id="Head1" runat="server">
    <title>Relatório Vendas - Comissões</title>
                ...
                <div id="DivNova" style="border-style: none">
                    <div style="border: 1px solid #808080; z-index: 1; left: 35px; top: 100px; position: absolute; height: 1200px; width: 832px; text-align: center;">
                        ...
                        <asp:Label ID="Label4" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            ...
                            Text="Período" Theme="PlasticBlue"
                        ...
                        <asp:Label ID="Label14" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            Font-Size="15px" ForeColor="#3E5395" Style="z-index: 2; left: 9px; top: 180px; position: absolute"
                        ...
                        <dx:ASPxComboBox ID="cbcontacorrente" runat="server" ValueType="System.String" Font-Bold="True"
                            Font-Names="Calibri" Font-Size="15px" ForeColor="#3E5395" Style="z-index: 5; position: absolute; font-size: 10pt; top: 180px; left: 150px;"
                            Width="380px"
                        ...
                        <asp:Label ID="Label1" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            Font-Size="15px" ForeColor="#3E5395" Style="z-index: 2; left: 9px; top: 210px; position: absolute"
                            Text="Origem Pagamento" Theme="PlasticBlue"
                            Visible="False"></asp:Label>
                        <asp:RadioButtonList ID="rborigempagamento" runat="server" AutoPostBack="True" CellPadding="0"
                            CellSpacing="0" Font-Names="Calibri" Font-Size="12pt" Font-Strikeout="False"
                            ForeColor="#3E5395" Style="z-index: 2; left: 150px; top: 210px; position: absolute; right: 376px; height: 20px; width: 306px;"
                            RepeatDirection="Horizontal" Visible="False">
                            <asp:ListItem Value="0" Selected="True">Todos</asp:ListItem>
                            <asp:ListItem Value="1">Carteira</asp:ListItem>
                            <asp:ListItem Value="2">Bancária</asp:ListItem>
                        </asp:RadioButtonList>
                        <asp:Label ID="Label3" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            Font-Size="15px" ForeColor="#3E5395" Style="z-index: 2; left: 9px; top: 240px; position: absolute"
                            Text="Tipo Parcela" Theme="PlasticBlue"
                            Visible="False"></asp:Label>
                        <asp:RadioButtonList ID="rbtipoparcela" runat="server" AutoPostBack="True" CellPadding="0"
                            CellSpacing="0" Font-Names="Calibri" Font-Size="12pt" Font-Strikeout="False"
                            ForeColor="#3E5395" Style="z-index: 2; left: 150px; top: 240px; position: absolute; right: 118px; width: 564px; height: 16px;"
                            RepeatDirection="Horizontal" Visible="False">
                        ...
                        <asp:Label ID="Label6" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            Font-Size="15px" ForeColor="#3E5395" Style="z-index: 2; left: 9px; top: 270px; position: absolute"
                            Text="Pagamentos" Theme="PlasticBlue" Visible="False"></asp:Label>
                        <asp:RadioButtonList ID="rbpagamentos" runat="server" AutoPostBack="True" CellPadding="0"
                            CellSpacing="0" Font-Names="Calibri" Font-Size="12pt" Font-Strikeout="False"
                            ForeColor="#3E5395" Height="12px" Style="z-index: 2; left: 150px; top: 270px; position: absolute; right: 214px; width: 468px;"
                            RepeatDirection="Horizontal" Visible="False">
                            <asp:ListItem Value="0" Selected="True">Todos</asp:ListItem>
                            <asp:ListItem Value="1">Atrasados</asp:ListItem>
                            <asp:ListItem Value="2">Antecipado</asp:ListItem>
                            <asp:ListItem Value="3">No Mês</asp:ListItem>
                        </asp:RadioButtonList>
                        <asp:Label ID="Label9" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            Font-Size="15px" ForeColor="#3E5395" Style="z-index: 2; left: 9px; top: 300px; position: absolute"
                            Text="Ordenação" Theme="PlasticBlue" Visible="False"></asp:Label>
                        <asp:RadioButtonList ID="rbordem" runat="server" AutoPostBack="True" CellPadding="0"
                            CellSpacing="0" Font-Names="Calibri" Font-Size="12pt" Font-Strikeout="False"
                            ForeColor="#3E5395" Style="z-index: 2; left: 150px; top: 300px; position: absolute; right: 416px; width: 266px; height: 19px;"
                            RepeatDirection="Horizontal" Visible="False" Enabled="False">
                            <asp:ListItem Value="0" Selected="True">Data de Pagamento</asp:ListItem>
                        ...
                        <asp:Label ID="Label10" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            Font-Size="15px" ForeColor="#3E5395" Style="z-index: 2; left: 9px; top: 330px; position: absolute; right: 713px;"
                            Text="Inclui Desistêntes"
                        ...
                        <asp:CheckBox ID="ckdesistentes" runat="server" AutoPostBack="True"
                            ...
                            Font-Size="15px" ForeColor="#3E5395" Style="z-index: 5; position: absolute; font-size: 15px; top: 330px; left: 150px; width: 50px;"
                            Text=" "
                            Visible="False" />
                        ...
                        <dx:ASPxComboBox ID="cbcorretor" runat="server" ValueType="System.String" Font-Bold="True"
                            Font-Names="Calibri" Font-Size="15px" ForeColor="#3E5395" Style="z-index: 5; position: absolute; font-size: 10pt; top: 365px; left: 150px;"
                            Width="380px"
                            Theme="PlasticBlue" AutoPostBack="True" Visible="False">
                        </dx:ASPxComboBox>
                                ...
                                <ContentCollection>
                                    <dx:PopupControlContentControl ID="PopupControlContentControl" runat="server">
                                        <div style="vertical-align: middle">
                                            Relatório Pagamentos.<br />
                                            <br />
                                            O Relatório em questão apresenta as de parcela paga de um período.<br />
                                            <br />
