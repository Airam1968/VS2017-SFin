<%@ Page Title="RELATÓRIO NOTAS FISCAIS" Language="C#" AutoEventWireup="true"
    CodeFile="RelNotaFiscalGitano.aspx.cs" Inherits="RelNotaFiscalGitano" StylesheetTheme="Principal" %>
...
<body>
    ...
    <div id="Relatorio">
        ...
        <dx:ReportToolbar ID="ReportToolbar1" runat="server" ReportViewerID="ReportViewer1"
            ShowDefaultButtons="False" Width="1200px" Theme="PlasticBlue" Height="35px">
            <Items>
    ...
    <dx:ReportViewer ID="ReportViewer1" runat="server" Width="1200px" AutoSize="False"
