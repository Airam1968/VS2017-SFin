<%@ Page Title="FRelProprietario" Language="C#" AutoEventWireup="true"
    CodeFile="FRelProprietario.aspx.cs" Inherits="FRelProprietario"
...
<head id="Head1" runat="server">
    <title>Relatório Vendas Proprietários</title>
                            ...
                            <ContentCollection>
                                <dx:PopupControlContentControl ID="PopupControlContentControl" runat="server">
                                    <div style="vertical-align: middle">
                                        Relatório Vendas Proprietário.<br />
                                        <br />
                                        O Relatório em questão apresenta uma lista de proprietários e imóveis a eles relacionados.<br />
                                        <br />
