...
public partial class RelVendasComissoes : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        RepVendasComissoes report = new RepVendasComissoes();
        ...
        //
        // CORRETOR
        string cbcorretor = Convert.ToString(Session["cbcorretor"]);
        if (cbcorretor == "")
        {
        ...
        {
            if (cbcorretor.Substring(0, 1) == "'")
            {
                report.lfcorretor.Text = "Alguns";
            }
            else
            {
                report.lfcorretor.Text = cbcorretor + " - " + uCorretor.PegaNomeIDCorretor(cbcorretor);
            }
        }
        // USUÁRIO
        ...
        // RODAPÉ
        report.lcaminho.Text = "Gitano ->SGFin ->Empresa ->Relatório Comissões";
        // LEGENDA
        ...
        //report.ltaxacomissao.DataBindings.AddRange(new DevExpress.XtraReports.UI.XRBinding[] {
        //    new DevExpress.XtraReports.UI.XRBinding("Text", null, "vlr_multa", "{0:N}")});
        //report.lvlrcomissao.DataBindings.AddRange(new DevExpress.XtraReports.UI.XRBinding[] {
        ...
        //report.lcorretor.DataBindings.AddRange(new DevExpress.XtraReports.UI.XRBinding[] {
