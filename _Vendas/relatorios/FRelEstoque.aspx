<%@ Page Title="FRelEstoque" Language="C#" AutoEventWireup="true"
    CodeFile="FRelEstoque.aspx.cs" Inherits="FRelEstoque"
...
<head id="Head1" runat="server">
    <title>Relatório Vendas Estoque</title>
            ...
            <div id="DivNova" style="border-style: none">
                <div style="border: 1px solid #808080; z-index: 1; left: 35px; top: 100px; position: absolute;
                    ...
                    <asp:Label ID="Label7" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                        ...
                        position: absolute" Text="Tipo da Unidade" Theme="PlasticBlue" 
                        Visible="False"></asp:Label>
                    <asp:RadioButtonList ID="rbunidadessituacao" runat="server" AutoPostBack="True" CellPadding="0"
                        ...
                        position: absolute; right: 423px;" Width="300px" RepeatDirection="Horizontal"
                        Visible="False" 
                        onselectedindexchanged="rbunidadessituacao_SelectedIndexChanged">
                        <asp:ListItem Value="0" Selected="True">Todas</asp:ListItem>
                        <asp:ListItem Value="1">Vendidas</asp:ListItem>
                        <asp:ListItem Value="2">Disponíveis</asp:ListItem>
                    </asp:RadioButtonList>
                            ...
                            <ContentCollection>
                                <dx:PopupControlContentControl ID="PopupControlContentControl" runat="server">
                                    <div style="vertical-align: middle">
                                        Relatório Vendas Estoque.<br />
                                        <br />
                                        O Relatório em questão apresenta uma visão sobre o estoque de unidades de um produto.<br />
                                        <br />
