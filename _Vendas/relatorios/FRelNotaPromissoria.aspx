<%@ Page Title="FRelNotaPromissoria" Language="C#" AutoEventWireup="true"
    CodeFile="FRelNotaPromissoria.aspx.cs" Inherits="FRelNotaPromissoria"
...
<head id="Head1" runat="server">
    <title>Relatório Vendas - Notas Promissórias</title>
                ...
                <div id="DivNova" style="border-style: none">
                    <div style="border: 1px solid #808080; z-index: 1; left: 35px; top: 100px; position: absolute; height: 1200px; width: 832px; text-align: center;">
                        ...
                        <asp:Label ID="Label1" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            Font-Size="15px" ForeColor="#3E5395" Style="z-index: 2; left: 9px; top: 215px; position: absolute"
                        ...
                        <asp:RadioButtonList ID="rbparcelasituacao" runat="server" AutoPostBack="True" CellPadding="0"
                            ...
                            ForeColor="#3E5395" Height="12px" Style="z-index: 2; left: 150px; top: 215px; position: absolute; right: 382px;"
                            Width="300px"
                        ...
                        <asp:Label ID="Label3" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            Font-Size="15px" ForeColor="#3E5395" Style="z-index: 2; left: 9px; top: 245px; position: absolute"
                            Text="Data Base" Theme="PlasticBlue" Visible="False"></asp:Label>
                        <asp:RadioButtonList ID="rbdatabase" runat="server" AutoPostBack="True" CellPadding="0"
                            CellSpacing="0" Font-Names="Calibri" Font-Size="12pt" Font-Strikeout="False"
                            ForeColor="#3E5395" Height="12px" Style="z-index: 2; left: 150px; top: 245px; position: absolute; right: 382px;"
                            Width="250px"
                            RepeatDirection="Horizontal" Visible="False">
                            <asp:ListItem Value="0" Selected="True">Venda</asp:ListItem>
                        ...
                        <asp:Label ID="Label10" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            Font-Size="15px" ForeColor="#3E5395" Style="z-index: 2; left: 9px; top: 280px; position: absolute;"
                            Text="Dados Conjuge"
                            Theme="PlasticBlue" Visible="False"></asp:Label>
                        <asp:CheckBox ID="ckconjuge" runat="server" AutoPostBack="True"
                            Font-Bold="True" Font-Names="Calibri"
                            Font-Size="15px" ForeColor="#3E5395" Style="z-index: 5; position: absolute; font-size: 15px; top: 280px; left: 150px; width: 50px;"
                            Text=" "
                            Visible="False" />
