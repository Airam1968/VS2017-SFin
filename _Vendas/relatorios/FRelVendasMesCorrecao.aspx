<%@ Page Title="FRelVendasMesCorrecao" Language="C#" AutoEventWireup="true"
    CodeFile="FRelVendasMesCorrecao.aspx.cs" Inherits="FRelVendasMesCorrecao"
...
<head id="Head1" runat="server">
    <title>Relatório Vendas - Mês Correção</title>
                ...
                <div id="DivNova" style="border-style: none">
                    <div style="border: 1px solid #808080; z-index: 1; left: 35px; top: 100px; position: absolute; height: 1200px; width: 832px; text-align: center;">
                        ...
                        <asp:Label ID="Label14" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            ...
                            Text="Mês" Theme="PlasticBlue" Visible="False"></asp:Label>
                        <dx:ASPxComboBox ID="cbmes" runat="server" ValueType="System.String" Font-Bold="True"
                            ...
                            OnSelectedIndexChanged="cbmes_SelectedIndexChanged">
                        </dx:ASPxComboBox>
                                ...
                                <ContentCollection>
                                    <dx:PopupControlContentControl ID="PopupControlContentControl" runat="server">
                                        <div style="vertical-align: middle">
                                            Relatório Vendas Mês de Correção.<br />
                                            <br />
                                            O Relatório em questão apresenta uma lista de Financiamentos por Mês de aniversário de correção Anual.<br />
                                            <br />
