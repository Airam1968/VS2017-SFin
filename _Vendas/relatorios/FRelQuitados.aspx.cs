...
public partial class FRelQuitados : System.Web.UI.Page
{
    ...
    protected void btImpressao_Click(object sender, EventArgs e)
    {
        ...
        if (lOk)
        {
            ...
            //
            //rbquitados
            Session.Remove("rbquitados");
            Session.Add("rbquitados", rbquitados.SelectedIndex.ToString());
            //
            //rbvendidos
            Session.Remove("rbvendidos");
            Session.Add("rbvendidos", rbvendidos.SelectedIndex.ToString());
            //
            //FIM CRIAÇÃO DA VARIÁVEL DE SESSÃO COM OS ELEMENTOS SELECIONADOS NO LOOKUP  ===============================================================================================================================================
            //
            //Usando Classe uLog.MakeLog - Gravando Log
            fwObs_Log = "RELATÓRIO VENDAS QUITADOS-NÃO QUITADOS: " + tst;
            SqlParameter[] param_log = { new SqlParameter("@login"    , (String)Session["CodUsuario"]            ), 
                                         new SqlParameter("@tabela"   , fWtabela                                 ),
                                         new SqlParameter("@operacao" , "RELATÓRIO"                              ),
                                         new SqlParameter("@obs"      , "RELATÓRIO VENDAS QUITADOS-NÃO QUITADOS" ),
                                         new SqlParameter("@acao"     , fwObs_Log                                ) };
            uLog.MakeLog(param_log);

            // FIM CRIA LOG RELATÓRIO  ===============================================================================================================================================

            ScriptManager.RegisterStartupScript(this, typeof(string), "OPEN_WINDOW", "window.open( '" + HttpContext.Current.Request.Url.GetLeftPart(UriPartial.Authority) + HttpRuntime.AppDomainAppVirtualPath + "/_Vendas/relatorios/RelQuitados.aspx', null, 'height=755,width=900,status=yes,resizable=yes,menubar=yes,location=yes' );", true);
    ...
    protected void cbproduto_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        if (cbproduto.Text != string.Empty)
        {
            ...
            Label1.Visible = true;
            rbquitados.Visible = true;
            Label3.Visible = true;
            rbvendidos.Visible = true;
        }
        else
        {
