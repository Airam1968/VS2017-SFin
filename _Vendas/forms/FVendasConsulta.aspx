<%@ Page Title="FVendasConsulta" Language="C#" AutoEventWireup="true" CodeFile="FVendasConsulta.aspx.cs"
    Inherits="FVendasConsulta" StylesheetTheme="Principal" %>
...
<head id="Head1" runat="server">
    <title>Gitano - Vendas - Consulta</title>
...
<body style="height: 1400px">
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="UpdatePanel" runat="server" style="height: 1400px">
            <ContentTemplate>
                <h1>VENDAS - CONSULTA</h1>
                <h2>Consulta da Venda de Unidade</h2>
                <div id="DivNova" style="border-style: none">
                    <div style="border: 1px solid #808080; z-index: 1; left: 35px; top: 100px; position: absolute; height: 1200px; width: 832px; text-align: center;">
                        ...
                        <asp:Label ID="Label42" runat="server" BackColor="White" Font-Bold="True" Font-Names="Calibri"
                            Font-Size="15px" ForeColor="#669900" Style="z-index: 2; left: 9px; top: 155px; position: absolute; width: 520px;"
                            Text="Financiamento Quitado!" Theme="PlasticBlue" Visible="False"></asp:Label>
                        ...
                        <dx:ASPxTextBox ID="edcorrecao" runat="server" Style="z-index: 2; left: 280px; top: 185px; position: absolute; right: 223px;"
                            Theme="PlasticBlue" Width="250px" Visible="False"
                            AutoPostBack="True" ReadOnly="True">
                        </dx:ASPxTextBox>
                        ...
                        <div id="Divsinalparcelado" runat="server" style="border: 1px solid #808080; z-index: 2; position: absolute; top: 90px; left: 540px; height: 160px; width: 280px;">
                            ...
                            <dx:ASPxButton ID="btgravasinal" runat="server" Style="z-index: 2; left: 230px; top: 15px; position: absolute; width: 14px; height: 20px"
                        ...
                        <asp:Label ID="Label19" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            ...
                            Text="Parcelas" Theme="PlasticBlue" Visible="False"></asp:Label>
                        <dx:ASPxTextBox ID="edqtdintermediarias" runat="server" Style="z-index: 2; left: 430px; top: 325px; position: absolute; right: 223px;"
                            Theme="PlasticBlue" Width="100px"
                            Visible="False" AutoPostBack="True" OnTextChanged="edqtdintermediarias_TextChanged">
                            <MaskSettings IncludeLiterals="None" Mask="&lt;0..9999999g&gt;" AllowMouseWheel="False" />
                        </dx:ASPxTextBox>
                        <div id="Divintermediaria" runat="server" style="border: 1px solid #808080; z-index: 2; position: absolute; top: 280px; left: 540px; height: 190px; width: 280px;">
                            ...
                            <asp:Label ID="Label28" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                                Font-Size="15px" ForeColor="#3E5395" Style="z-index: 2; left: 100px; top: 20px; position: absolute"
                                Text="9999/9999" Theme="PlasticBlue" Visible="False"></asp:Label>
                            <dx:ASPxButton ID="btgravaintermediaria" runat="server" Style="z-index: 2; left: 230px; top: 15px; position: absolute; width: 14px; height: 20px"
                                RightToLeft="True"
                        ...
                        <div id="Divfluxos" runat="server" style="border: 1px solid #808080; z-index: 2; position: absolute; top: 500px; left: 540px; height: 190px; width: 280px;">
                            ...
                            <asp:Label ID="Label35" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                                Font-Size="15px" ForeColor="#3E5395" Style="z-index: 2; left: 100px; top: 20px; position: absolute"
                                Text="9999/9999" Theme="PlasticBlue" Visible="False"></asp:Label>
                            <dx:ASPxButton ID="btgravafluxo" runat="server" Style="z-index: 2; left: 230px; top: 15px; position: absolute; width: 14px; height: 20px"
                                RightToLeft="True" HorizontalAlign="Left"
                                position="absolute" VerticalAlign="Top" Visible="False" ImageSpacing="0px">
                        ...
                        <asp:Label ID="Label41" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            ...
                            Text="Data Base" Theme="PlasticBlue" Visible="False"></asp:Label>
                        <dx:ASPxDateEdit ID="dtbase" runat="server" BackColor="#E1E6F2" DisplayFormatString="dd/MM/yyyy"
                            EditFormat="Custom" EditFormatString="dd/MM/yyyy" EnableTheming="True" Font-Bold="False"
                            Font-Names="Calibri" Font-Size="15px" ForeColor="#3E5395" Height="16px" Style="z-index: 4; position: absolute; margin-right: 5px; left: 150px; top: 565px;"
                            Theme="PlasticBlue"
                            UseMaskBehavior="True" Width="120px" Visible="False" MinDate="1900-01-01">
                            <CalendarProperties ClearButtonText="Limpar" TodayButtonText="Hoje">
                            </CalendarProperties>
                        ...
                        <asp:Label ID="Label6" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            Font-Size="15px" ForeColor="#3E5395" Style="z-index: 2; left: 9px; top: 600px; position: absolute"
                            Text="Observações" Theme="PlasticBlue" Visible="False"></asp:Label>
                        <dx:ASPxTextBox ID="edobservacao" runat="server" Style="z-index: 2; left: 150px; top: 600px; position: absolute; right: 223px;"
                        ...
                        <dx3:ASPxGridView ID="GridListagem" runat="server" AutoGenerateColumns="False" EnableTheming="True"
                            ...
                            <Columns>
                                ...
                                <dx3:GridViewDataTextColumn FieldName="produto" VisibleIndex="1" Width="60px" Caption="Produto"
                                    ...
                                    Visible="False">
                                    <EditFormSettings Caption="Produto &gt;" ColumnSpan="1" Visible="True" />
                                ...
                                <dx3:GridViewDataTextColumn Caption="Vlr Pgto" FieldName="vlr_pagamento"
                                    Name="vlr_pagamento" VisibleIndex="10" ReadOnly="True">
                                ...
                                <dx3:GridViewDataTextColumn VisibleIndex="3" Caption="Unidade" FieldName="unidade"
                                    ...
                                    <EditFormSettings Caption="Unidade &gt;" Visible="True" />
                                    <EditFormCaptionStyle Font-Bold="True" HorizontalAlign="Right">
                                    </EditFormCaptionStyle>
                                    <CellStyle HorizontalAlign="Right">
                                    </CellStyle>
                                ...
                                <dx3:GridViewDataTextColumn VisibleIndex="4" Caption="Parte" FieldName="parte" Name="parte"
                                    ...
                                    <EditFormSettings Caption="Parte &gt;" Visible="True" />
                                    <EditFormCaptionStyle Font-Bold="True" HorizontalAlign="Right">
                                    </EditFormCaptionStyle>
                                </dx3:GridViewDataTextColumn>
                                ...
                                <dx3:GridViewDataTextColumn Caption="Valor Base" FieldName="vlr_base" Name="vlr_base"
                                    Visible="False" VisibleIndex="14" ReadOnly="True">
                                ...
                                <dx3:GridViewDataTextColumn Caption="Origem Pagamento"
                                    ...
                                    Visible="False" VisibleIndex="16" ReadOnly="True">
                                ...
                                <dx3:GridViewDataCheckColumn Caption="Protesto" FieldName="protesto" Name="protesto"
                                    Visible="False" VisibleIndex="22" ReadOnly="True">
                                    <PropertiesCheckEdit>
                                ...
                                <dx3:GridViewDataTextColumn Caption="% Correção"
                                    ...
                                    Visible="False" VisibleIndex="20" ReadOnly="True">
                                ...
                                <dx3:GridViewDataTextColumn Caption="% Multa" FieldName="tx_multa" Name="tx_multa"
                                    Visible="False" VisibleIndex="24" ReadOnly="True">
                                    <PropertiesTextEdit Width="100px">
                                    </PropertiesTextEdit>
                                ...
                                <dx3:GridViewDataTextColumn Caption="% Comissão" FieldName="tx_comissao"
                                    Name="tx_comissao" Visible="False" VisibleIndex="25" ReadOnly="True">
                                ...
                                <dx3:GridViewDataTextColumn Caption="Valor Multa" FieldName="vlr_multa" Name="vlr_multa"
                                    VisibleIndex="28" Width="100px" Visible="False" ReadOnly="True">
                                    <PropertiesTextEdit Width="100px">
                                    </PropertiesTextEdit>
                                ...
                                <dx3:GridViewDataTextColumn Caption="Valor Comissão" FieldName="vlr_comissao" Name="vlr_comissao"
                                    Visible="False" VisibleIndex="29" ReadOnly="True">
                                ...
                                <dx3:GridViewDataTextColumn Caption="Valor Desconto" FieldName="vlr_desconto" Name="vlr_desconto"
                                    Visible="False" VisibleIndex="30" ReadOnly="True">
                                ...
                                <dx3:GridViewDataTextColumn Caption="Comissão"
                                    ...
                                    Visible="False" VisibleIndex="26" ReadOnly="True">
                                    <EditFormSettings Caption="Comissão &gt;" ColumnSpan="2" Visible="True" />
                                    <EditFormCaptionStyle Font-Bold="True" HorizontalAlign="Right">
                                    </EditFormCaptionStyle>
                                </dx3:GridViewDataTextColumn>
                                ...
                                <dx3:GridViewDataCheckColumn Caption="Contabil" FieldName="contabil" Name="contabil"
                                    Visible="False" VisibleIndex="23" ReadOnly="True">
                                    <PropertiesCheckEdit>
                                        <Style HorizontalAlign="Left">
                                ...
                                <dx3:GridViewDataDateColumn Caption="Pagamento" FieldName="data_pagamento"
                                    Name="data_pagamento" VisibleIndex="9" ReadOnly="True">
                                    <PropertiesDateEdit DisplayFormatString="dd/MM/yyyy" Width="100px">
                                    </PropertiesDateEdit>
                                ...
                                <dx3:GridViewDataTextColumn Caption="Conta" FieldName="conta" Name="conta"
                                    Visible="False" VisibleIndex="18" Width="50px" ReadOnly="True">
                                ...
                                <dx3:GridViewDataCheckColumn Caption="Carteira" FieldName="carteira" Name="carteira"
                                    Visible="False" VisibleIndex="21" ReadOnly="True">
                                    <PropertiesCheckEdit>
                                        <Style HorizontalAlign="Left">
                                ...
                                <dx3:GridViewDataDateColumn Caption="Data Original" FieldName="data_original"
                                    Name="data_original" Visible="False" VisibleIndex="11" ReadOnly="True">
                                    <PropertiesDateEdit DisplayFormatString="dd/MM/yyyy" Width="100px">
                                    </PropertiesDateEdit>
                                ...
                                <dx3:GridViewDataTextColumn Caption="Indexador" FieldName="indexador" Name="indexador"
                                    Visible="False" VisibleIndex="32" ReadOnly="True">
                                    <PropertiesTextEdit Width="60px">
                                        <Style Font-Bold="True">
                                    </Style>
                                    </PropertiesTextEdit>
                                ...
                                <dx3:GridViewDataTextColumn Caption="Indexador Mês" FieldName="indexador_mes" Name="indexador_mes"
                                    VisibleIndex="33" Visible="False" ReadOnly="True">
                                ...
                                <dx3:GridViewDataTextColumn Caption="Resíduo Mês" FieldName="residuo_mes"
                                    Name="residuo_mes" Visible="False" VisibleIndex="35" ReadOnly="True">
                                ...
                                <dx3:GridViewDataTextColumn Caption="Valor Correção" FieldName="vlr_correcao"
                                    Name="vlr_correcao" Visible="False" VisibleIndex="27" ReadOnly="True">
                                ...
                                <dx3:GridViewDataTextColumn Caption="Juros T.Price" FieldName="juros_price"
                                    Name="juros_price" VisibleIndex="38">
                                    <EditFormSettings Caption="Juros T.Price &gt;" ColumnSpan="2" Visible="True" />
                                    <HeaderStyle Font-Bold="True" ForeColor="White" />
                                    <CellStyle HorizontalAlign="Right">
                                    </CellStyle>
                                </dx3:GridViewDataTextColumn>
                                <dx3:GridViewDataTextColumn Caption="Vlr Parcela T.Price"
                                    FieldName="vlr_parcelas_jurosprice" Name="vlr_parcelas_jurosprice"
                                    VisibleIndex="39">
                                    <PropertiesTextEdit DisplayFormatInEditMode="true" DisplayFormatString="N"></PropertiesTextEdit>
                                    <EditFormSettings Caption="Vlr Parcela T.Price &gt;" ColumnSpan="2"
                                        Visible="True" />
                                    <HeaderStyle Font-Bold="True" ForeColor="White" />
                                    <CellStyle HorizontalAlign="Right">
                                    </CellStyle>
                                </dx3:GridViewDataTextColumn>
                                <dx3:GridViewDataTextColumn Caption="Amortização" FieldName="amortizacao"
                                    VisibleIndex="40">
                                    <EditFormSettings Caption="Amortização &gt;" ColumnSpan="2" Visible="True" />
                                    <HeaderStyle Font-Bold="True" ForeColor="White" />
                                    <CellStyle HorizontalAlign="Right">
                                    </CellStyle>
                                </dx3:GridViewDataTextColumn>
                                <dx3:GridViewDataTextColumn Caption="Vlr Parcela Descap."
                                    FieldName="vlr_parcelas_descapitalizada" Name="vlr_parcelas_descapitalizada"
                                    VisibleIndex="41">
                                    <PropertiesTextEdit DisplayFormatInEditMode="true" DisplayFormatString="N"></PropertiesTextEdit>
                                    <EditFormSettings Caption="Vlr Parcela Descap. &gt;" ColumnSpan="2"
                                        Visible="True" />
                                    <HeaderStyle Font-Bold="True" ForeColor="White" />
                                    <CellStyle HorizontalAlign="Right">
                                    </CellStyle>
                                </dx3:GridViewDataTextColumn>
                                <dx3:GridViewDataTextColumn Caption="Taxa Anual" FieldName="taxa_anual_price"
                                    Name="taxa_anual_price" VisibleIndex="42">
                                    <EditFormSettings Caption="Taxa Anual &gt;" ColumnSpan="2" Visible="True" />
                                    <HeaderStyle Font-Bold="True" ForeColor="White" />
                                    <CellStyle HorizontalAlign="Right">
                                    </CellStyle>
                                </dx3:GridViewDataTextColumn>
                                ...
                                <ContentCollection>
                                    <dx:PopupControlContentControl ID="PopupControlContentControl" runat="server">
                                        <div style="vertical-align: middle">
                                            <br />
                                            Consulta da Venda.<br />
                                            <br />
                                            Consulta dos dados registrados da Venda da Unidade.<br />
                                            <br />
                                            <br />
                                        </div>
