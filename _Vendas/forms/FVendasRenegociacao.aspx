<%@ Page Title="FVendasRenegociacao" Language="C#" AutoEventWireup="true" CodeFile="FVendasRenegociacao.aspx.cs"
    Inherits="FVendasRenegociacao" StylesheetTheme="Principal" %>
...
<head id="Head1" runat="server">
    <title>Gitano - Vendas - Renegociação</title>
...
<body style="height: 1400px">
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="UpdatePanel" runat="server" style="height: 1400px">
            <ContentTemplate>
                <h1>VENDAS - RENEGOCIAÇÃO</h1>
                <h2>Renegociação da Venda de Unidade</h2>
                <div id="DivNova" style="border-style: none">
                    <div style="border: 1px solid #808080; z-index: 1; left: 35px; top: 100px; position: absolute; height: 1200px; width: 832px; text-align: center;">
                        ...
                        <dx:ASPxTextBox ID="edcliente" runat="server" AutoPostBack="True"
                            ReadOnly="True" Style="z-index: 2; left: 150px; top: 120px; position: absolute; right: 223px;"
                        ...
                        <asp:Label ID="Label4" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            ...
                            Text="Data da Renegociação" Theme="PlasticBlue"
                        ...
                        <dx:ASPxDateEdit ID="dtvenda" runat="server" BackColor="#E1E6F2" DisplayFormatString="dd/MM/yyyy"
                            ...
                            Theme="PlasticBlue"
                            UseMaskBehavior="True" Width="120px" Visible="False" AutoPostBack="True" OnDateChanged="dtvenda_DateChanged"
                            MinDate="1900-01-01">
                        ...
                        <asp:Label ID="Label5" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            ...
                            Text="Valor Renegociação" Theme="PlasticBlue"
                            Visible="False"></asp:Label>
                        ...
                        <dx:ASPxTextBox ID="edindexador" runat="server" AutoPostBack="True"
                            ReadOnly="True" Style="z-index: 2; left: 150px; top: 395px; position: absolute; right: 223px;"
                            Theme="PlasticBlue" Visible="False"
                            Width="380px">
                        </dx:ASPxTextBox>
                        ...
                        <dx:ASPxTextBox ID="edcorretor" runat="server" AutoPostBack="True"
                            ReadOnly="True" Style="z-index: 2; left: 150px; top: 460px; position: absolute; right: 223px;"
                            Theme="PlasticBlue" Visible="False"
                            Width="380px">
                        </dx:ASPxTextBox>
                        ...
                        <asp:Label ID="Label41" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            ...
                            Text="Data Base" Theme="PlasticBlue"
                            Visible="False"></asp:Label>
                        <dx:ASPxDateEdit ID="dtbase" runat="server" BackColor="#E1E6F2" DisplayFormatString="dd/MM/yyyy"
                            EditFormat="Custom" EditFormatString="dd/MM/yyyy" EnableTheming="True" Font-Bold="False"
                            Font-Names="Calibri" Font-Size="15px" ForeColor="#3E5395" Height="16px" Style="z-index: 4; position: absolute; margin-right: 5px; left: 150px; top: 600px;"
                            Theme="PlasticBlue"
