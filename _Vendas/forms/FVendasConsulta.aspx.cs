...
public partial class FVendasConsulta : System.Web.UI.Page
{
    DataSet dsparcelas;
    DataSet dsvenda;
        ...
        if (cbproduto.Text != string.Empty)
        {
            if (cbgrupo.Text != string.Empty)
            {
                if (cbgrupounidades.Text != string.Empty)
                {
                    ...
                    //
                    dsvenda = uVendas.PegaDadosVenda(cbproduto.Value.ToString(),
                                                     cbgrupo.Value.ToString(),
                                                     cbgrupounidades.Value.ToString(),
                                                     parte,
                                                     "01/01/1900",
                    ...
                    dtbase.Value = Convert.ToDateTime(dsvenda.Tables[0].Rows[0]["ultima_correcao"].ToString().Substring(0, 10));
                    //
                    edcorrecao.Visible = true;
                    edcorrecao.Text = "";
                    edcorrecao.Text = edcorrecao.Text + uVendas.PegaPeriodicidade(cbproduto.Value.ToString(), cbgrupo.Value.ToString(), cbgrupounidades.Value.ToString(), parte, (rbmeiolote.SelectedIndex + 1).ToString());
                    ...
                    edcorrecao.Text = edcorrecao.Text + " - BASE: ";
                    edcorrecao.Text = edcorrecao.Text + uVendas.PegaDataBase(cbproduto.Value.ToString(), cbgrupo.Value.ToString(), cbgrupounidades.Value.ToString(), parte).ToString().Substring(0, 10);
                    //
                    ...
                    cbcorretor.Text = Srelib.QStr0(dsvenda.Tables[0].Rows[0]["corretor"].ToString(),5) + " - ";
                    cbcorretor.Text = cbcorretor.Text + uCorretor.PegaApelidoCorretor(Convert.ToInt32(dsvenda.Tables[0].Rows[0]["corretor"]));
                    //
