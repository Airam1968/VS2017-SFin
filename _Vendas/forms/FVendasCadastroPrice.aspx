<%@ Page Title="FVendasCadastroPrice" Language="C#" AutoEventWireup="true" CodeFile="FVendasCadastroPrice.aspx.cs"
    Inherits="FVendasCadastroPrice" StylesheetTheme="Principal" %>
...
<head id="Head1" runat="server">
    <title>Gitano - Vendas - Cadastro - Tabela Price</title>
...
<body style="height: 1600px">
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="UpdatePanel" runat="server" style="height: 1600px">
            <ContentTemplate>
                <h1>VENDAS - CADASTRO - TABELA PRICE</h1>
                <h2>Cadastro da Venda de Unidade - TABELA PRICE - CORREÇÃO + jUROS</h2>
                <div id="DivNova" style="border-style: none">
                    <div style="border: 1px solid #808080; z-index: 1; left: 35px; top: 100px; position: absolute; height: 1200px; width: 832px; text-align: center;">
                        ...
                        <asp:Label ID="Label41" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            ...
                            Text="Tabela Price %" Theme="PlasticBlue" Visible="False"></asp:Label>
                        <dx:ASPxTextBox ID="edjurostabelaprice" runat="server" Style="z-index: 2; left: 150px; top: 155px; position: absolute; right: 223px;"
                        ...
                        <asp:Label ID="Label42" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            ...
                            Text="Indexador + Juros?" Theme="PlasticBlue" Visible="False"></asp:Label>
                        <dx:ASPxCheckBox ID="ckindexadorejuros" runat="server" Style="z-index: 2; left: 150px; top: 600px; position: absolute; right: 223px;"
                            AutoPostBack="True" CheckState="Unchecked"
                            Font-Bold="False" Font-Names="Calibri" Font-Size="14px" ForeColor="#3E5395" Height="21px"
                            Text=" " Theme="PlasticBlue" Width="120px" Visible="False">
                        </dx:ASPxCheckBox>
                        <asp:Label ID="Label43" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            Font-Size="15px" ForeColor="#3E5395" Style="z-index: 2; left: 9px; top: 635px; position: absolute"
                            Text="Juros" Theme="PlasticBlue" Visible="False"></asp:Label>
                        <dx:ASPxComboBox ID="cbindexadorejuros" runat="server" ValueType="System.String" Font-Bold="True"
                            Font-Names="Calibri" Font-Size="15px" ForeColor="#3E5395" Style="z-index: 5; position: absolute; font-size: 10pt; top: 635px; left: 150px;"
                            Width="380px"
