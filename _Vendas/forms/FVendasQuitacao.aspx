<%@ Page Title="FVendasQuitacao" Language="C#" AutoEventWireup="true" CodeFile="FVendasQuitacao.aspx.cs"
    Inherits="FVendasQuitacao" StylesheetTheme="Principal" %>
...
<head id="Head1" runat="server">
    <title>Gitano - Vendas - Quitação</title>
...
<body style="height: 1400px">
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="UpdatePanel" runat="server" style="height: 1400px">
            <ContentTemplate>
                <h1>VENDAS - QUITAÇÃO</h1>
                <h2>Quitação da Unidade</h2>
                                ...
                                <ContentCollection>
                                    <dx:PopupControlContentControl ID="PopupControlContentControl" runat="server">
                                        <div style="vertical-align: middle">
                                            <br />
                                            Quitação de Vendas.<br />
                                            <br />
                                            O Processo de Quitação deve ser realizado quando o financiamento foi completamente pago e quitado. O Processo se divide nas ações a seguir:<br />
                                            <br />
                                            1o. Congelamento da Venda, Parcelas e Pagamentos, nada poderá ser alterado no financiamento.<br />
                                            <br />
                                            2o. O financiamento passa a constar da lista de Quitados do Sistema.<br />
                                            <br />
                                            <br />
                                        </div>
