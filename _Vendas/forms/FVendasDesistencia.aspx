<%@ Page Title="FVendasDesistencia" Language="C#" AutoEventWireup="true" CodeFile="FVendasDesistencia.aspx.cs"
    Inherits="FVendasDesistencia" StylesheetTheme="Principal" %>
...
<head id="Head1" runat="server">
    <title>Gitano - Vendas - Desistência</title>
...
<body style="height: 1400px">
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="UpdatePanel" runat="server" style="height: 1400px">
            <ContentTemplate>
                <h1>VENDAS - DESISTÊNCIA</h1>
                <h2>Desistência da Venda de Unidade</h2>
                <div id="DivNova" style="border-style: none">
                    <div style="border: 1px solid #808080; z-index: 1; left: 35px; top: 100px; position: absolute; height: 500px; width: 832px; text-align: center;">
                        ...
                        <asp:Label ID="Label42" runat="server" BackColor="White" Font-Bold="True" Font-Names="Calibri"
                            Font-Size="15px" ForeColor="#669900" Style="z-index: 2; left: 9px; top: 120px; position: absolute; width: 520px;"
                        ...
                        <dx:ASPxTextBox ID="edcliente" runat="server" Style="z-index: 2; left: 150px; top: 155px; position: absolute; right: 223px;"
                        ...
                        <dx:ASPxTextBox ID="edfeedback" runat="server" Style="z-index: 2; left: 150px; top: 190px; position: absolute; right: 223px;"
                                ...
                                <ContentCollection>
                                    <dx:PopupControlContentControl ID="PopupControlContentControl" runat="server">
                                        <div style="vertical-align: middle">
                                            ...
                                            Desistência.<br />
                                            <br />
                                            O Processo de Desistência permite que o acordo financeiro feito para uma unidade, possa ser transferido a parte efetivamente paga para um arquivo auxiliar, dando consistência aos dados de Contas a Receber e Conta Corrente, as demais parcelas em aberto são excluidas e a unidade é liberada para nova venda. O Processo se divide nas ações a seguir:<br />
                                            <br />
                                            1o. Escolha da Unidade e informe a data da Desistência.<br />
                                            <br />
                                            2o. Processamento da Desistência.<br />
                                            <br />
                                            3o. Ações decorrentes do Processo:<br />
                                            <br />
                                            - As Parcelas Pagas são armazenadas em um arquivo auxiliar.<br />
                                            - A Venda e as parcelas em aberto são excluidas e a unidade é liberada para nova venda.<br />
                                            <br />
                                            Dica: Emita extrato da venda e parcelas antes de começar o processo. Depois do processo concluído não será mais possivel.<br />
                                            <br />
                                        </div>
