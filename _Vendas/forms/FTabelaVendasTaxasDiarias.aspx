<%@ Page Title="FTabelaVendasTaxasDiarias" Language="C#" AutoEventWireup="true" CodeFile="FTabelaVendasTaxasDiarias.aspx.cs"
    Inherits="FTabelaVendasTaxasDiarias" StylesheetTheme="Principal" ClientIDMode="Inherit" %>
...
<head id="Head1" runat="server">
    <title>Gitano - Vendas - Tabela - Taxas Diárias</title>
...
<body style="height: 1200px">
    ...
    <asp:UpdatePanel ID="UpdatePanel" runat="server" style="height: 1200px">
        <ContentTemplate>
            <h1>
                VENDAS - TABELA - TAXAS DIÁRIAS</h1>
            <h2>
                Manutenção de Taxas Diárias</h2>
            <div id="DivNova" style="border-style: none">
                <div style="border: 1px solid #808080; z-index: 1; left: 35px; top: 100px; position: absolute;
                    ...
                    <dx3:ASPxGridView ID="GridListagem" runat="server" EnableTheming="True"
                        Font-Bold="False" KeyFieldName="ID" Style="margin-right: 6px;" 
