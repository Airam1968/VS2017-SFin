<%@ Page Title="FTabelaVendasCorretores" Language="C#" AutoEventWireup="true" CodeFile="FTabelaVendasCorretores.aspx.cs"
    Inherits="FTabelaVendasCorretores" StylesheetTheme="Principal" ClientIDMode="Inherit" %>
...
<head id="Head1" runat="server">
    <title>Gitano - Vendas - Tabela - Corretores</title>
...
<body style="height: 1200px">
    ...
    <asp:UpdatePanel ID="UpdatePanel" runat="server" style="height: 1200px">
        <ContentTemplate>
            <h1>
                VENDAS - TABELA - CORRETORES</h1>
            <h2>
                Manutenção de Corretores</h2>
                ...
                <div style="border: 1px solid #808080; z-index: 1; left: 35px; top: 100px; position: absolute;
                    ...
                    <dx3:ASPxGridView ID="GridListagem" runat="server" AutoGenerateColumns="False" EnableTheming="True"
                        ...
                        <SettingsText EmptyDataRow="Não há Dados á Exibir" CommandCancel="Cancela" CommandClearFilter="Limpar Filtros"
                            ...
                            CommandUpdate="Altera" ConfirmDelete="Apagar o Registro, Confirma?" PopupEditFormCaption="Manutenção de Corretores"
                            Title="Verificar" />
                        ...
                        <Columns>
                            ...
                            <dx3:GridViewDataTextColumn FieldName="codigo" VisibleIndex="1" Width="100px" Caption="Código"
                                Name="codigo" SortIndex="0" SortOrder="Ascending" ReadOnly="True">
                                <EditFormSettings Caption="Código &gt;" ColumnSpan="1" />
                            ...
                            <dx3:GridViewDataTextColumn Caption="Apelido" FieldName="apelido" 
                                Name="apelido" VisibleIndex="2"
                                Width="100px">
                                <EditFormSettings Caption="Apelido &gt;" CaptionLocation="Near" 
                                    ColumnSpan="4" Visible="True" />
                                <PropertiesTextEdit>
                            ...
                            <dx3:GridViewDataTextColumn Caption="Nome" FieldName="nome" 
                                Name="nome" VisibleIndex="3" Width="300px">
                                <EditFormSettings Caption="Nome &gt;" Visible="True" />
                            ...
                            <dx3:GridViewDataTextColumn Caption="Comissão" FieldName="comissao_base" 
                                Name="comissao_base" VisibleIndex="4" Width="100px">
                                <EditFormSettings Caption="Comissão &gt;" Visible="True" />
