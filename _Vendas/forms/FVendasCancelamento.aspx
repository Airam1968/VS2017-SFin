<%@ Page Title="FVendasCancelamento" Language="C#" AutoEventWireup="true" CodeFile="FVendasCancelamento.aspx.cs"
    Inherits="FVendasCancelamento" StylesheetTheme="Principal" %>
...
<head id="Head1" runat="server">
    <title>Gitano - Vendas - Cancelamento</title>
...
<body style="height: 1400px">
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="UpdatePanel" runat="server" style="height: 1400px">
            <ContentTemplate>
                <h1>VENDAS - CANCELAMENTO</h1>
                <h2>Cancelamento da Venda de Unidade</h2>
                                ...
                                <ContentCollection>
                                    <dx:PopupControlContentControl ID="PopupControlContentControl" runat="server">
                                        <div style="vertical-align: middle">
                                            <br />
                                            Cancelamento da Venda.<br />
                                            <br />
                                            O Processo de Cancelamento da Venda pressupõe que NÃO EXISTEM PAGAMENTOS, ou seja,
                                        cancela uma venda sem envolvimento financeiro dentro do Sistema.<br />
                                            <br />
                                            Caso existam valores envolvidos, pagamentos feitos, outros procedimentos devem ser
                                        adotados conforme o caso.<br />
                                            <br />
                                            Caso necessite, solicite suporte ou orientação para proseguir.<br />
                                            <br />
                                        </div>
