<%@ Page Title="FTabelaVendasMensagensBoleto" Language="C#" AutoEventWireup="true" CodeFile="FTabelaVendasMensagensBoleto.aspx.cs"
    Inherits="FTabelaVendasMensagensBoleto" StylesheetTheme="Principal" ClientIDMode="Inherit" %>
...
<head id="Head1" runat="server">
    <title>Gitano - Vendas - Tabela - Mensagens Boleto</title>
...
<body style="height: 1200px">
    ...
    <asp:UpdatePanel ID="UpdatePanel" runat="server" style="height: 1200px">
        <ContentTemplate>
            <h1>
                VENDAS - TABELA - MENSAGENS BOLETO</h1>
            <h2>
                Manutenção de Mensagens Boleto</h2>
                ...
                <div style="border: 1px solid #808080; z-index: 1; left: 35px; top: 100px; position: absolute;
                    ...
                    <dx3:ASPxGridView ID="GridListagem" runat="server" AutoGenerateColumns="False" EnableTheming="True"
                        ...
                        <SettingsText EmptyDataRow="Não há Dados á Exibir" CommandCancel="Cancela" CommandClearFilter="Limpar Filtros"
                            ...
                            CommandUpdate="Altera" ConfirmDelete="Apagar o Registro, Confirma?" PopupEditFormCaption="Manutenção de Mensagens Boleto"
                            Title="Verificar" />
                        ...
                        <Columns>
                            ...
                            <dx3:GridViewDataTextColumn Caption="Produto" FieldName="produto" 
                                Name="produto" VisibleIndex="2"
                                Width="100px">
                                <EditFormSettings Caption="Produto &gt;" CaptionLocation="Near" 
                            ...
                            <dx3:GridViewDataTextColumn Caption="Linha 1" FieldName="linha1" 
                                Name="linha1" VisibleIndex="3" Width="400px">
                                <PropertiesTextEdit EnableFocusedStyle="False">
                                </PropertiesTextEdit>
                                <EditFormSettings Caption="Linha 1 &gt;" Visible="True" />
                            ...
                            <dx3:GridViewDataTextColumn Caption="Linha 2" FieldName="linha2" 
                                Name="linha2" VisibleIndex="5" Width="400px">
                                <EditFormSettings Caption="Linha 2 &gt;" ColumnSpan="2" Visible="True" />
                                <EditFormCaptionStyle Font-Bold="True" HorizontalAlign="Right">
                                </EditFormCaptionStyle>
                                <HeaderStyle Font-Bold="True" />
                            </dx3:GridViewDataTextColumn>
                            <dx3:GridViewDataTextColumn Caption="Linha 3" FieldName="linha3" Name="linha3" 
                                VisibleIndex="6" Width="400px">
                                <EditFormSettings Caption="Linha 3 &gt;" ColumnSpan="2" Visible="True" />
                                <EditFormCaptionStyle Font-Bold="True" HorizontalAlign="Right">
                                </EditFormCaptionStyle>
                                <HeaderStyle Font-Bold="True" />
                            </dx3:GridViewDataTextColumn>
                            <dx3:GridViewDataTextColumn Caption="Linha 4" FieldName="linha4" Name="linha4" 
                                VisibleIndex="7" Width="400px">
                                <EditFormSettings Caption="Linha 4 &gt;" ColumnSpan="2" Visible="True" />
                                <EditFormCaptionStyle Font-Bold="True" HorizontalAlign="Right">
                                </EditFormCaptionStyle>
                                <HeaderStyle Font-Bold="True" />
                            </dx3:GridViewDataTextColumn>
                            <dx3:GridViewDataTextColumn Caption="Linha 5" FieldName="linha5" Name="linha5" 
                                VisibleIndex="8" Width="400px">
                                <EditFormSettings Caption="Linha 5 &gt;" ColumnSpan="2" Visible="True" />
                                <EditFormCaptionStyle Font-Bold="True" HorizontalAlign="Right">
                                </EditFormCaptionStyle>
                                <HeaderStyle Font-Bold="True" />
                            </dx3:GridViewDataTextColumn>
