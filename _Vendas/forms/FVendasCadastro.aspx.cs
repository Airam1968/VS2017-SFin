...
public partial class FVendasCadastro : System.Web.UI.Page
{
    DataSet dsunidade;
    ...
    protected void btprocessa_Click(object sender, EventArgs e)
    {
            ...
            if (cbproduto.Text != string.Empty)
            {
                if (cbgrupo.Text != string.Empty)
                {
                    ...
                    else
                    {
                        ...
                        ScriptManager.RegisterStartupScript(this.Page, typeof(Page), Guid.NewGuid().ToString(),
                                            "toastr.warning('Unidade não selecionada!', 'Atenção!')", true);
                    }
                ...
                else
                {
                    ...
                    ScriptManager.RegisterStartupScript(this.Page, typeof(Page), Guid.NewGuid().ToString(),
                                        "toastr.warning('Grupo não selecionado!', 'Atenção!')", true);
                }
            }
            else
            {
                ...
                ScriptManager.RegisterStartupScript(this.Page, typeof(Page), Guid.NewGuid().ToString(),
                                    "toastr.warning('Produto não selecionado!', 'Atenção!')", true);
            }
        ...
        if (lOk)
        {
            ...
            if (SreDblib.GetParametro("FILTRO CONTATO") == "SIM")
            {
                ...
                else
                {
                    ...
                    ScriptManager.RegisterStartupScript(this.Page, typeof(Page), Guid.NewGuid().ToString(),
                                        "toastr.warning('Cliente não selecionado!', 'Atenção!')", true);
                }
            }
            else
            {
        ...
        if (lOk)
        {
            ...
            else
            {
                ...
                ScriptManager.RegisterStartupScript(this.Page, typeof(Page), Guid.NewGuid().ToString(),
                                    "toastr.error('Valor de Venda igual a Zero!', 'Atenção!')", true);
            }
            //Fim Valor da Venda
        }
        //
        if (lOk)
        {
            ...
            if ((edvlrsinal.Text != string.Empty) && (edvlrsinal.Text != "0,00"))
            {
                ...
                if (cksinalparcelado.Checked)
                {
                    ...
                    else
                    {
                        ...
                        ScriptManager.RegisterStartupScript(this.Page, typeof(Page), Guid.NewGuid().ToString(),
                                            "toastr.error('Quantidade de Parcelas de Sinal igual a Zero!', 'Atenção!')", true);
                    }
                }
            }
            else
            {
                if (cksinalparcelado.Visible == true)
                {
                    ...
                    ScriptManager.RegisterStartupScript(this.Page, typeof(Page), Guid.NewGuid().ToString(),
                                        "toastr.error('Valor de Sinal igual a Zero!', 'Atenção!')", true);
                }
            }
            //Fim Sinal Parcelado
        }
        ...
        if (lOk)
        {
            ...
            if ((edvlrintermediarias.Text != string.Empty) && (edvlrintermediarias.Text != "0,00"))
            {
                ...
                else
                {
                    ...
                    ScriptManager.RegisterStartupScript(this.Page, typeof(Page), Guid.NewGuid().ToString(),
                                        "toastr.error('Quantidade de Parcelas de Intermediarias igual a Zero!', 'Atenção!')", true);
        ...
        if (lOk)
        {
            ...
            if ((edvlrfluxoparcelas.Text != string.Empty) && (edvlrfluxoparcelas.Text != "0,00"))
            {
                ...
                else
                {
                    ...
                    ScriptManager.RegisterStartupScript(this.Page, typeof(Page), Guid.NewGuid().ToString(),
                                        "toastr.error('Quantidade de Fluxos igual a Zero!', 'Atenção!')", true);
                }
            }
            else
            {
        ...
        if (lOk)
        {
            ...
            else
            {
                ...
                ScriptManager.RegisterStartupScript(this.Page, typeof(Page), Guid.NewGuid().ToString(),
                                    "toastr.error('Selecione um Indexador!', 'Atenção!')", true);
            }
        ...
        if (lOk)
        {
            ...
            else
            {
                ...
                ScriptManager.RegisterStartupScript(this.Page, typeof(Page), Guid.NewGuid().ToString(),
                                    "toastr.error('Selecione um Corretor!', 'Atenção!')", true);
            }
        ...
        if (lOk)
        {
            ...
            else
            {
                ...
                ScriptManager.RegisterStartupScript(this.Page, typeof(Page), Guid.NewGuid().ToString(),
                                    "toastr.error('Valor de Multa igual a Zero!', 'Atenção!')", true);
            }
            //Fim Valor da Multa
        }
        //
        if (lOk)
        {
            ...
            else
            {
                ...
                ScriptManager.RegisterStartupScript(this.Page, typeof(Page), Guid.NewGuid().ToString(),
                                    "toastr.error('Valor de Comissão de Permanência igual a Zero!', 'Atenção!')", true);
            }
        ...
        if (lOk)
        {
            ...
            if (vlr_venda != Resultado)
            {
                if (vlr_venda > Resultado)
                {
                    ...
                    lOk = false;
                    //ScriptManager.RegisterStartupScript(UpdatePanel, GetType(), "msgbox", "alert('Soma dos componentes da venda é MENOR que o valor de venda!');", true);
                    ScriptManager.RegisterStartupScript(this.Page, typeof(Page), Guid.NewGuid().ToString(),
                                        "toastr.error('Soma dos componentes da venda é MENOR que o valor de venda!', 'Atenção!','mid-center')", true);
                }
                else
                {
                    //Resultado Maior que valor da venda
                    lOk = false;
                    //ScriptManager.RegisterStartupScript(UpdatePanel, GetType(), "msgbox", "alert('Soma dos componentes da venda é MAIOR que o valor de venda!');", true);
                    ScriptManager.RegisterStartupScript(this.Page, typeof(Page), Guid.NewGuid().ToString(),
                                        "toastr.error('Soma dos componentes da venda é MAIOR que o valor de venda!', 'Atenção!','mid-center')", true);
                }
            }
        }
        //
        if (lOk)
        {
            ...
            //
            if (edvlrparcelafluxo.Text == String.Empty)
            {
            ...
            //Fim Processa Venda
            // CRIA LOG ===================================================================================================================================================
            fwObs_Log = "VENDA UNIDADE: " + produto + "/" + grupo + "/" + grupounidade + "/" + grupounidadeparte;
            SqlParameter[] param_log = { new SqlParameter("@login"    , (String)Session["CodUsuario"]         ),
                                         new SqlParameter("@tabela"   , fWtabela                              ),
                                         new SqlParameter("@operacao" , "VENDAS"                              ),
                                         new SqlParameter("@obs"      , "VENDA UNIDADE"                       ),
            ...
            else
            {
                ...
                if (Total != Convert.ToDouble(edvlrsinal.Text))
                {
                    if (Total > Convert.ToDouble(edvlrsinal.Text))
                    {
                        ...
                        btprocessa.Focus();
                        ScriptManager.RegisterStartupScript(this.Page, typeof(Page), Guid.NewGuid().ToString(),
                                            "toastr.error('Soma dos componentes do Sinal MAIOR que o Total de Sinal!', 'Atenção!')", true);
                    }
                    else
                    {
                        //Resultado Maior que valor da venda
                        ...
                        btprocessa.Focus();
                        ScriptManager.RegisterStartupScript(this.Page, typeof(Page), Guid.NewGuid().ToString(),
                                            "toastr.error('Soma dos componentes do Sinal MENOR que o Total de Sinal!', 'Atenção!')", true);
                    }
                }
                //
                if (lOk)
            ...
            else
            {
                ...
                if (Total != Convert.ToDouble(edvlrintermediarias.Text))
                {
                    if (Total > Convert.ToDouble(edvlrintermediarias.Text))
                    {
                        ...
                        btprocessa.Focus();
                        ScriptManager.RegisterStartupScript(this.Page, typeof(Page), Guid.NewGuid().ToString(),
                                            "toastr.error('Soma dos componentes de Intermediarias MAIOR que o Total de Intermediarias!', 'Atenção!')", true);
                    ...
                    else
                    {
                        ...
                        btprocessa.Focus();
                        ScriptManager.RegisterStartupScript(this.Page, typeof(Page), Guid.NewGuid().ToString(),
                                            "toastr.error('Soma dos componentes de Intermediarias MENOR que o Total de Intermediarias!', 'Atenção!')", true);
            ...
            else
            {
                ...
                if (Total != Convert.ToDouble(edvlrfluxoparcelas.Text))
                {
                    if (Total > Convert.ToDouble(edvlrfluxoparcelas.Text))
                    {
                        ...
                        lOk = false;
                        //ScriptManager.RegisterStartupScript(UpdatePanel, GetType(), "msgbox", "alert('Soma dos componentes do Fluxo é MAIOR que o Total de Fluxo de Parcelas!');", true);
                        btprocessa.Focus();
                        ScriptManager.RegisterStartupScript(this.Page, typeof(Page), Guid.NewGuid().ToString(),
                                            "toastr.error('Soma dos componentes do Fluxo é MAIOR que o Total de Fluxo de Parcelas!', 'Atenção!')", true);
                    }
                    else
                    {
                        //Resultado Maior que valor da Fluxo
                        lOk = false;
                        //ScriptManager.RegisterStartupScript(UpdatePanel, GetType(), "msgbox", "alert('Soma dos componentes do Fluxo é MENOR que o Total de Fluxo de Parcelas!');", true);
                        btprocessa.Focus();
                        ScriptManager.RegisterStartupScript(this.Page, typeof(Page), Guid.NewGuid().ToString(),
                                            "toastr.error('Soma dos componentes do Fluxo é MENOR que o Total de Fluxo de Parcelas!', 'Atenção!')", true);
