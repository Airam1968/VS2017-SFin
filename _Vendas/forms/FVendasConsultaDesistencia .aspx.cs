...
public partial class FVendasConsultaDesistencia : System.Web.UI.Page
{
    DataSet dsparcelas;
    DataSet dsvenda;
            ...
            if (cbgrupo.Text != string.Empty)
            {
                if (cbgrupounidades.Text != string.Empty)
                {
                    ...
                    else
                    {
                        ...
                        //
                        uVendas.MontaComboDesistencias(cbdesistencias,
                        ...
                        cbdesistencias.Text = "";
                        //
                        if (cbdesistencias.Items.Count > 0)
                        {
                            Label42.Visible = true;
                            cbdesistencias.Visible = true;
                            btprocessa.Enabled = true;
                        }
                        else
                        {
    ...
    private void AtualizaGrid()
    {
        ...
        dsparcelas = uParcelas.PegaDadosParcelasRenegociacao(cbproduto.Value.ToString().Trim(),
                                                             ...
                                                             dtbase.Date.ToString().Substring(0, 10).Trim(),
                                                             dtvenda.Date.ToString().Substring(0, 10).Trim(),
                                                             "T",
                                                             "0",
                                                             "N",
                                                             false);
    ...
    protected void btprocessa_Click(object sender, EventArgs e)
    {
        ...
        {
            //Renegociações
            if (cbdesistencias.Text != String.Empty)
            {
                ID = cbdesistencias.Text.Substring(3, 7);
            }
            else
            {
                lOk = false;
