<%@ Page Title="FVendasConsultaRenegociacao" Language="C#" AutoEventWireup="true" CodeFile="FVendasConsultaRenegociacao.aspx.cs"
    Inherits="FVendasConsultaRenegociacao" StylesheetTheme="Principal" %>
...
<head id="Head1" runat="server">
    <title>Gitano - Vendas - Consulta Renegociação</title>
...
<body style="height: 1400px">
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="UpdatePanel" runat="server" style="height: 1400px">
            <ContentTemplate>
                <h1>VENDAS - CONSULTA RENEGOCIAÇÃO</h1>
                <h2>Consulta Renegociação da Venda</h2>
                <div id="DivNova" style="border-style: none">
                    <div style="border: 1px solid #808080; z-index: 1; left: 35px; top: 100px; position: absolute; height: 1200px; width: 832px; text-align: center;">
                        ...
                        <asp:Label ID="Label42" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            ...
                            Text="Renegociações" Theme="PlasticBlue" Visible="False"></asp:Label>
                        <dx:ASPxComboBox ID="cbrenegociacoes" runat="server" ValueType="System.String" Font-Bold="True"
                            Font-Names="Calibri" Font-Size="15px" ForeColor="#3E5395" Style="z-index: 5; position: absolute; font-size: 10pt; top: 155px; left: 150px;"
                            Width="380px" Theme="PlasticBlue"
                        ...
                        <asp:Label ID="Label4" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            ...
                            Text="Data da Renegociação" Theme="PlasticBlue" Visible="False"></asp:Label>
