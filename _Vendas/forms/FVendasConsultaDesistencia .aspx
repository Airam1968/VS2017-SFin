<%@ Page Title="FVendasConsultaDesistencia" Language="C#" AutoEventWireup="true" CodeFile="FVendasConsultaDesistencia .aspx.cs"
    Inherits="FVendasConsultaDesistencia" StylesheetTheme="Principal" %>
...
<head id="Head1" runat="server">
    <title>Gitano - Vendas - Consulta Desistência</title>
...
<body style="height: 1400px">
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="UpdatePanel" runat="server" style="height: 1400px">
            <ContentTemplate>
                <h1>VENDAS - CONSULTA DESISTÊNCIA</h1>
                <h2>Consulta Desistência da Venda</h2>
                <div id="DivNova" style="border-style: none">
                    <div style="border: 1px solid #808080; z-index: 1; left: 35px; top: 100px; position: absolute; height: 1200px; width: 832px; text-align: center;">
                        ...
                        <asp:Label ID="Label42" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            ...
                            Text="Desistência" Theme="PlasticBlue" Visible="False"></asp:Label>
                        <dx:ASPxComboBox ID="cbdesistencias" runat="server" ValueType="System.String" Font-Bold="True"
