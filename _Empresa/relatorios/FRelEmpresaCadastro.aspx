<%@ Page Title="FRelEmpresaCadastro" Language="C#" AutoEventWireup="true" CodeFile="FRelEmpresaCadastro.aspx.cs"
    Inherits="FRelEmpresaCadastro" StylesheetTheme="Principal" %>
...
<head id="Head1" runat="server">
    <title>Relatório Empresa Cadastro</title>
            ...
            <div id="DivNova" style="border-style: none">
                <div style="border: 1px solid #808080; z-index: 1; left: 35px; top: 100px; position: absolute;
                    ...
                    <asp:Label ID="Label1" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                        ...
                        position: absolute" Text="Empresa "></asp:Label>
                        ...
                        <ContentCollection>
                            <dx:PopupControlContentControl ID="PopupControlContentControl" runat="server">
                                <div style="vertical-align: middle">
                                    Relatório Empresas.<br />
                                    <br />
                                    O Relatório em questão apresenta os dados das Empresas cadastradas.<br />
                                    <br />
                                </div>
