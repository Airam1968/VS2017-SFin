<%@ Page Title="FEmpresaCadastro" Language="C#" AutoEventWireup="true" CodeFile="FEmpresaCadastro.aspx.cs"
    Inherits="FEmpresaCadastro" StylesheetTheme="Principal" %>
...
<head id="Head1" runat="server">
    <title>Gitano - Empresa - Cadastro</title>
            ...
            <div id="DivNova" style="border-style: none">
                <div style="border: 1px solid #808080; z-index: 1; left: 35px; top: 100px; position: absolute;
                    ...
                    <dx3:ASPxGridView ID="GridListagem" runat="server" AutoGenerateColumns="False" EnableTheming="True"
                        Font-Bold="False" KeyFieldName="login" Style="margin-right: 6px;" Theme="PlasticBlue"
                        ...
                        <SettingsText EmptyDataRow="Não há Dados á Exibir" CommandCancel="Cancela" CommandClearFilter="Limpar Filtros"
                            ...
                            CommandUpdate="Grava" ConfirmDelete="Apagar o Registro, Confirma?" PopupEditFormCaption="Manutenção de Empresas"
                            Title="Verificar" />
                        ...
                        <SettingsText EmptyDataRow="Não há Dados á Exibir" CommandCancel="Cancela" CommandClearFilter="Limpar Filtros"
                            ...
                            CommandUpdate="Altera" ConfirmDelete="Apagar o Registro, Confirma?" PopupEditFormCaption="Manutenção de Empresas"
                            Title="Verificar" />
                        ...
                        <Columns>
                            ...
                            <dx3:GridViewDataTextColumn FieldName="apelido" VisibleIndex="1" Width="200px" Caption="Apelido"
                            ...
                            <dx3:GridViewDataTextColumn Caption="CNPJ" FieldName="cnpj" Name="CPFCNPJ"
                            ...
                            <dx3:GridViewDataTextColumn Caption="ID" FieldName="ID" Name="ID"
                                VisibleIndex="0" Width="40px" ReadOnly="True">
                            ...
                            <dx3:GridViewDataCheckColumn Caption="Ativo" FieldName="ativo" Name="Ativo" VisibleIndex="4"
                                Width="50px">
                            ...
                            <dx3:GridViewDataTextColumn Caption="Inscr.Municipal" FieldName="inscmunicipal" 
                                Name="inscmunicipal" Visible="False" VisibleIndex="7">
                            ...
                            <dx3:GridViewDataTextColumn Caption="Inscr.Estadual" FieldName="inscestadual" 
                                Name="inscestadual" Visible="False" VisibleIndex="8">
                                <PropertiesTextEdit MaxLength="20">
                                </PropertiesTextEdit>
                            ...
                            <dx3:GridViewDataTextColumn Caption="Reg.Junta Comercial" 
                                FieldName="regjuntacom" Name="regjuntacom" Visible="False" 
                                VisibleIndex="9">
                            ...
                            <dx3:GridViewDataTextColumn Caption="Endereço" FieldName="enderecocom" 
                                Name="enderecocom" Visible="False" VisibleIndex="11">
                                <PropertiesTextEdit MaxLength="70">
                                </PropertiesTextEdit>
                                <EditFormSettings Caption="Endereço &gt;" ColumnSpan="2" Visible="True" />
                                <EditFormCaptionStyle Font-Bold="True" HorizontalAlign="Right">
                                </EditFormCaptionStyle>
                            </dx3:GridViewDataTextColumn>
                            <dx3:GridViewDataTextColumn Caption="Número" FieldName="enderecocomnumero" 
                                Name="enderecocomnumero" Visible="False" VisibleIndex="12">
                            ...
                            <dx3:GridViewDataTextColumn Caption="Complemento" 
                                FieldName="enderecocomcomplem" Name="enderecocomcomplem" Visible="False" 
                                VisibleIndex="13">
                                <PropertiesTextEdit MaxLength="30">
                                </PropertiesTextEdit>
                            ...
                            <dx3:GridViewDataTextColumn Caption="Bairro" FieldName="bairrocom" 
                                Name="bairrocom" Visible="False" VisibleIndex="14">
                                <PropertiesTextEdit MaxLength="20">
                                </PropertiesTextEdit>
                            ...
                            <dx3:GridViewDataTextColumn Caption="Cidade" FieldName="cidadecom" 
                                Name="cidadecom" Visible="False" VisibleIndex="15">
                                <PropertiesTextEdit MaxLength="20">
                                </PropertiesTextEdit>
                            ...
                            <dx3:GridViewDataTextColumn Caption="UF" FieldName="ufcom" Name="ufcom" 
                                Visible="False" VisibleIndex="16" Width="100px">
                            ...
                            <dx3:GridViewDataTextColumn Caption="CEP" FieldName="cepcom" Name="cepcom" 
                                Visible="False" VisibleIndex="17" Width="100px">
                            ...
                            <dx3:GridViewDataTextColumn Caption="Telefone 1" FieldName="fone1com" 
                                Name="fone1com" Visible="False" VisibleIndex="18">
                                <PropertiesTextEdit MaxLength="30">
                                </PropertiesTextEdit>
                            ...
                            <dx3:GridViewDataTextColumn Caption="Telefone 2" FieldName="fone2com" 
                                Name="fone2com" Visible="False" VisibleIndex="19">
                                <PropertiesTextEdit MaxLength="30">
                                </PropertiesTextEdit>
                            ...
                            <dx3:GridViewDataTextColumn Caption="Telefone 3" FieldName="fone3com" 
                                Name="fone3com" Visible="False" VisibleIndex="20">
                                <PropertiesTextEdit MaxLength="30">
                                </PropertiesTextEdit>
                            ...
                            <dx3:GridViewDataTextColumn Caption="Gerente" FieldName="gerente" 
                                Name="gerente" Visible="False" VisibleIndex="26">
                            ...
                            <dx3:GridViewDataTextColumn Caption="Contato" FieldName="contato" 
                                Name="contato" Visible="False" VisibleIndex="27">
                                <PropertiesTextEdit MaxLength="20">
                                </PropertiesTextEdit>
                            ...
                            <dx3:GridViewDataDateColumn Caption="Fundação" FieldName="dtnascimento" 
                                Name="dtnascimento" Visible="False" VisibleIndex="28" Width="150px">
                                <PropertiesDateEdit DisplayFormatString="" Width="100px">
                                    <ValidationSettings>
                                        <RequiredField ErrorText="Preenchimento Obrigatório!" IsRequired="True" />
                                    </ValidationSettings>
                                </PropertiesDateEdit>
                                <EditFormSettings Caption="Fundação &gt;" ColumnSpan="2" Visible="True" />
                                <EditFormCaptionStyle Font-Bold="True" HorizontalAlign="Right">
                                </EditFormCaptionStyle>
                            </dx3:GridViewDataDateColumn>
                            <dx3:GridViewDataTextColumn Caption="No. Contrato" FieldName="ncontrato" 
                                Name="ncontrato" Visible="False" VisibleIndex="30">
                                <PropertiesTextEdit MaxLength="10">
                                </PropertiesTextEdit>
                            ...
                            <dx3:GridViewDataDateColumn Caption="Data Contrato" FieldName="dtcontrato" 
                                Name="dtcontrato" Visible="False" VisibleIndex="31" Width="150px">
                                <PropertiesDateEdit DisplayFormatString="" Width="100px">
                                </PropertiesDateEdit>
                            ...
                            <dx3:GridViewDataDateColumn Caption="Cadastro" FieldName="dtingresso" 
                                Name="dtingresso" Visible="False" VisibleIndex="29" Width="150px">
                                <PropertiesDateEdit DisplayFormatString="" Width="100px">
                                    <ValidationSettings>
                                        <RequiredField ErrorText="Preenchimento Obrigatório!" IsRequired="True" />
                                    </ValidationSettings>
                            ...
                            <dx3:GridViewDataCheckColumn Caption="Acesso á Internet" 
                                FieldName="acessointernet" Name="acessointernet" Visible="False" 
                                VisibleIndex="32">
                            ...
                            <dx3:GridViewDataTextColumn Caption="1a. Instrução de Cobrança" 
                                FieldName="instrcob1" Name="instrcob1" Visible="False" VisibleIndex="38" 
                                Width="100px">
                                <PropertiesTextEdit MaxLength="2" Width="100px">
                                </PropertiesTextEdit>
                            ...
                            <dx3:GridViewDataTextColumn Caption="2a. Instrução de Cobrança" 
                                FieldName="instrcob2" Name="instrcob2" Visible="False" VisibleIndex="39" 
                                Width="100px">
                                <PropertiesTextEdit MaxLength="2" Width="100px">
                                </PropertiesTextEdit>
                            ...
                            <dx3:GridViewDataTextColumn Caption="Dias Protesto" FieldName="diasprotesto" 
                                Name="diasprotesto" Visible="False" VisibleIndex="40" Width="100px">
                                <PropertiesTextEdit MaxLength="2" Width="100px">
                                </PropertiesTextEdit>
                            ...
                            <dx3:GridViewDataTextColumn Caption="Conta 1" FieldName="conta1" Name="conta1" 
                                Visible="False" VisibleIndex="41" Width="150px">
                            ...
                            <dx3:GridViewDataTextColumn Caption="Conta 2" FieldName="conta2" Name="conta2" 
                                Visible="False" VisibleIndex="42" Width="150px">
                                <PropertiesTextEdit MaxLength="18">
                                </PropertiesTextEdit>
                            ...
                            <dx3:GridViewDataTextColumn Caption="Conta 5" FieldName="conta5" Name="conta5" 
                                Visible="False" VisibleIndex="45" Width="150px">
                                <PropertiesTextEdit MaxLength="18">
                                </PropertiesTextEdit>
                            ...
                            <dx3:GridViewDataCheckColumn Caption="Matriz" FieldName="matriz" Name="Matriz" 
                                VisibleIndex="5" Width="50px">
                                <PropertiesCheckEdit DisplayTextChecked="Marcado" 
                                    DisplayTextUnchecked="Desmarcado">
                                </PropertiesCheckEdit>
                                <EditFormSettings Caption="Matriz &gt;" Visible="True" />
                                <EditCellStyle HorizontalAlign="Left">
                                </EditCellStyle>
                                <EditFormCaptionStyle Font-Bold="True" HorizontalAlign="Right">
                                </EditFormCaptionStyle>
