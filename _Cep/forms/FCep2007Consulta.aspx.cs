...
public partial class FCep2007Consulta : System.Web.UI.Page
{
    DataSet dscep;
    ...
    String fwObs_Log = "";
    String fWtabela = uParametros.PegaParametro("BASE CEP");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            //
            uUF.MontaComboUF(cbuf, true);
            //
            if (fWtabela == String.Empty)
            {
                Label3.Text = "CEP (" + "Erro Configuração, Parâmetro BASE CEP, corrija." + "): ";
            }
            else
            {
                Label3.Text = "CEP (" + fWtabela + "): ";
            }
            //
        }
