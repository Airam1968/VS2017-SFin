<%@ Page Title="FTabelaDespesas" Language="C#" AutoEventWireup="true" CodeFile="FTabelaDespesas.aspx.cs"
    Inherits="FTabelaDespesas" StylesheetTheme="Principal" ClientIDMode="Inherit" %>
...
<head id="Head1" runat="server">
    <title>Gitano - A Pagar - Tabela - Despesas</title>
...
<body style="height: 1200px">
    ...
    <asp:UpdatePanel ID="UpdatePanel" runat="server" style="height: 1200px">
        <ContentTemplate>
            <h1>
                A PAGAR - TABELA - DESPESAS</h1>
            <h2>
                Manutenção de Tipo de Despesas</h2>
                ...
                <div style="border: 1px solid #808080; z-index: 1; left: 35px; top: 100px; position: absolute;
                    ...
                    <dx3:ASPxGridView ID="GridListagem" runat="server" AutoGenerateColumns="False" EnableTheming="True"
                        ...
                        <SettingsText EmptyDataRow="Não há Dados á Exibir" CommandCancel="Cancela" CommandClearFilter="Limpar Filtros"
                            ...
                            CommandUpdate="Altera" ConfirmDelete="Apagar o Registro, Confirma?" PopupEditFormCaption="Manutenção de Tipo de Despesas"
                            Title="Verificar" />
                            ...
                            <ContentCollection>
                                <dx:PopupControlContentControl ID="PopupControlContentControl" runat="server">
                                    <div style="vertical-align: middle">
                                        Tipo de Despesas.<br />
                                        <br />
                                        Plano de Contas de Tipos de Despesas.<br />
                                        <br />
                                        Despesas para o cadastro de lançamentos de Contas a Pagar.<br />
                                        <br />
                                    </div>
