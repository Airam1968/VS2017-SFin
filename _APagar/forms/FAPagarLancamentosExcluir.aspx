<%@ Page Title="FAPagarLancamentosExcluir" Language="C#" AutoEventWireup="true" CodeFile="FAPagarLancamentosExcluir.aspx.cs"
    Inherits="FAPagarLancamentosExcluir" StylesheetTheme="Principal" %>
...
<head id="Head1" runat="server">
    <title>Gitano - Contas a Pagar - Excluir Lançamentos</title>
...
<body style="height: 1400px">
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="UpdatePanel" runat="server" style="height: 1400px">
            <ContentTemplate>
                <h1>LANÇAMENTOS - CONTAS A PAGAR</h1>
                ...
                <div id="DivNova" style="border-style: none">
                    <div style="border: 1px solid #808080; z-index: 1; left: 35px; top: 100px; position: absolute; height: 1200px; width: 832px; text-align: center;">
                        ...
                        <dx:ASPxTextBox ID="edlancamento" runat="server" Style="z-index: 2; left: 150px; top: 15px; position: absolute; right: 482px;"
                            ...
                            AutoPostBack="True" HorizontalAlign="Right" OnTextChanged="edlancamento_TextChanged">
                        </dx:ASPxTextBox>
                        ...
                        <asp:Label ID="Label2" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            ...
                            Text="Tipo de Despesa" Theme="PlasticBlue" Visible="False"></asp:Label>
                        ...
                        <dx:ASPxDateEdit ID="dtnotafiscal1" runat="server" BackColor="#E1E6F2" DisplayFormatString="dd/MM/yyyy"
                            ...
                            Theme="PlasticBlue"
                            UseMaskBehavior="True" Width="120px" Visible="False" ReadOnly="True" AutoPostBack="True" MinDate="1900-01-01">
                        ...
                        <asp:Label ID="Label11" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            ...
                            Text="Documento Compra" Theme="PlasticBlue"></asp:Label>
                        ...
                        <asp:RadioButtonList ID="rbchequenominal" runat="server" AutoPostBack="True" CellPadding="0"
                        ...
                        <div id="Div2" runat="server" style="border: 1px solid #808080; z-index: 2; position: absolute; top: 20px; left: 700px; height: 50px; width: 100px;">
                            <dx:ASPxButton ID="btprocessa" runat="server" Height="40px" ImagePosition="Left"
                                OnClick="btprocessa_Click" Width="45px" ToolTip="Exlui Lançamento">
                                <Image Height="30px" ToolTip="Exlui Lançamento" Url="~/images/BotoesTelas/BTNalterarA.bmp"
                                ...
                                <ContentCollection>
                                    <dx:PopupControlContentControl ID="PopupControlContentControl" runat="server">
                                        <div style="vertical-align: middle">
                                            ...
                                            <br />
                                            Os lançamentos de contas a pagar se dividem em previsão de pagamento e pagamento
