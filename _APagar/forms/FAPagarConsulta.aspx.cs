...
public partial class FAPagarConsulta : System.Web.UI.Page
{
    DataSet dscpagar;
    ...
    private void AtualizaGrid(String situacaopgto, String ordenacao)
    {
        ...
        dscpagar = uContasPagar.PegaDadosCPagar(cbproduto2,
                                                cbdespesa2,
                                                cbfornecedor2,
                                                cbcontascorrentes2,
                                                dtprevisao1.Text.Substring(0, 10),
                                                dtprevisao2.Text.Substring(0, 10),
                                                dtrealizado1.Text.Substring(0, 10),
                                                dtrealizado2.Text.Substring(0, 10),
                                                dtnotafiscal1.Text.Substring(0, 10),
                                                dtnotafiscal2.Text.Substring(0, 10),
                                                eddocumento.Text,
                                                situacaopgto,
                                                ordenacao,
                                                false,
        ...
        if (ordenacao == "L")
        {
            GridListagem.KeyFieldName = "lancamento";
        }
        //Todas/Classe Despesa
        if (ordenacao == "D")
        {
            GridListagem.KeyFieldName = "despesa";
        }
        //Todas/Fornecedores
        if (ordenacao == "F")
        {
            GridListagem.KeyFieldName = "fornecedor";
        }
        //Todas/Data Prevista
        if (ordenacao == "DP")
        {
            GridListagem.KeyFieldName = "data_prevista";
        }
        //Todas/Data Realizado
        if (ordenacao == "DR")
        {
            GridListagem.KeyFieldName = "data_realizado";
        }
        //Todas/Data Nota Fiscal
        if (ordenacao == "DN")
        {
            GridListagem.KeyFieldName = "data_documento";
        }
        //  
        //
