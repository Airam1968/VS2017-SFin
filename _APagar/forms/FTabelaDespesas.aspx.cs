...
public partial class FTabelaDespesas : System.Web.UI.Page
{
    DataSet dsdespesas;
    ...
    {
        //dsusuario.Clear();
        dsdespesas = uDespesas.PegaDadosDespesas("");
        GridListagem.DataSource = dsdespesas;
    ...
    protected void GridListagem_RowInserting(object sender, DevExpress.Web.Data.ASPxDataInsertingEventArgs e)
    {
        ...
        fwObs_Log = "INCLUI CLASSE DESPESAS: " + codigo + "/" + descricao;
        SqlParameter[] param_log = { new SqlParameter("@login"    , (String)Session["CodUsuario"]),
                                     new SqlParameter("@tabela"   , fWtabela                     ),
                                     new SqlParameter("@operacao" , "CLASSE DESPESAS"            ),
    ...
    protected void GridListagem_RowUpdating(object sender, DevExpress.Web.Data.ASPxDataUpdatingEventArgs e)
    {
        ...
        //Usando Classe uLog.MakeLog - Gravando Log
        fwObs_Log = "ALTERA CLASSE DESPESAS: " + codigo + "/" + descricao;
        SqlParameter[] param_log = { new SqlParameter("@login"    , (String)Session["CodUsuario"]),
                                     new SqlParameter("@tabela"   , fWtabela                     ),
                                     new SqlParameter("@operacao" , "CLASSE DESPESAS"            ),
    ...
    protected void GridListagem_RowDeleting(object sender, DevExpress.Web.Data.ASPxDataDeletingEventArgs e)
    {
        ...
        uDespesas.ExcluiDespesa(e.Values["ID"].ToString());
        //
        ...
        //Usando Classe uLog.MakeLog - Gravando Log
        fwObs_Log = "EXCLUI CLASSE DESPESAS: " + e.Values["codigo"].ToString() + "/" + e.Values["descricao"].ToString().ToUpper();
        SqlParameter[] param_log = { new SqlParameter("@login"    , (String)Session["CodUsuario"]),
                                     new SqlParameter("@tabela"   , fWtabela                     ),
                                     new SqlParameter("@operacao" , "CLASSE DESPESAS"            ),
