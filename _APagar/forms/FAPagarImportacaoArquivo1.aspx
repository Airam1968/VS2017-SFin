<%@ Page Title="FAPagarImportacaoArquivo1" Language="C#" AutoEventWireup="true"
    CodeFile="FAPagarImportacaoArquivo1.aspx.cs" Inherits="FAPagarImportacaoArquivo1"
...
<head id="Head1" runat="server">
    <title>Gitano - Contas a Pagar - Importação Arquivo - Modelo Texto 1</title>
...
<body style="height: 1400px">
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="UpdatePanel" runat="server" style="height: 1400px">
            <ContentTemplate>
                <h1>IMPORTAÇÃO ARQUIVOS - CONTAS A PAGAR</h1>
                ...
                <div id="DivNova" style="border-style: none">
                    <div style="border: 1px solid #808080; z-index: 1; left: 35px; top: 100px; position: absolute; height: 1200px; width: 832px; text-align: center;">
                        ...
                        <dx:ASPxTextBox ID="edpasta" runat="server" Style="z-index: 2; left: 150px; top: 15px; position: absolute; right: 223px;"
                            ...
                            ReadOnly="True" Text="\Arquivos\Importacao\Cpagar\Arquivo_texto\">
                        </dx:ASPxTextBox>
                                ...
                                <ContentCollection>
                                    <dx:PopupControlContentControl ID="PopupControlContentControl" runat="server">
                                        <div style="vertical-align: middle">
                                            Importação de Lançamentos Contas a Pagar.<br />
                                            <br />
