<%@ Page Title="FRelAPagarLancamentos" Language="C#" AutoEventWireup="true" CodeFile="FRelAPagarLancamentos.aspx.cs"
    Inherits="FRelAPagarLancamentos" StylesheetTheme="Principal" %>
...
<head id="Head1" runat="server">
    <title>Relatório Contas a Pagar - Lançamentos</title>
            ...
            <div id="DivNova" style="border-style: none">
                <div style="border: 1px solid #808080; z-index: 1; left: 35px; top: 100px; position: absolute;
                    ...
                    <asp:Label ID="Label1" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                        ...
                        position: absolute" Text="Tipo de Despesa" Theme="PlasticBlue" Visible="False"></asp:Label>
                    ...
                    <asp:Label ID="Label7" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                        ...
                        position: absolute" Text="Fornecedor" Theme="PlasticBlue" Visible="False"></asp:Label>
                    <dx:ASPxComboBox ID="cbfornecedor" runat="server" ValueType="System.String" Font-Bold="True"
                        Font-Names="Calibri" Font-Size="15px" ForeColor="#3E5395" Style="z-index: 5;
                        position: absolute; font-size: 10pt; top: 85px; left: 150px;" Width="380px"
                        Theme="PlasticBlue" Visible="False" AutoPostBack="True">
                    </dx:ASPxComboBox>
                    <dx:ASPxComboBox ID="cbfornecedor_filtro" runat="server" IncrementalFilteringMode="StartsWith"
                        ...
                        DataSourceID="dsfiltro_combo_fornecedores" Visible="False">
                        <Columns>
                    ...
                    <asp:Label ID="Label16" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                        ...
                        position: absolute" Text="Conta Corrente" Theme="PlasticBlue" Visible="False"></asp:Label>
                    <dx:ASPxComboBox ID="cbcontascorrentes" runat="server" ValueType="System.String"
                        Font-Bold="True" Font-Names="Calibri" Font-Size="15px" ForeColor="#3E5395" Style="z-index: 5;
                        position: absolute; font-size: 10pt; top: 120px; left: 150px;" Width="380px"
                        Theme="PlasticBlue" Visible="False" AutoPostBack="True">
                    </dx:ASPxComboBox>
                    <asp:Label ID="Label8" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                        ...
                        position: absolute" Text="Documento" Theme="PlasticBlue"></asp:Label>
                    <dx:ASPxTextBox ID="eddocumento" runat="server" Style="z-index: 2; left: 150px; top: 155px;
                        position: absolute; right: 223px;" Theme="PlasticBlue" Width="380px" AutoPostBack="True"
                        ReadOnly="True">
                    </dx:ASPxTextBox>
                    <asp:Label ID="Label4" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                        ...
                        position: absolute" Text="Período Previsão" Theme="PlasticBlue" Visible="False"></asp:Label>
                    <dx:ASPxDateEdit ID="dtprevisao1" runat="server" BackColor="#E1E6F2" DisplayFormatString="dd/MM/yyyy"
                        ...
                        position: absolute; margin-right: 5px; left: 150px; top: 190px;" Theme="PlasticBlue"
                    ...
                    <asp:Label ID="Label5" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                        Font-Size="15px" ForeColor="#3E5395" Style="z-index: 2; left: 300px; top: 190px;
                        position: absolute" Text="Até" Theme="PlasticBlue" Visible="False"></asp:Label>
                    <dx:ASPxDateEdit ID="dtprevisao2" runat="server" BackColor="#E1E6F2" DisplayFormatString="dd/MM/yyyy"
                        EditFormat="Custom" EditFormatString="dd/MM/yyyy" EnableTheming="True" Font-Bold="False"
                        Font-Names="Calibri" Font-Size="15px" ForeColor="#3E5395" Height="16px" Style="z-index: 4;
                        position: absolute; margin-right: 5px; left: 350px; top: 190px;" Theme="PlasticBlue"
                        UseMaskBehavior="True" Width="120px" Visible="False" MinDate="1900-01-01">
                        <CalendarProperties ClearButtonText="Limpar" TodayButtonText="Hoje">
                        </CalendarProperties>
                        <ClientSideEvents KeyDown="function(s, e) 
                    ...
                    <asp:Label ID="Label6" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                        ...
                        position: absolute" Text="Período Realizado" Theme="PlasticBlue" Visible="False"></asp:Label>
                    <dx:ASPxDateEdit ID="dtrealizado1" runat="server" BackColor="#E1E6F2" DisplayFormatString="dd/MM/yyyy"
                        EditFormat="Custom" EditFormatString="dd/MM/yyyy" EnableTheming="True" Font-Bold="False"
                        Font-Names="Calibri" Font-Size="15px" ForeColor="#3E5395" Height="16px" Style="z-index: 4;
                        position: absolute; margin-right: 5px; left: 150px; top: 225px;" Theme="PlasticBlue"
                        UseMaskBehavior="True" Width="120px" Visible="False" MinDate="1900-01-01">
                        <CalendarProperties ClearButtonText="Limpar" TodayButtonText="Hoje">
                        </CalendarProperties>
                        <ClientSideEvents KeyDown="function(s, e) 
                    ...
                    <asp:Label ID="Label9" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                        Font-Size="15px" ForeColor="#3E5395" Style="z-index: 2; left: 300px; top: 225px;
                        position: absolute" Text="Até" Theme="PlasticBlue" Visible="False"></asp:Label>
                    <dx:ASPxDateEdit ID="dtrealizado2" runat="server" BackColor="#E1E6F2" DisplayFormatString="dd/MM/yyyy"
                        EditFormat="Custom" EditFormatString="dd/MM/yyyy" EnableTheming="True" Font-Bold="False"
                        Font-Names="Calibri" Font-Size="15px" ForeColor="#3E5395" Height="16px" Style="z-index: 4;
                        position: absolute; margin-right: 5px; left: 350px; top: 225px;" Theme="PlasticBlue"
                        UseMaskBehavior="True" Width="120px" Visible="False" MinDate="1900-01-01">
                        <CalendarProperties ClearButtonText="Limpar" TodayButtonText="Hoje">
                        </CalendarProperties>
                        <ClientSideEvents KeyDown="function(s, e) 
                    ...
                    <asp:Label ID="Label10" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                        ...
                        position: absolute" Text="Período Nota Fiscal" Theme="PlasticBlue" Visible="False"></asp:Label>
                    <dx:ASPxDateEdit ID="dtnotafiscal1" runat="server" BackColor="#E1E6F2" DisplayFormatString="dd/MM/yyyy"
                        EditFormat="Custom" EditFormatString="dd/MM/yyyy" EnableTheming="True" Font-Bold="False"
                        Font-Names="Calibri" Font-Size="15px" ForeColor="#3E5395" Height="16px" Style="z-index: 4;
                        position: absolute; margin-right: 5px; left: 150px; top: 260px;" Theme="PlasticBlue"
                        UseMaskBehavior="True" Width="120px" Visible="False" MinDate="1900-01-01">
                        <CalendarProperties ClearButtonText="Limpar" TodayButtonText="Hoje">
                        </CalendarProperties>
                        <ClientSideEvents KeyDown="function(s, e) 
                    ...
                    <asp:Label ID="Label11" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                        Font-Size="15px" ForeColor="#3E5395" Style="z-index: 2; left: 300px; top: 260px;
                        position: absolute" Text="Até" Theme="PlasticBlue" Visible="False"></asp:Label>
                    <dx:ASPxDateEdit ID="dtnotafiscal2" runat="server" BackColor="#E1E6F2" DisplayFormatString="dd/MM/yyyy"
                        EditFormat="Custom" EditFormatString="dd/MM/yyyy" EnableTheming="True" Font-Bold="False"
                        Font-Names="Calibri" Font-Size="15px" ForeColor="#3E5395" Height="16px" Style="z-index: 4;
                        position: absolute; margin-right: 5px; left: 350px; top: 260px;" Theme="PlasticBlue"
                        UseMaskBehavior="True" Width="120px" Visible="False" MinDate="1900-01-01">
                        <CalendarProperties ClearButtonText="Limpar" TodayButtonText="Hoje">
                        </CalendarProperties>
                        <ClientSideEvents KeyDown="function(s, e) 
                    ...
                    <asp:Label ID="Label13" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                        ...
                        position: absolute" Text="Lançamentos" Theme="PlasticBlue"></asp:Label>
                    <asp:RadioButtonList ID="rblancamentossituacao" runat="server" AutoPostBack="True"
                        ...
                        ForeColor="#3E5395" Height="12px" Style="z-index: 2; left: 150px; top: 295px;
                        position: absolute; right: 382px;" Width="300px" RepeatDirection="Horizontal">
                    ...
                    <asp:Label ID="Label12" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                        ...
                        position: absolute" Text="Ordenação" Theme="PlasticBlue"></asp:Label>
                    <asp:RadioButtonList ID="rbordenacao" runat="server" AutoPostBack="True" CellPadding="0"
                        ...
                        ForeColor="#3E5395" Height="12px" Style="z-index: 2; left: 150px; top: 330px;
                        position: absolute; right: 32px;" Width="650px" RepeatDirection="Horizontal">
                    ...
                    <asp:Label ID="Label14" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                        ...
                        position: absolute" Text="Saldo Inicial" Theme="PlasticBlue"></asp:Label>
                    <dx:ASPxTextBox ID="edsaldoinicial" runat="server" Style="z-index: 2; left: 150px; top: 365px;
                        position: absolute; right: 223px;" Theme="PlasticBlue" Width="380px"
                ...
                <asp:ObjectDataSource ID="dsfiltro_combo_fornecedores" runat="server" OldValuesParameterFormatString="original_{0}"
                    SelectMethod="filtro_combo_fornecedores" TypeName="uFornecedores">
                    <SelectParameters>
