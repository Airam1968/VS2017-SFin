<%@ Page Title="FRelApagarMalaDireta" Language="C#" AutoEventWireup="true" CodeFile="FRelApagarMalaDireta.aspx.cs"
    Inherits="FRelApagarMalaDireta" StylesheetTheme="Principal" %>
...
<head id="Head1" runat="server">
    <title>Relatório Fornecedores Etiquetas</title>
...
<body style="height: 910px">
    ...
    <asp:UpdatePanel ID="UpdatePanel" runat="server">
        <ContentTemplate>
            ...
            <h2>
                Forcedores Mala Direta Etiquetas</h2>
            <div id="DivNova" style="border-style: none">
                <div style="border: 1px solid #808080; z-index: 1; left: 35px; top: 100px; position: absolute;
                    ...
                    <dx3:ASPxGridView ID="lookupempresa" ClientInstanceName="lookupempresa" runat="server"
                        ...
                        height: 170px;" Theme="PlasticBlue" Width="200px" EnableRowsCache="False" EnableCallBacks="False">
                        <Columns>
                    ...
                    <div id="Div2" runat="server" style="border: 1px solid #808080; z-index: 2; position: absolute;
                        top: 20px; left: 400px; height: 50px; width: 100px;">
                            ...
                            <ContentCollection>
                                <dx:PopupControlContentControl ID="PopupControlContentControl" runat="server">
                                    <div style="vertical-align: middle">
                                        Mala Direta Fornecedores.<br />
                                        <br />
                                        Emissão de etiquetas de endereçamento baseado no cadastro de Fornecedores.<br />
                                        <br />
