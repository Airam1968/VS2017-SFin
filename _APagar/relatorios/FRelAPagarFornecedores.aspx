<%@ Page Title="FRelAPagarFornecedores" Language="C#" AutoEventWireup="true" CodeFile="FRelAPagarFornecedores.aspx.cs"
    Inherits="FRelAPagarFornecedores" StylesheetTheme="Principal" %>
...
<head id="Head1" runat="server">
    <title>Relatório Contas a Pagar - Fornecedores</title>
                    ...
                    <dx3:ASPxGridView ID="lookupempresa" ClientInstanceName="lookupempresa" runat="server"
                        ...
                        <Columns>
                            ...
                            <dx3:GridViewDataTextColumn Caption="Apelido" FieldName="apelido" 
                                Name="apelido" VisibleIndex="2" Width="60%">
                                <PropertiesTextEdit>
                        ...
                        <ContentCollection>
                            <dx:PopupControlContentControl ID="PopupControlContentControl" runat="server">
                                <div style="vertical-align: middle">
                                    ...
                                    <br />
                                    O Relatório em questão apresenta os dados dos Fornecedores cadastrados no Contas a Pagar.<br />
                                    <br />
                                </div>
