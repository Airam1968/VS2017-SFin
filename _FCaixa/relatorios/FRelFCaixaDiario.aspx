<%@ Page Title="FRelFCaixaDiario" Language="C#" AutoEventWireup="true"
    CodeFile="FRelFCaixaDiario.aspx.cs" Inherits="FRelFCaixaDiario"
...
<head id="Head1" runat="server">
    <title>Relatório Fluxo de Caixa - Diário</title>
                ...
                <div id="DivNova" style="border-style: none">
                    <div style="border: 1px solid #808080; z-index: 1; left: 35px; top: 100px; position: absolute; height: 1200px; width: 832px; text-align: center;">
                        ...
                        <dx:ASPxDateEdit ID="dtprevisao1" runat="server" BackColor="#E1E6F2" DisplayFormatString="dd/MM/yyyy"
                            ...
                            Font-Names="Calibri" Font-Size="15px" ForeColor="#3E5395" Height="16px" Style="z-index: 4; position: absolute; margin-right: 5px; left: 150px; top: 85px;"
                            Theme="PlasticBlue"
                        ...
                        <asp:Label ID="Label5" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            Font-Size="15px" ForeColor="#3E5395" Style="z-index: 2; left: 300px; top: 85px; position: absolute"
                        ...
                        <dx:ASPxDateEdit ID="dtprevisao2" runat="server" BackColor="#E1E6F2" DisplayFormatString="dd/MM/yyyy"
                            EditFormat="Custom" EditFormatString="dd/MM/yyyy" EnableTheming="True" Font-Bold="False"
                            Font-Names="Calibri" Font-Size="15px" ForeColor="#3E5395" Height="16px" Style="z-index: 4; position: absolute; margin-right: 5px; left: 350px; top: 85px;"
                            Theme="PlasticBlue"
                            UseMaskBehavior="True" Width="120px" MinDate="1900-01-01">
                            <CalendarProperties ClearButtonText="Limpar" TodayButtonText="Hoje">
                            </CalendarProperties>
                        ...
                        <asp:RadioButtonList ID="rblancamentossituacao" runat="server"
                            ...
                            ForeColor="#3E5395" Height="12px" Style="z-index: 2; left: 150px; top: 120px; position: absolute; right: 382px;"
                            Width="300px"
                        ...
                        <dx:ASPxCheckBox ID="ckmulticontas" runat="server" Style="z-index: 2; left: 150px; top: 155px; position: absolute; right: 562px;"
                        ...
                        <asp:Label ID="Label1" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            Font-Size="15px" ForeColor="#3E5395" Style="z-index: 2; left: 300px; top: 155px; position: absolute"
                            Text="Inclui Aplicações" Theme="PlasticBlue"></asp:Label>
                        <dx:ASPxCheckBox ID="ckaplicacoes" runat="server" Style="z-index: 2; top: 155px; left: 450px; position: absolute; right: 562px;"
                        ...
                        <dx3:ASPxGridView ID="lookupempresa" ClientInstanceName="lookupempresa" runat="server"
                            ...
                            Style="z-index: 1; position: absolute; margin-right: 5px; top: 185px; left: 10px; height: 300px;"
