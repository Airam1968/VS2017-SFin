<%@ Page Title="FRelAReceberClientes" Language="C#" AutoEventWireup="true" CodeFile="FRelAReceberClientes.aspx.cs"
    Inherits="FRelAReceberClientes" StylesheetTheme="Principal" %>
...
<head id="Head1" runat="server">
    <title>Relatório Contas a Receber - Clientes</title>
...
<body style="height: 910px">
    ...
    <asp:UpdatePanel ID="UpdatePanel" runat="server">
        <ContentTemplate>
            <h1>
                CONTAS A RECEBER - RELATÓRIOS</h1>
            <h2>
                Clientes Cadastro</h2>
                        ...
                        <ContentCollection>
                            <dx:PopupControlContentControl ID="PopupControlContentControl" runat="server">
                                <div style="vertical-align: middle">
                                    Relatório Clientes Contas a Receber.<br />
                                    <br />
                                    O Relatório em questão apresenta os dados dos clientes cadastrados no Contas a Receber.<br />
                                    <br />
                                </div>
