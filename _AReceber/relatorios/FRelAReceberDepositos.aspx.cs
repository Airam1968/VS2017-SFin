...
public partial class FRelAReceberDepositos : System.Web.UI.Page
{
    ...
    protected void Page_Init(object sender, EventArgs e)  // CARGA DOS LOOKUPS TEM QUE SER FEITA NESTE EVENTO  ====================================================================================
    {
        ...
        uCliente.MontaComboCliente(cbcliente, true);
        Label7.Visible = true;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            //Combo Grupo
            cbreceita.Items.Clear();
            uDespesas.MontaComboDespesas(cbreceita, "0", true);
            Label2.Visible = true;
            cbreceita.Visible = true;
            //
            //Combo Fornecedor
            cbcliente.Items.Clear();
            uFornecedores.MontaComboFornecedores(cbcliente, "0", true);
            Label7.Visible = true;
            cbcliente.Visible = true;
            //
            //Combo Contas Correntes
