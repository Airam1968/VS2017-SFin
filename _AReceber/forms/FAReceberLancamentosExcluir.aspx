<%@ Page Title="FAReceberLancamentosExcluir" Language="C#" AutoEventWireup="true" CodeFile="FAReceberLancamentosExcluir.aspx.cs"
    Inherits="FAReceberLancamentosExcluir" StylesheetTheme="Principal" %>
...
<head id="Head1" runat="server">
    <title>Gitano - Contas a Receber - Excluir Lançamentos</title>
                ...
                <div id="DivNova" style="border-style: none">
                    <div style="border: 1px solid #808080; z-index: 1; left: 35px; top: 100px; position: absolute; height: 1200px; width: 832px; text-align: center;">
                        ...
                        <dx:ASPxTextBox ID="edlancamento" runat="server" Style="z-index: 2; left: 150px; top: 15px; position: absolute; right: 482px;"
                            ...
                            OnTextChanged="edlancamento_TextChanged">
                        </dx:ASPxTextBox>
                        ...
                        <dx:ASPxComboBox ID="cbcliente" runat="server" ValueType="System.String" Font-Bold="True"
                            ...
                            Width="380px"
                            Theme="PlasticBlue" Visible="False" AutoPostBack="True" ReadOnly="True">
                        </dx:ASPxComboBox>
                        ...
                        <dx:ASPxTextBox ID="eddescricao" runat="server" Style="z-index: 2; left: 150px; top: 260px; position: absolute; right: 223px;"
                        ...
                        <dx:ASPxDateEdit ID="dtprevisao1" runat="server" BackColor="#E1E6F2" DisplayFormatString="dd/MM/yyyy"
                            EditFormat="Custom" EditFormatString="dd/MM/yyyy" EnableTheming="True" Font-Bold="False"
                            Font-Names="Calibri" Font-Size="15px" ForeColor="#3E5395" Height="16px" Style="z-index: 4; position: absolute; margin-right: 5px; left: 150px; top: 295px;"
                            Theme="PlasticBlue"
                            UseMaskBehavior="True" Width="120px" Visible="False" AutoPostBack="True" MinDate="1900-01-01">
                            <CalendarProperties ClearButtonText="Limpar" TodayButtonText="Hoje">
                            </CalendarProperties>
                        ...
                        <dx:ASPxTextBox ID="edvlrtotalprevisto" runat="server" Style="z-index: 2; left: 150px; top: 330px; position: absolute; right: 223px;"
                            Theme="PlasticBlue" Width="200px"
                            AutoPostBack="True" HorizontalAlign="Right" ReadOnly="True">
                        ...
                        <dx:ASPxDateEdit ID="dtrealizado1" runat="server" BackColor="#E1E6F2" DisplayFormatString="dd/MM/yyyy"
                            ...
                            Theme="PlasticBlue"
                            UseMaskBehavior="True" Width="120px" Visible="False" AutoPostBack="True" MinDate="1900-01-01"
                            OnDateChanged="dtrealizado1_DateChanged" ReadOnly="True">
                            <CalendarProperties ClearButtonText="Limpar" TodayButtonText="Hoje">
                            </CalendarProperties>
                            <ClientSideEvents KeyDown="function(s, e) 
                                                   {if (!(
                        ...
                        <dx:ASPxTextBox ID="edcheque" runat="server" Style="z-index: 2; left: 150px; top: 435px; position: absolute; right: 223px;"
                            Theme="PlasticBlue" Width="380px"
                            AutoPostBack="True" ReadOnly="True">
                        </dx:ASPxTextBox>
                        ...
                        <dx:ASPxTextBox ID="edcontabil" runat="server" Style="z-index: 2; left: 150px; top: 470px; position: absolute; right: 223px;"
                            Theme="PlasticBlue" Width="380px"
                            AutoPostBack="True" ReadOnly="True">
                        </dx:ASPxTextBox>
                        <asp:Label ID="Label13" runat="server" BackColor="White" Font-Bold="False" Font-Names="Calibri"
                            ...
                            Text="Data Compensação" Theme="PlasticBlue" Visible="False"></asp:Label>
                        <dx:ASPxDateEdit ID="dtcompensacao1" runat="server" BackColor="#E1E6F2" DisplayFormatString="dd/MM/yyyy"
                            EditFormat="Custom" EditFormatString="dd/MM/yyyy" EnableTheming="True" Font-Bold="False"
                            Font-Names="Calibri" Font-Size="15px" ForeColor="#3E5395" Height="16px" Style="z-index: 4; position: absolute; margin-right: 5px; left: 150px; top: 505px;"
                            Theme="PlasticBlue"
                            UseMaskBehavior="True" Width="120px" Visible="False" AutoPostBack="True" MinDate="1900-01-01">
                            <CalendarProperties ClearButtonText="Limpar" TodayButtonText="Hoje">
                            </CalendarProperties>
                        ...
                        <dx3:ASPxGridView ID="GridListagem" runat="server" AutoGenerateColumns="False" EnableTheming="True"
                            Font-Bold="False" KeyFieldName="ID" Style="margin-right: 6px; position: absolute; top: 600px; left: 10px; height: 400px;"
                        ...
                        <div id="Div2" runat="server" style="border: 1px solid #808080; z-index: 2; position: absolute; top: 20px; left: 700px; height: 50px; width: 100px;">
                            <dx:ASPxButton ID="btprocessa" runat="server" Height="40px" ImagePosition="Left"
                                ...
                                <Image Height="30px" ToolTip="Altera Lançamento" Url="~/images/BotoesTelas/BTNalterarA.bmp"
                                ...
                                <ContentCollection>
                                    <dx:PopupControlContentControl ID="PopupControlContentControl" runat="server">
                                        <div style="vertical-align: middle">
                                            Contas a Pagar - Excluir Lançamentos.<br />
                                            <br />
                                            Os lançamentos de contas a pagar se dividem em previsão de pagamento e pagamento realizado, as informações solicitadas permitem que em consultas possa localizar perfis de pagamentos úteis para a empresa. Alem de Alimentar os lançamentos do Controle de Contas Correntes.<br />
                                            <br />
                                            Exclusões de Lançamentos com valores realizados impactam no saldo da conta corrente registrada.<br />
                                            <br />
                                        </div>
