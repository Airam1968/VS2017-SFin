...
public partial class FAReceberConsulta : System.Web.UI.Page
{
    DataSet dscreceber;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            uCliente.MontaComboClientes(cbclientes, "0", true);
            Label7.Visible = true;
    ...
    private void AtualizaGrid(String situacaopgto, String ordenacao)
    {
        ...
        if (cbclientes.Value != null)
        {
            cbcliente2 = cbclientes.Value.ToString().Trim();
        }
        ...
        dscreceber = uContasReceber.PegaDadosCReceber(cbproduto2,
                                                      cbreceita2,
                                                      cbcliente2,
                                                      cbcontascorrentes2,
                                                      dtprevisao1.Text,
        ...
        //Todas/Classe Receitas
        if (ordenacao == "R")
        {
            GridListagem.KeyFieldName = "receita";
        }
        //Todas/Fornecedores
        if (ordenacao == "C")
        {
            GridListagem.KeyFieldName = "cliente";
        }
        //Todas/Data Prevista
        if (ordenacao == "DP")
        {
