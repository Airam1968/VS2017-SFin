<%@ Page Title="FTabelaReceitas" Language="C#" AutoEventWireup="true" CodeFile="FTabelaReceitas.aspx.cs"
    Inherits="FTabelaReceitas" StylesheetTheme="Principal" ClientIDMode="Inherit" %>
...
<head id="Head1" runat="server">
    <title>Gitano - A Receber - Tabela - Receitas</title>
...
<body style="height: 1200px">
    ...
    <asp:UpdatePanel ID="UpdatePanel" runat="server" style="height: 1200px">
        <ContentTemplate>
            <h1>
                A RECEBER - TABELA - RECEITAS</h1>
            <h2>
                Manutenção de Tipo de Receitas</h2>
                ...
                <div style="border: 1px solid #808080; z-index: 1; left: 35px; top: 100px; position: absolute;
                    ...
                    <dx3:ASPxGridView ID="GridListagem" runat="server" AutoGenerateColumns="False" EnableTheming="True"
                        ...
                        <SettingsText EmptyDataRow="Não há Dados á Exibir" CommandCancel="Cancela" CommandClearFilter="Limpar Filtros"
                            ...
                            CommandUpdate="Altera" ConfirmDelete="Apagar o Registro, Confirma?" PopupEditFormCaption="Manutenção Classe de Receitas"
                            Title="Verificar" />
                        ...
                        <Columns>
                            ...
                            <dx3:GridViewDataTextColumn FieldName="codigo" VisibleIndex="1" Width="150px" Caption="Código"
                                Name="codigo" SortIndex="0" SortOrder="Ascending">
                            ...
                            <dx3:GridViewDataTextColumn Caption="Descrição" FieldName="descricao" 
                                Name="descricao" VisibleIndex="2"
                                Width="300px">
                                <EditFormSettings Caption="Descrição &gt;" CaptionLocation="Near" 
                            ...
                            <dx3:GridViewDataTextColumn Caption="Conta Contábil" FieldName="conta_contabil" Name="conta_contabil"
                            ...
                            <ContentCollection>
                                <dx:PopupControlContentControl ID="PopupControlContentControl" runat="server">
                                    <div style="vertical-align: middle">
                                        Tipo de Receitas.<br />
                                        <br />
                                        Plano de Contas de Tipos de Receitas.<br />
                                        <br />
                                        Receitas para o cadastro de lançamentos de Contas a Receber.<br />
                                        <br />
                                    </div>
