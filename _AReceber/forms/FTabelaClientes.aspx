<%@ Page Title="FTabelaClientes" Language="C#" AutoEventWireup="true" CodeFile="FTabelaClientes.aspx.cs"
    Inherits="FTabelaClientes" StylesheetTheme="Principal" %>
...
<head id="Head1" runat="server">
    <title>Gitano - A Receber - Tabelas - Clientes</title>
                            ...
                            <ContentCollection>
                                <dx:PopupControlContentControl ID="PopupControlContentControl" runat="server">
                                    <div style="vertical-align: middle">
                                        Clientes.<br />
                                        <br />
                                        Clientes para o cadastro de lançamentos de Contas a Receber.<br />
                                        <br />
                                    </div>
