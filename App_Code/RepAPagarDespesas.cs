...
/// <summary>
/// Summary description for RepAPagarDespesas
/// </summary>
public class RepAPagarDespesas : DevExpress.XtraReports.UI.XtraReport
{
    ...
    {
        //string resourceFileName = "RepAPagarDespesas.resx";
        ...
        this.lfdespesa = new DevExpress.XtraReports.UI.XRLabel();
        ...
        this.lcontacontabil.Text = "lcontacontabil";
        ...
        this.lcodigo.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleLeft;
        ...
        this.ltitulorelatorio.Text = "RELATÓRIO DESPESAS CADASTRO";
        ...
        // lfdespesa
        // 
        this.lfdespesa.LocationFloat = new DevExpress.Utils.PointFloat(82.23017F, 5.000007F);
        this.lfdespesa.Name = "lfdespesa";
        this.lfdespesa.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 100F);
        this.lfdespesa.SizeF = new System.Drawing.SizeF(377.2502F, 20F);
        this.lfdespesa.StylePriority.UseTextAlignment = false;
        this.lfdespesa.Text = "lfdespesa";
        this.lfdespesa.TextAlignment = DevExpress.XtraPrinting.TextAlignment.TopLeft;
        // 
        // xrLabel4
        // 
        ...
        this.Version = "13.2";
        this.BeforePrint += new System.Drawing.Printing.PrintEventHandler(this.RepAPagarDespesas_BeforePrint);
    ...
    private void RepAPagarDespesas_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
    {
